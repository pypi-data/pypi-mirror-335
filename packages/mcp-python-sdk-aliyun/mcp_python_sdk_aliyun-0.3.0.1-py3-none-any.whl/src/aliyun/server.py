...
http_domain = "https://pre-ai-assistant-management.aliyun-inc1.com"
...
def main(server_name: str, log_file: str, port: int, transport: str) -> int:
    ...
    try:
        ...
        raise Exception("服务注册中心[{}]连接失败：{}".format(http_domain, str(e)))
    if "data" not in result:
        raise Exception("mcp server启动失败，请传入MCP服务注册中心已有的服务code！")
