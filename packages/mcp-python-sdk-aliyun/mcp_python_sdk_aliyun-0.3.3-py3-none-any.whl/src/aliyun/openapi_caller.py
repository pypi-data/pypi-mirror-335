...
if __name__ == '__main__':
    res = call_openapi_tool(tool_info={
        "protocol": {
            "regionId": "cn-hangzhou",
            "domain": "ak-inner.cn-hangzhou.aliyuncs.com",
            "action": "QueryShortTermAccessKeyForTicket",
            "version": "2016-07-14"
        }
    }, arguments={
      "Ticket": "xRucVUFr_iBiyN9Ucqof_BNpwU_TOTNChZBoeM1KJexdfb9zhYnsN5Zos6qISCrRt7mGxbigG2Cd4fWaCmBZHIzsgdZq64XXWQgyKFeuf0vpmV*s*CT58JlM_1t$w37z$ZcYgi3622D5aSheQpKhDLp*0",
      "ExpireTime": "1742548692913",
      "AK": "LTAID7u7vRk6Qqv1",
      "SK": "joHtcBDBaFKbjZrffh3JUXEjSWiB8K"
    })
    print(res)
