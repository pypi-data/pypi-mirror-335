...
from jimuflow.gui.window_element_relative_xpath_tool import WindowElementRelativeXpathTool
from jimuflow.locales.i18n import gettext
from jimuflow.runtime.expression import escape_string


class WindowRelativeXPathEdit(QWidget):
    ...
    @Slot()
    def _open_tool(self):
        tool = WindowElementRelativeXpathTool()
