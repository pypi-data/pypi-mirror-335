...
class WindowTitlePopup(QWidget):
    ...
    def reload_window_titles(self):
        ...
        for window in desktop.windows():
            ...
            if window_text:
                item = QStandardItem(window_text)
...
class WindowTitleEdit(QWidget):
    ...
    def _on_popup_item_selected(self, title):
        self.set_value(escape_string(title))
    ...
    def _open_popup(self):
        self._popup.reload_window_titles()
