...
mcp = FastMCP("Ableton Live Controller", dependencies=["python-osc", "uvicorn"])
...
def main():
    ...
    if not tools:
        print("WARNING: No MCP tools found when scanning. Will use pre-registered tools.")
    else:
        print(f"Found {len(tools)} MCP tools.")
        
    # Start the FastMCP server using the global mcp instance that already has tools registered
