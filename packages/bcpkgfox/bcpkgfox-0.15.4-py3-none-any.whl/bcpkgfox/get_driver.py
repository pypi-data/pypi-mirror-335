    ...
    def initialize_driver(self,
        ...
        if self.selenoid:
            ...
            # Un-chrome
                ...
                # browsers_path = resource_path("fake_useragent/data/browsers.jsonl")

                # ua = UserAgent(path=browsers_path)
                # print(ua.random)
                ...
                # ua = UserAgent(browsers=browsers_path, platforms=['win32', 'linux', 'macos'])
