...
def main():
    ...
    class exec_gen():
        ...
        def preparations(self):
            ...
            self.target_file = os.path.join(self.current_dir, args.file)
        ...
        def run_pyinstaller(self):
            ...
            def print_footer():
                ...
                while not process_finished:
                    sys.stdout.write(f"\r \033[F\r\033[K\033[E {visuals.animate_rgb_text(f"   {visuals.Neg}| Gerando executável do '{self.target_file}', aguarde finalização. |{visuals.RESET}")}\n\033[F")
                    sys.stdout.flush()
