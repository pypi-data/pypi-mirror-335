            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i574 in range(_size570):
                        _key575 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        _val576 = []
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i627 in range(_size623):
                        _key628 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i691 in range(_size687):
                        _key692 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i760 in range(_size756):
                        _elem761 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
