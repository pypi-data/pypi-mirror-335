...
class Guideline(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRING:
                    self.guidelineName = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
...
class Rule(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRING:
                    self.ruleId = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.STRING:
