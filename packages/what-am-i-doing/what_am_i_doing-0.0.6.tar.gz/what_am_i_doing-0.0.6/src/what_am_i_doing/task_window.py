...
class TaskWindow(Gtk.Window):
    ...
    def task_search(self,widget):
        ...
        if i in self.search_cache and 1 == 2:
            ...
            limit = ''
            order_by = 'taskindex.status DESC, taskindex.priority DESC, sessions.start_time DESC, rank ASC' 
            # order_by = 'taskindex.status DESC, taskindex.priority DESC, rank' # for testing
            ...
            if len(i) == 0:
                # Set default_tasks
                limit = 'LIMIT 25'
                # conditions = " WHERE taskindex.status = '1' "
                conditions = ''
                order_by = 'taskindex.status DESC, taskindex.priority DESC, sessions.start_time DESC'
    ...
    def add_task_to_list(self,t,search_str = None):
        ...
        try:
            ...
            if len(search_str) > 1:
                # print('escaped extended_label',extended_label)
        ...
        if event:  # Right-click (button 3)
            if event.button == 3:  # Right-click (button 3)
                ...
                # TODO: Context menu with: Modify session to this task, mark_done, start, edit?, and get_times? (from time tracker)
                    ...
                    # Create popover
                    # https://stackoverflow.com/a/64531462/4692205
                    # popover = Gtk.Popover()
