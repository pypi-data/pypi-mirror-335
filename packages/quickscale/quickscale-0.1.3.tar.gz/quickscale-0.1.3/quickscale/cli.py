...
def main():
    ...
    shell_parser = subparsers.add_parser("shell", help="Enter an interactive bash shell in the web container")
    django_shell_parser = subparsers.add_parser("django-shell", help="Enter the Django shell in the web container")
