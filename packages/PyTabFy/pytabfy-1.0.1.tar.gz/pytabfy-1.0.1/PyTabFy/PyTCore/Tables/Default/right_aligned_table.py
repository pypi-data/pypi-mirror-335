...
class RightAlignedTable(BaseTable):
    """'RightAlignedTable' always use 'Alignment.RIGHT' as the default Alignment"""
    ...
    def __init__(self, custom_configs: Optional[TableConfigs] = None) -> None:
        ...
        self.configs.title_alignment    = Alignment.RIGHT
        self.configs.header_alignments  = [Alignment.RIGHT, ]
        self.configs.content_alignments = [Alignment.RIGHT, ]


    def build(self, /, data: TableData, **kwargs) -> 'BaseTable':
        if kwargs:
            # NOTE: Overrides alignment values
            kwargs['title_alignment']    = Alignment.RIGHT
            kwargs['header_alignments']  = [Alignment.RIGHT, ]
            kwargs['content_alignments'] = [Alignment.RIGHT, ]
