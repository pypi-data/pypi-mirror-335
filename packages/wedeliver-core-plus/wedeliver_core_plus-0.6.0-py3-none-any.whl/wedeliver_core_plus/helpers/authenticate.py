...
from wedeliver_core_plus.helpers.exceptions import AppExpiredTokenError
...
def authenticate(token, api=None):
    try:
        ...
        raise AppExpiredTokenError(_("Token is not valid"))
    except jwt.ExpiredSignatureError:
        raise AppExpiredTokenError(_("Token is expired"))
