...
struct DDManagerSyncDef {
    fullManagerFLI @0: Text;
    respFLI @1: Text;
}

struct DDManagerGetStateDef {
    respFLI @0: Text;
}

struct DDManagerGetStateResponseDef {
    state @0: Text;
}

struct DDMarkDrainedManagerDef {
    respFLI @0: Text;
    managerID @1: UInt64;
}
...
struct MessageDef {
    ...
    union {
        ...
        ddGetManagers @48: DDGetManagersDef;
        ddGetManagersResponse @49: DDGetManagersResponseDef;
        ddManagerSync @50: DDManagerSyncDef;
        ddManagerGetState @51: DDManagerGetStateDef;
        ddManagerGetStateResponse @52: DDManagerGetStateResponseDef;
        ddMarkDrainedManager @53: DDMarkDrainedManagerDef;
    }
}
