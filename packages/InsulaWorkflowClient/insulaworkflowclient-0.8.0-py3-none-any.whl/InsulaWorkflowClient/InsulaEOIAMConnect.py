...
@dataclass
class InsulaEOIAMConfig(object):
...
class InsulaEOIAMConnect(InsulaAuthorizationApiConfig):
    def __init__(self, config_eoian: InsulaEOIAMConfig):
    ...
    def get_authorization_header(self):
        ...
        if not self.__is_valid_token():
            eoiam = self.__create_eoiam_token()
            self.__get_esa_token(eoiam['access_token'])
