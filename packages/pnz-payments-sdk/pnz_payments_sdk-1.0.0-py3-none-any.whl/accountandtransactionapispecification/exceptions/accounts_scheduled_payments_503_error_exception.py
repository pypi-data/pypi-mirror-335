...
class AccountsScheduledPayments503ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the AccountsScheduledPayments503ErrorException class
        ...
        """
        super(AccountsScheduledPayments503ErrorException, self).__init__(reason, response)
