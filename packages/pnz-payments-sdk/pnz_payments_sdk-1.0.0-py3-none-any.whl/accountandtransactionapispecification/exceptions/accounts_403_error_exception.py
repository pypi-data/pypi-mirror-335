...
class Accounts403ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the Accounts403ErrorException class
        ...
        """
        super(Accounts403ErrorException, self).__init__(reason, response)
