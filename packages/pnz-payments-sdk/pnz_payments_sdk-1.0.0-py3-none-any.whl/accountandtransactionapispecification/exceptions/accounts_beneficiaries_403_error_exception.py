...
class AccountsBeneficiaries403ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the AccountsBeneficiaries403ErrorException class
        ...
        """
        super(AccountsBeneficiaries403ErrorException, self).__init__(reason, response)
