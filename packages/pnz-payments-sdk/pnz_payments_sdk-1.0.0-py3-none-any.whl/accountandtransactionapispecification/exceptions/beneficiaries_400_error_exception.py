...
class Beneficiaries400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the Beneficiaries400ErrorException class
        ...
        """
        super(Beneficiaries400ErrorException, self).__init__(reason, response)
