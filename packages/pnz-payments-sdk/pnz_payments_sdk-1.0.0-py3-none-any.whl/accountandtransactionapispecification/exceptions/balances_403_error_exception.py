...
class Balances403ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the Balances403ErrorException class
        ...
        """
        super(Balances403ErrorException, self).__init__(reason, response)
