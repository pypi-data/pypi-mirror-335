...
class AccountsStatements400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the AccountsStatements400ErrorException class
        ...
        """
        super(AccountsStatements400ErrorException, self).__init__(reason, response)
