...
class AccountsOffers503ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the AccountsOffers503ErrorException class
        ...
        """
        super(AccountsOffers503ErrorException, self).__init__(reason, response)
