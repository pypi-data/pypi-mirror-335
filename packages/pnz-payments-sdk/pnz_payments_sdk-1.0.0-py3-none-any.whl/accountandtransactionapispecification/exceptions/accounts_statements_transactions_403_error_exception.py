...
class AccountsStatementsTransactions403ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the AccountsStatementsTransactions403ErrorException class
        ...
        """
        super(AccountsStatementsTransactions403ErrorException, self).__init__(reason, response)
