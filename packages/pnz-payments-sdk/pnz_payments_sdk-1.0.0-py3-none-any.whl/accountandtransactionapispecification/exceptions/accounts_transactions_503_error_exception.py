...
class AccountsTransactions503ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the AccountsTransactions503ErrorException class
        ...
        """
        super(AccountsTransactions503ErrorException, self).__init__(reason, response)
