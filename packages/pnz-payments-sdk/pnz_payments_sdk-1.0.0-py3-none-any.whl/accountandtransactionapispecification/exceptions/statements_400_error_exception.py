...
class Statements400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the Statements400ErrorException class
        ...
        """
        super(Statements400ErrorException, self).__init__(reason, response)
