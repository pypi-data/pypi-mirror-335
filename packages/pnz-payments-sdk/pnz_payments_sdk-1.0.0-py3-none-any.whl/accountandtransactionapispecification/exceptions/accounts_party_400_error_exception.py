...
class AccountsParty400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the AccountsParty400ErrorException class
        ...
        """
        super(AccountsParty400ErrorException, self).__init__(reason, response)
