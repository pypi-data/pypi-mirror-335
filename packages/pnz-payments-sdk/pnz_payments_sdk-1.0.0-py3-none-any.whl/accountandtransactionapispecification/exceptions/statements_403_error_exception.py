...
class Statements403ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the Statements403ErrorException class
        ...
        """
        super(Statements403ErrorException, self).__init__(reason, response)
