...
class AccountsBalances500ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the AccountsBalances500ErrorException class
        ...
        """
        super(AccountsBalances500ErrorException, self).__init__(reason, response)
