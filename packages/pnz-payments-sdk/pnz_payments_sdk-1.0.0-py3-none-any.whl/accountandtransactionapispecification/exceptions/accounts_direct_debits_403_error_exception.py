...
class AccountsDirectDebits403ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the AccountsDirectDebits403ErrorException class
        ...
        """
        super(AccountsDirectDebits403ErrorException, self).__init__(reason, response)
