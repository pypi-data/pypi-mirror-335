...
class AccountsParty403ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the AccountsParty403ErrorException class
        ...
        """
        super(AccountsParty403ErrorException, self).__init__(reason, response)
