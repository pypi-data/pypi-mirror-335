...
class DirectDebits400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the DirectDebits400ErrorException class
        ...
        """
        super(DirectDebits400ErrorException, self).__init__(reason, response)
