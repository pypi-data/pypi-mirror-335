...
class StandingOrders400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the StandingOrders400ErrorException class
        ...
        """
        super(StandingOrders400ErrorException, self).__init__(reason, response)
