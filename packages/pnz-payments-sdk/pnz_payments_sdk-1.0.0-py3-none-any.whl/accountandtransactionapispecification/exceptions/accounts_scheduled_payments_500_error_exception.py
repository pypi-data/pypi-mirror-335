...
class AccountsScheduledPayments500ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the AccountsScheduledPayments500ErrorException class
        ...
        """
        super(AccountsScheduledPayments500ErrorException, self).__init__(reason, response)
