...
class AccountsStatementsTransactions503ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the AccountsStatementsTransactions503ErrorException class
        ...
        """
        super(AccountsStatementsTransactions503ErrorException, self).__init__(reason, response)
