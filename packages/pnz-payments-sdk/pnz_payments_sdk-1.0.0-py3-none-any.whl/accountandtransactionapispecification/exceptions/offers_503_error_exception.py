...
class Offers503ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the Offers503ErrorException class
        ...
        """
        super(Offers503ErrorException, self).__init__(reason, response)
