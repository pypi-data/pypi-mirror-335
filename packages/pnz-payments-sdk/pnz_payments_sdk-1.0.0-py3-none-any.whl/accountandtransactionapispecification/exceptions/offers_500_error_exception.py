...
class Offers500ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the Offers500ErrorException class
        ...
        """
        super(Offers500ErrorException, self).__init__(reason, response)
