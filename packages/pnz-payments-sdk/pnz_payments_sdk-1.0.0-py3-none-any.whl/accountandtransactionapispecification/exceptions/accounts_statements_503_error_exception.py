...
class AccountsStatements503ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the AccountsStatements503ErrorException class
        ...
        """
        super(AccountsStatements503ErrorException, self).__init__(reason, response)
