...
class AccountsTransactions500ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the AccountsTransactions500ErrorException class
        ...
        """
        super(AccountsTransactions500ErrorException, self).__init__(reason, response)
