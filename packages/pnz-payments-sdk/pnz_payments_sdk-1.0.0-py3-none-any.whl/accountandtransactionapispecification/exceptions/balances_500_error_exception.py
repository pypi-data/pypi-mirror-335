...
class Balances500ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the Balances500ErrorException class
        ...
        """
        super(Balances500ErrorException, self).__init__(reason, response)
