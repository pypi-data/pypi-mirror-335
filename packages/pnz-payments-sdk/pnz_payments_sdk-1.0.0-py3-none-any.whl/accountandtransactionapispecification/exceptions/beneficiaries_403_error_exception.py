...
class Beneficiaries403ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the Beneficiaries403ErrorException class
        ...
        """
        super(Beneficiaries403ErrorException, self).__init__(reason, response)
