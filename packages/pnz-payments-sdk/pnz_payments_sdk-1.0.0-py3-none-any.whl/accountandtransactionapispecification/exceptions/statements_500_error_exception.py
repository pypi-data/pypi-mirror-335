...
class Statements500ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the Statements500ErrorException class
        ...
        """
        super(Statements500ErrorException, self).__init__(reason, response)
