...
class Transactions403ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the Transactions403ErrorException class
        ...
        """
        super(Transactions403ErrorException, self).__init__(reason, response)
