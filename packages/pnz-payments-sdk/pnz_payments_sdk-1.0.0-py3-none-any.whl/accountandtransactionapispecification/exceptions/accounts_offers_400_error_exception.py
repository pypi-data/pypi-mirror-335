...
class AccountsOffers400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the AccountsOffers400ErrorException class
        ...
        """
        super(AccountsOffers400ErrorException, self).__init__(reason, response)
