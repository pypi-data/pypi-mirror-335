...
class ScheduledPayments500ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the ScheduledPayments500ErrorException class
        ...
        """
        super(ScheduledPayments500ErrorException, self).__init__(reason, response)
