...
class AccountsBeneficiaries400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the AccountsBeneficiaries400ErrorException class
        ...
        """
        super(AccountsBeneficiaries400ErrorException, self).__init__(reason, response)
