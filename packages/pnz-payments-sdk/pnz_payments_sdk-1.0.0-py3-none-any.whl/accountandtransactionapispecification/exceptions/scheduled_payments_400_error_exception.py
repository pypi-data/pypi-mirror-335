...
class ScheduledPayments400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the ScheduledPayments400ErrorException class
        ...
        """
        super(ScheduledPayments400ErrorException, self).__init__(reason, response)
