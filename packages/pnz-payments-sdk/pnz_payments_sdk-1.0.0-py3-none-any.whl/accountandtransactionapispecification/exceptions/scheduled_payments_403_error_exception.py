...
class ScheduledPayments403ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the ScheduledPayments403ErrorException class
        ...
        """
        super(ScheduledPayments403ErrorException, self).__init__(reason, response)
