...
class AccountsStatementsTransactions500ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the AccountsStatementsTransactions500ErrorException class
        ...
        """
        super(AccountsStatementsTransactions500ErrorException, self).__init__(reason, response)
