...
class DirectDebits503ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the DirectDebits503ErrorException class
        ...
        """
        super(DirectDebits503ErrorException, self).__init__(reason, response)
