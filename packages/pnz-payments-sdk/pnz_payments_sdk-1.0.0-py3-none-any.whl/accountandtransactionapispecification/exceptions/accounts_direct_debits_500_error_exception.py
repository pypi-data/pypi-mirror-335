...
class AccountsDirectDebits500ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the AccountsDirectDebits500ErrorException class
        ...
        """
        super(AccountsDirectDebits500ErrorException, self).__init__(reason, response)
