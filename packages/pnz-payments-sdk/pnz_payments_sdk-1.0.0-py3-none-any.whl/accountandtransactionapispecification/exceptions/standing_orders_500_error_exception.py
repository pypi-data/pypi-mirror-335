...
class StandingOrders500ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the StandingOrders500ErrorException class
        ...
        """
        super(StandingOrders500ErrorException, self).__init__(reason, response)
