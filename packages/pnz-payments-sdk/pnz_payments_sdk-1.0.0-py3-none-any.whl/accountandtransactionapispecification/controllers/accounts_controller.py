...
from accountandtransactionapispecification.models.account_response import AccountResponse
from accountandtransactionapispecification.exceptions.accounts_400_error_exception import Accounts400ErrorException
from accountandtransactionapispecification.exceptions.api_exception import APIException
from accountandtransactionapispecification.exceptions.accounts_403_error_exception import Accounts403ErrorException
from accountandtransactionapispecification.exceptions.accounts_500_error_exception import Accounts500ErrorException
from accountandtransactionapispecification.exceptions.accounts_503_error_exception import Accounts503ErrorException
...
class AccountsController(BaseController):
    ...
    def get_account(self,
        ...
        Returns:
            AccountResponse: Response from the API. Account resource
        ...
        return super().new_api_call_builder.request(
            ...
            .local_error('400', 'Bad Request', Accounts400ErrorException)
            .local_error('401', 'Unauthorized', APIException)
            .local_error('403', 'Forbidden', Accounts403ErrorException)
            ...
            .local_error('500', 'Internal Server Error', Accounts500ErrorException)
            .local_error('501', 'Not Implemented', APIException)
            .local_error('503', 'Service Unavailable', Accounts503ErrorException)
        ).execute()
    ...
    def get_accounts(self,
        ...
        Returns:
            AccountResponse: Response from the API. Accounts successfully
                retrieved
