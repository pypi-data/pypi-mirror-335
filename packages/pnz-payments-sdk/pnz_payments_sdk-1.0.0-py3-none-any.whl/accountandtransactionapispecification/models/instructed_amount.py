...
class InstructedAmount(object):

    """Implementation of the 'InstructedAmount' model.

    Amount of money of the cash balance after a transaction entry is applied
    to the account..

    Attributes:
        amount (str): A number of monetary units specified in an active
    ...
    def __init__(self,
                 amount=None,
                 currency=None):
        """Constructor for the InstructedAmount class"""
