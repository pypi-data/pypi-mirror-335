...
class DeliveryAddress(object):
    ...
    Attributes:
        address_type (AddressTypeEnum): Identifies the nature of the postal
            address.
        ...
        town_name (str): Name of a built-up area, with defined boundaries, and
            a local government.
        country_sub_division (str): Identifies a subdivision of a country, for
            instance state, region, county.
        country (str): Nation with its own government, occupying a particular
            territory.
