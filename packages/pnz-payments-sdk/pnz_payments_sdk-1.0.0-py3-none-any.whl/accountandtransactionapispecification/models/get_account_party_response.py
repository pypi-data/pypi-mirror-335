...
"""
from accountandtransactionapispecification.models.get_account_party_response_data import GetAccountPartyResponseData
...
class GetAccountPartyResponse(object):

    """Implementation of the 'GetAccountPartyResponse' model.

    Attributes:
        data (GetAccountPartyResponseData): The model property of type
            GetAccountPartyResponseData.
    ...
    def __init__(self,
                 ...
                 links=None,
                 meta=None):
        """Constructor for the GetAccountPartyResponse class"""
    ...
    def from_dictionary(cls,
        ...
        data = GetAccountPartyResponseData.from_dictionary(dictionary.get('Data')) if dictionary.get('Data') else None
