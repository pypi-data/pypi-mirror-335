...
class StatementFee(object):

    """Implementation of the 'StatementFee' model.
    ...
    Attributes:
        ...
        mtype (StatementFeeTypeEnum): Fee type, in a coded form.
    ...
    def __init__(self,
                 ...
                 mtype=None):
        """Constructor for the StatementFee class"""
