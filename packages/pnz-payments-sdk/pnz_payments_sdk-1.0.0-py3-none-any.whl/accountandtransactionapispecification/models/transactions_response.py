...
from accountandtransactionapispecification.models.transactions_response_data import TransactionsResponseData


class TransactionsResponse(object):

    """Implementation of the 'TransactionsResponse' model.

    Attributes:
        data (TransactionsResponseData): The model property of type
    ...
    def __init__(self,
                 ...
                 links=None,
                 meta=None):
        """Constructor for the TransactionsResponse class"""
    ...
    def from_dictionary(cls,
        ...
        data = TransactionsResponseData.from_dictionary(dictionary.get('Data')) if dictionary.get('Data') else None
