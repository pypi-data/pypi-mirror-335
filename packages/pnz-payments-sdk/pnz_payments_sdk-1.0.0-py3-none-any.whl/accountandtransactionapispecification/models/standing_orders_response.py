...
from accountandtransactionapispecification.models.standing_orders_response_data import StandingOrdersResponseData


class StandingOrdersResponse(object):

    """Implementation of the 'StandingOrdersResponse' model.

    Attributes:
        data (StandingOrdersResponseData): The model property of type
    ...
    def __init__(self,
                 ...
                 links=None,
                 meta=None):
        """Constructor for the StandingOrdersResponse class"""
    ...
    def from_dictionary(cls,
        ...
        data = StandingOrdersResponseData.from_dictionary(dictionary.get('Data')) if dictionary.get('Data') else None
