...
"""
from accountandtransactionapispecification.models.get_statements_response_data import GetStatementsResponseData
...
class GetStatementsResponse(object):

    """Implementation of the 'GetStatementsResponse' model.

    Attributes:
        data (GetStatementsResponseData): The model property of type
    ...
    def __init__(self,
                 ...
                 links=None,
                 meta=None):
        """Constructor for the GetStatementsResponse class"""
    ...
    def from_dictionary(cls,
        ...
        data = GetStatementsResponseData.from_dictionary(dictionary.get('Data')) if dictionary.get('Data') else None
