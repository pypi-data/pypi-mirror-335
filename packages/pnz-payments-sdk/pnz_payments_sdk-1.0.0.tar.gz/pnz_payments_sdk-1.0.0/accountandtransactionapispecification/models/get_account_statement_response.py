...
"""
from accountandtransactionapispecification.models.get_account_statement_response_data import GetAccountStatementResponseData
...
class GetAccountStatementResponse(object):

    """Implementation of the 'GetAccountStatementResponse' model.

    Attributes:
        data (GetAccountStatementResponseData): The model property of type
    ...
    def __init__(self,
                 ...
                 links=None,
                 meta=None):
        """Constructor for the GetAccountStatementResponse class"""
    ...
    def from_dictionary(cls,
        ...
        data = GetAccountStatementResponseData.from_dictionary(dictionary.get('Data')) if dictionary.get('Data') else None
