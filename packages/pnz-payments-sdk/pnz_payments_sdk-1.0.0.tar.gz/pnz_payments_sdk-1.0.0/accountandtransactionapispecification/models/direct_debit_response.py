...
"""
from accountandtransactionapispecification.models.direct_debit_response_data import DirectDebitResponseData
...
class DirectDebitResponse(object):
    ...
    """Implementation of the 'DirectDebitResponse' model.

    Attributes:
        data (DirectDebitResponseData): The model property of type
    ...
    def __init__(self,
                 ...
                 links=None,
                 meta=None):
        """Constructor for the DirectDebitResponse class"""
    ...
    def from_dictionary(cls,
        ...
        data = DirectDebitResponseData.from_dictionary(dictionary.get('Data')) if dictionary.get('Data') else None
