...
"""
from accountandtransactionapispecification.models.beneficiaries_response_data import BeneficiariesResponseData
...
class BeneficiariesResponse(object):
    ...
    """Implementation of the 'BeneficiariesResponse' model.

    Attributes:
        data (BeneficiariesResponseData): The model property of type
    ...
    def __init__(self,
                 ...
                 links=None,
                 meta=None):
        """Constructor for the BeneficiariesResponse class"""
    ...
    def from_dictionary(cls,
        ...
        data = BeneficiariesResponseData.from_dictionary(dictionary.get('Data')) if dictionary.get('Data') else None
