...
"""
from accountandtransactionapispecification.models.account_response_data import AccountResponseData
...
class AccountResponse(object):
    ...
    Attributes:
        data (AccountResponseData): The model property of type
            AccountResponseData.
    ...
    def from_dictionary(cls,
        ...
        data = AccountResponseData.from_dictionary(dictionary.get('Data')) if dictionary.get('Data') else None
