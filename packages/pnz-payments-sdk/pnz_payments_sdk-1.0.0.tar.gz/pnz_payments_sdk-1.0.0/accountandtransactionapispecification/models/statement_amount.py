...
class StatementAmount(object):

    """Implementation of the 'StatementAmount' model.
    ...
    Attributes:
        ...
        mtype (StatementAmountTypeEnum): Amount type, in a coded form.
    ...
    def __init__(self,
                 ...
                 mtype=None):
        """Constructor for the StatementAmount class"""
