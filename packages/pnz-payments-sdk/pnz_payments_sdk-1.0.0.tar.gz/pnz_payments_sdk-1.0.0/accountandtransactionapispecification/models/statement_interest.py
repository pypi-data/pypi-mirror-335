...
class StatementInterest(object):

    """Implementation of the 'StatementInterest' model.
    ...
    Attributes:
        ...
        mtype (StatementInterestTypeEnum): Interest amount type, in a coded
            form.
    ...
    def __init__(self,
                 ...
                 mtype=None):
        """Constructor for the StatementInterest class"""
