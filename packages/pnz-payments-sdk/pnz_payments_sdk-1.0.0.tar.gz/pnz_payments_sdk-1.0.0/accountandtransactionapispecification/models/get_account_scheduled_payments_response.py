...
"""
from accountandtransactionapispecification.models.get_scheduled_payments_response_data import GetScheduledPaymentsResponseData
...
class GetAccountScheduledPaymentsResponse(object):

    """Implementation of the 'GetAccountScheduledPaymentsResponse' model.

    Attributes:
        data (GetScheduledPaymentsResponseData): The model property of type
    ...
    def __init__(self,
                 ...
                 links=None,
                 meta=None):
        """Constructor for the GetAccountScheduledPaymentsResponse class"""
    ...
    def from_dictionary(cls,
        ...
        data = GetScheduledPaymentsResponseData.from_dictionary(dictionary.get('Data')) if dictionary.get('Data') else None
