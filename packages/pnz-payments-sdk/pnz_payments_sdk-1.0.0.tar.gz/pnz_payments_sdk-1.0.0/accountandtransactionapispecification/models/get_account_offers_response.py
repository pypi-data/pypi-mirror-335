...
"""
from accountandtransactionapispecification.models.get_offers_response_data import GetOffersResponseData
...
class GetAccountOffersResponse(object):

    """Implementation of the 'GetAccountOffersResponse' model.

    Attributes:
        data (GetOffersResponseData): The model property of type
    ...
    def __init__(self,
                 ...
                 links=None,
                 meta=None):
        """Constructor for the GetAccountOffersResponse class"""
    ...
    def from_dictionary(cls,
        ...
        data = GetOffersResponseData.from_dictionary(dictionary.get('Data')) if dictionary.get('Data') else None
