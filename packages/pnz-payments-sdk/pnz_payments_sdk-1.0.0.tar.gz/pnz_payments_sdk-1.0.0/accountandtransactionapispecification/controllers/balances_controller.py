...
from accountandtransactionapispecification.models.balances_response import BalancesResponse
from accountandtransactionapispecification.exceptions.balances_400_error_exception import Balances400ErrorException
from accountandtransactionapispecification.exceptions.api_exception import APIException
from accountandtransactionapispecification.exceptions.balances_403_error_exception import Balances403ErrorException
from accountandtransactionapispecification.exceptions.balances_500_error_exception import Balances500ErrorException
from accountandtransactionapispecification.exceptions.balances_503_error_exception import Balances503ErrorException
from accountandtransactionapispecification.exceptions.accounts_balances_400_error_exception import AccountsBalances400ErrorException
from accountandtransactionapispecification.exceptions.accounts_balances_403_error_exception import AccountsBalances403ErrorException
from accountandtransactionapispecification.exceptions.accounts_balances_500_error_exception import AccountsBalances500ErrorException
from accountandtransactionapispecification.exceptions.accounts_balances_503_error_exception import AccountsBalances503ErrorException
...
class BalancesController(BaseController):
    ...
    def get_balances(self,
        ...
        Returns:
            BalancesResponse: Response from the API. Balances successfully
                retrieved
        ...
        return super().new_api_call_builder.request(
            ...
            .local_error('400', 'Bad Request', Balances400ErrorException)
            .local_error('401', 'Unauthorized', APIException)
            .local_error('403', 'Forbidden', Balances403ErrorException)
            ...
            .local_error('500', 'Internal Server Error', Balances500ErrorException)
            .local_error('501', 'Not Implemented', APIException)
            .local_error('503', 'Service Unavailable', Balances503ErrorException)
        ).execute()
    ...
    def get_account_balances(self,
                             ...
                             x_merchant_ip_address=None,
                             x_customer_user_agent=None):
        """Does a GET request to /accounts/{AccountId}/balances.
        ...
        Returns:
            BalancesResponse: Response from the API. Account Balances
        ...
        return super().new_api_call_builder.request(
            ...
            .deserializer(APIHelper.json_deserialize)
            .deserialize_into(BalancesResponse.from_dictionary)
            .local_error('400', 'Bad Request', AccountsBalances400ErrorException)
            .local_error('401', 'Unauthorized', APIException)
            .local_error('403', 'Forbidden', AccountsBalances403ErrorException)
            .local_error('405', 'Method Not Allowed', APIException)
            .local_error('406', 'Not Acceptable', APIException)
            .local_error('429', 'Too Many Requests', APIException)
            .local_error('500', 'Internal Server Error', AccountsBalances500ErrorException)
            .local_error('501', 'Not Implemented', APIException)
            .local_error('503', 'Service Unavailable', AccountsBalances503ErrorException)
        ).execute()
