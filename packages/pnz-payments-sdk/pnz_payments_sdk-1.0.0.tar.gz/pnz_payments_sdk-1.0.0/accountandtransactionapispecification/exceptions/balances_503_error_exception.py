...
class Balances503ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the Balances503ErrorException class
        ...
        """
        super(Balances503ErrorException, self).__init__(reason, response)
