...
class AccountsScheduledPayments403ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the AccountsScheduledPayments403ErrorException class
        ...
        """
        super(AccountsScheduledPayments403ErrorException, self).__init__(reason, response)
