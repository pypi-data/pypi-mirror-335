...
class AccountsStandingOrders400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the AccountsStandingOrders400ErrorException class
        ...
        """
        super(AccountsStandingOrders400ErrorException, self).__init__(reason, response)
