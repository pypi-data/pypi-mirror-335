...
class AccountsParty503ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the AccountsParty503ErrorException class
        ...
        """
        super(AccountsParty503ErrorException, self).__init__(reason, response)
