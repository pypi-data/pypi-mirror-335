...
class Transactions503ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the Transactions503ErrorException class
        ...
        """
        super(Transactions503ErrorException, self).__init__(reason, response)
