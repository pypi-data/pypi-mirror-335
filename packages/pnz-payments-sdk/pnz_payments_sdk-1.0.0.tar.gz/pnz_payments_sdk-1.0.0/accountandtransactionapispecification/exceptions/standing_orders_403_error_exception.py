...
class StandingOrders403ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the StandingOrders403ErrorException class
        ...
        """
        super(StandingOrders403ErrorException, self).__init__(reason, response)
