...
class Accounts500ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the Accounts500ErrorException class
        ...
        """
        super(Accounts500ErrorException, self).__init__(reason, response)
