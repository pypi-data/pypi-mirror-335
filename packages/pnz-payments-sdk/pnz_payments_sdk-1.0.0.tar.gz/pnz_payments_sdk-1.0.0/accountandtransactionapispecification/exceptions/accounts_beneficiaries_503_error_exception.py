...
class AccountsBeneficiaries503ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the AccountsBeneficiaries503ErrorException class
        ...
        """
        super(AccountsBeneficiaries503ErrorException, self).__init__(reason, response)
