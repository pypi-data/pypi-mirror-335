...
class AccountsDirectDebits503ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the AccountsDirectDebits503ErrorException class
        ...
        """
        super(AccountsDirectDebits503ErrorException, self).__init__(reason, response)
