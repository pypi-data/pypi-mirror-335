...
class AccountsStandingOrders403ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the AccountsStandingOrders403ErrorException class
        ...
        """
        super(AccountsStandingOrders403ErrorException, self).__init__(reason, response)
