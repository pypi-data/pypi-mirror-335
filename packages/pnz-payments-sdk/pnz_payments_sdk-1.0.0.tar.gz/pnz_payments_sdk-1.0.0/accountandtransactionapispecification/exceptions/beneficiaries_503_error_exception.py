...
class Beneficiaries503ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the Beneficiaries503ErrorException class
        ...
        """
        super(Beneficiaries503ErrorException, self).__init__(reason, response)
