...
class AccountsBeneficiaries500ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the AccountsBeneficiaries500ErrorException class
        ...
        """
        super(AccountsBeneficiaries500ErrorException, self).__init__(reason, response)
