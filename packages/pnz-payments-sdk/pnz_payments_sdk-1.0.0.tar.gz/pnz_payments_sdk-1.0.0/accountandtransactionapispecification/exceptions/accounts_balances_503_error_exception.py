...
class AccountsBalances503ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the AccountsBalances503ErrorException class
        ...
        """
        super(AccountsBalances503ErrorException, self).__init__(reason, response)
