...
class Offers400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the Offers400ErrorException class
        ...
        """
        super(Offers400ErrorException, self).__init__(reason, response)
