...
class AccountsTransactions400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the AccountsTransactions400ErrorException class
        ...
        """
        super(AccountsTransactions400ErrorException, self).__init__(reason, response)
