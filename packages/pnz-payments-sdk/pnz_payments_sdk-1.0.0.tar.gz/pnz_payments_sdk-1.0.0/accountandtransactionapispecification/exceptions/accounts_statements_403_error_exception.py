...
class AccountsStatements403ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the AccountsStatements403ErrorException class
        ...
        """
        super(AccountsStatements403ErrorException, self).__init__(reason, response)
