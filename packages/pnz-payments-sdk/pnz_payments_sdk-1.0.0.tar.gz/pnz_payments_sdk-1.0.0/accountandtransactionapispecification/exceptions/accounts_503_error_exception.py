...
class Accounts503ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the Accounts503ErrorException class
        ...
        """
        super(Accounts503ErrorException, self).__init__(reason, response)
