...
class Statements503ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the Statements503ErrorException class
        ...
        """
        super(Statements503ErrorException, self).__init__(reason, response)
