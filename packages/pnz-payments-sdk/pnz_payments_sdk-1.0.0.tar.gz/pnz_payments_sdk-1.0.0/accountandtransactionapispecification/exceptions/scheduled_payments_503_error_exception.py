...
class ScheduledPayments503ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the ScheduledPayments503ErrorException class
        ...
        """
        super(ScheduledPayments503ErrorException, self).__init__(reason, response)
