...
class AccountsStandingOrders500ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the AccountsStandingOrders500ErrorException class
        ...
        """
        super(AccountsStandingOrders500ErrorException, self).__init__(reason, response)
