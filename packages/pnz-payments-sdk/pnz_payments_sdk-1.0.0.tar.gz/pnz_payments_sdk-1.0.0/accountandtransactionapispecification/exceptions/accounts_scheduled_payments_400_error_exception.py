...
class AccountsScheduledPayments400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the AccountsScheduledPayments400ErrorException class
        ...
        """
        super(AccountsScheduledPayments400ErrorException, self).__init__(reason, response)
