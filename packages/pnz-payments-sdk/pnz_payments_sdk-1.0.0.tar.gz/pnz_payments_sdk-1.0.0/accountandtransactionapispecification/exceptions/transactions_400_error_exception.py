...
class Transactions400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the Transactions400ErrorException class
        ...
        """
        super(Transactions400ErrorException, self).__init__(reason, response)
