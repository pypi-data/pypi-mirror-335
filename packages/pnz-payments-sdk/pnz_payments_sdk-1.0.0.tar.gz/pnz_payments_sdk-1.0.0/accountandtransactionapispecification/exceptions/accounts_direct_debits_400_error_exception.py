...
class AccountsDirectDebits400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the AccountsDirectDebits400ErrorException class
        ...
        """
        super(AccountsDirectDebits400ErrorException, self).__init__(reason, response)
