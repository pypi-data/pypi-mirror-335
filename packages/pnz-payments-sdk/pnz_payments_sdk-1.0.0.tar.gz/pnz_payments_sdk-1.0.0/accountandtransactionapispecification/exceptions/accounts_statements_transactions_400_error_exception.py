...
class AccountsStatementsTransactions400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the AccountsStatementsTransactions400ErrorException class
        ...
        """
        super(AccountsStatementsTransactions400ErrorException, self).__init__(reason, response)
