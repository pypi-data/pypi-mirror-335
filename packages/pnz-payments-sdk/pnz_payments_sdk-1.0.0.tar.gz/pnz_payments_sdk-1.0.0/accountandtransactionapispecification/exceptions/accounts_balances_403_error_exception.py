...
class AccountsBalances403ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the AccountsBalances403ErrorException class
        ...
        """
        super(AccountsBalances403ErrorException, self).__init__(reason, response)
