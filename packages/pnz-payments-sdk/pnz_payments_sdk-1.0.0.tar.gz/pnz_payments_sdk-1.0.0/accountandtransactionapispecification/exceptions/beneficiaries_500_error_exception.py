...
class Beneficiaries500ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the Beneficiaries500ErrorException class
        ...
        """
        super(Beneficiaries500ErrorException, self).__init__(reason, response)
