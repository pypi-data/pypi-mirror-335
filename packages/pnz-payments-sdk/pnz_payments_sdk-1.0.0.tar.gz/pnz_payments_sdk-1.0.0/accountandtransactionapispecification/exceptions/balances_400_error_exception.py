...
class Balances400ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the Balances400ErrorException class
        ...
        """
        super(Balances400ErrorException, self).__init__(reason, response)
