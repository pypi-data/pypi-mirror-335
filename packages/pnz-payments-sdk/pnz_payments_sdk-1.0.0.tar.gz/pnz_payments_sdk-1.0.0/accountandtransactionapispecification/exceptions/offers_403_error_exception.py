...
class Offers403ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the Offers403ErrorException class
        ...
        """
        super(Offers403ErrorException, self).__init__(reason, response)
