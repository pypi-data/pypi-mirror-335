...
class StandingOrders503ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the StandingOrders503ErrorException class
        ...
        """
        super(StandingOrders503ErrorException, self).__init__(reason, response)
