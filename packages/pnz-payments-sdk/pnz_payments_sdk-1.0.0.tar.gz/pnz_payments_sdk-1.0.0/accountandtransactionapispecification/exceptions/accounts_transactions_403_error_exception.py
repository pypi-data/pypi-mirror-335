...
class AccountsTransactions403ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the AccountsTransactions403ErrorException class
        ...
        """
        super(AccountsTransactions403ErrorException, self).__init__(reason, response)
