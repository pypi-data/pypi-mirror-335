...
class DirectDebits500ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the DirectDebits500ErrorException class
        ...
        """
        super(DirectDebits500ErrorException, self).__init__(reason, response)
