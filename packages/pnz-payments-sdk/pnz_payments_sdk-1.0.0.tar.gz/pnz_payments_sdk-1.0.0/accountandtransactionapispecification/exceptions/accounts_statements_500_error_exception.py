...
class AccountsStatements500ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the AccountsStatements500ErrorException class
        ...
        """
        super(AccountsStatements500ErrorException, self).__init__(reason, response)
