...
class Transactions500ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the Transactions500ErrorException class
        ...
        """
        super(Transactions500ErrorException, self).__init__(reason, response)
