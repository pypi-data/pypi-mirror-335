...
class AccountsStandingOrders503ErrorException(APIException):
    def __init__(self, reason, response):
        """Constructor for the AccountsStandingOrders503ErrorException class
        ...
        """
        super(AccountsStandingOrders503ErrorException, self).__init__(reason, response)
