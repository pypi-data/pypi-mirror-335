...
class ChainlitAdapter(SDKAdapter):
    ...
    async def process_tool_calls(self, is_sequence_agent: bool, sequence_agent_graph_items:List[GraphItem], reported_sequence_sub_agent_ids: set, run_id: str, tool_calls: Dict[int, ChainlitToolCallWithLLMResponse], on_node_enter: Optional[Callable], on_node_error: Optional[Callable], agent_custom_functions: list[GraphItem] = [], local_tools: Dict[str, Callable] = None) -> str | None:
        """
