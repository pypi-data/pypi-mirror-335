...
class Electron_v1:
    ...
    def trackParticle(self, index: int) -> func_adl_servicex_xaodr25.xAOD.trackparticle_v1.TrackParticle_v1:
        "A method"
        ...

    def trackParticleLink(self, index: int) -> func_adl_servicex_xaodr25.elementlink_datavector_xaod_trackparticle_v1__.ElementLink_DataVector_xAOD_TrackParticle_v1__:
        "A method"
        ...
    ...
    def trackCaloMatchValue(self, value: float, information: func_adl_servicex_xaodr25.xAOD.egammaparameters.EgammaParameters.TrackCaloMatchType) -> bool:
        "A method"
        ...

    def setTrackCaloMatchValue(self, value: float, information: func_adl_servicex_xaodr25.xAOD.egammaparameters.EgammaParameters.TrackCaloMatchType) -> bool:
        "A method"
        ...

    def trackParticleSummaryValue(self, value: int, information: func_adl_servicex_xaodr25.xaod.xAOD.SummaryType, index: int) -> bool:
        "A method"
        ...

    def trackParticleSummaryIntValue(self, information: func_adl_servicex_xaodr25.xaod.xAOD.SummaryType, index: int) -> int:
        "A method"
        ...

    def trackParticleSummaryFloatValue(self, information: func_adl_servicex_xaodr25.xaod.xAOD.SummaryType, index: int) -> float:
        "A method"
        ...
