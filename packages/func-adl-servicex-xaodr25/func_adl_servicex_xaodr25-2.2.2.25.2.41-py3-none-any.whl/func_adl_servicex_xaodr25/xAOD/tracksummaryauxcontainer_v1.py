...
_method_map = {
    'memResource': {
        ...
        'type_string': 'xAOD::TrackSummaryAuxContainer_v1',
...
def _add_method_metadata(s: ObjectStream[T], a: ast.Call) -> Tuple[ObjectStream[T], ast.Call]:
    ...
    if a.func.attr in _method_map:
        ...
        s_update = s_update.MetaData({
            ...
            'name': 'xAODTracking/versions/TrackSummaryAuxContainer_v1.h',
            'body_includes': ["xAODTracking/versions/TrackSummaryAuxContainer_v1.h"],
        })
