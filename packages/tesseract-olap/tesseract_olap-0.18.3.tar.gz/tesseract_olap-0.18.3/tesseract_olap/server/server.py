...
from tesseract_olap.backend import Backend, CacheProvider, DummyProvider, LfuProvider, Result
...
class OlapServer:
    ...
    def debug_query(self, query: AnyQuery) -> dict[str, str]:
        """Build the SQL query for a Query instance, using the backend currently configured in this server."""
    ...
    def validate(self) -> None:
        """Verify the information declared in the Schema matches the structures in the Backend."""
