...
from ..datamodels.seismic.SeisHorizon import SeisHorizon, SeisHorizonValue
...
class SeismicService:
    ...
    def get_horizon_values(self, horizon: SeisHorizon) -> List[SeisHorizonValue]:
        """
        ...
        :return: A list of inline, crossline, x, y, z values for every value in the horizon.
        ...
        for inline in range(inlines.start, inlines.stop):
            for crossline in range(crosslines.start, crosslines.stop):
                ...
                value = SeisHorizonValue(inline, crossline, c)
                values.append(value)
        return values
