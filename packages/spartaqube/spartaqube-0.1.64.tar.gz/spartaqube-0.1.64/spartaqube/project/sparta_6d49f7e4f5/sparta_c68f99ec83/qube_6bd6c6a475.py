...
from spartaqube_app.secrets import sparta_37547bdcfb
...
def sendEmailFunc(emailObj,USERNAME_SMTP=_A,PASSWORD_SMTP=_A,EMAIL_SMTP=_A,HOST=_A,PORT=25,SENDERNAME=_A):
	...
	if F is _A:D=sparta_37547bdcfb();HOST=D['EMAIL_HOST_SMTP'];F=D['EMAIL_USERNAME_SMTP'];H=D['EMAIL_RECIPIENT'];K=D['EMAIL_PASSWORD_SMTP'];PORT=D['EMAIL_PORT_SMTP'];G=D['EMAIL_SENDERNAME']
