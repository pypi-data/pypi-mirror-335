...
def sparta_76f1053f28(type='line'):A=_F;B={_H:_K,_I:_L,_J:_M};C=_N;D=_O;return[{_A:f"Simple {type}",_B:_E,_C:'',_D:f"""{A}
...
plot_example"""}]
def sparta_3cbf1d788a():return sparta_76f1053f28(type='line')
def sparta_9e67d01d00():return sparta_76f1053f28(type='bar')
def sparta_d527118993():return sparta_76f1053f28(type='scatter')
def sparta_794391c29f():A=_F;type='area';B={_H:_K,_I:_L,_J:_M};C=_N;D=_O;return[{_A:f"Simple {type}",_B:_E,_C:'',_D:f"""{A}
import yfinance as yf
spartaqube_obj = Spartaqube()
# Fetch the data for Apple (ticker symbol: AAPL)
apple_price_df = yf.Ticker(\"AAPL\").history(period=\"1y\")
...
plot_example"""}]
def sparta_f7575e3ccf(type='pie'):A=_F;D={_H:_K,_I:_L,_J:_M};B='{\n    "datasets": [\n        {\n            "datalabels": {\n                "display": True,\n                "color": "red",\n                "font": {\n                    "family": "Azonix",\n                    "size": 20,\n                }\n            },\n        }\n    ]\n  }';C='{\n    "datasets": [\n        {\n            "backgroundColor": [\'red\', \'blue\', \'green\'],\n            "borderColor": [\'red\', \'blue\', \'green\'],\n        }\n    ]\n  }';return[{_A:f"Simple {type}",_B:_E,_C:'',_D:f"""{A}
import yfinance as yf
spartaqube_obj = Spartaqube()
# Plot example
plot_example = spartaqube_obj.plot(
...
plot_example"""}]
def sparta_36a0a86844():return sparta_f7575e3ccf(type='donut')
def sparta_b5854308e2():return sparta_f7575e3ccf(type='polar')
def sparta_a964108e8f():type='bubble';A=_F;B={_H:_K,_I:_L,_J:_M};C=_N;D=_O;return[{_A:f"Simple {type}",_B:_E,_C:'',_D:f"""{A}
import yfinance as yf
spartaqube_obj = Spartaqube()
# Fetch the data for Apple (ticker symbol: AAPL)
apple_price_df = yf.Ticker(\"AAPL\").history(period=\"1y\")
...
plot_example"""}]
def sparta_30ed66fd82():A=_F;B={_H:_K,_I:_L,_J:_M};C=_N;D=_O;type='barH';return[{_A:f"Simple horizontal bar",_B:_E,_C:'',_D:f"""{A}
import yfinance as yf
spartaqube_obj = Spartaqube()
# Fetch the data for Apple (ticker symbol: AAPL)
apple_price_df = yf.Ticker(\"AAPL\").history(period=\"1y\")
...
plot_example"""}]
def sparta_894b82f8be():A=_F;type='radar';C={_H:_K,_I:_L,_J:_M};D=_N;E=_O;B='{\n    "datasets": [\n        {\n            "tension": 0\n        }\n    ]\n  }';return[{_A:f"Simple {type}",_B:_E,_C:'',_D:f'''{A}
import yfinance as yf
spartaqube_obj = Spartaqube()
# Plot example
plot_example = spartaqube_obj.plot(
...
plot_example'''}]
def sparta_1b86bac6d8():A=_F;type='mixed';B='{\n    "datasets": [\n        {\n            "type": \'bar\',\n        },\n        {\n            "type": \'line\',\n        }\n    ]\n  }';return[{_A:f"Simple {type}",_B:_E,_C:'',_D:f"""{A}
import yfinance as yf
spartaqube_obj = Spartaqube()
# Fetch the data for Apple (ticker symbol: AAPL)
apple_price_df = yf.Ticker(\"AAPL\").history(period=\"1y\")
...
plot_example"""}]
def sparta_c72b2f7401():A=_F;type='histogram';return[{_A:f"Simple {type}",_B:_E,_C:'',_D:f"""{A}
import yfinance as yf
spartaqube_obj = Spartaqube()
# Fetch the data for Apple (ticker symbol: AAPL)
apple_price_df = yf.Ticker(\"AAPL\").history(period=\"1y\")
