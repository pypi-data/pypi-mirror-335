...
def sparta_76f1053f28(type=_M):B=_F;D={_G:_J,_H:_K,_I:_L};A=_N;C='{\n        "showTicks": True,\n        "renderTicks": {\n            "showTicks": True,\n            "divisions": 10,\n        },\n    }';return[{_A:f"{type.capitalize()}",_B:_E,_C:'',_D:f"""{B}
...
plot_example"""}]
def sparta_f8e2989dff():return sparta_76f1053f28(type=_M)
def sparta_1d5530e409():return sparta_76f1053f28(type='gauge2')
def sparta_89710fdf20():type='gauge3';B=_F;D={_G:_J,_H:_K,_I:_L};A={'min':0,'max':100,'value':34};C=_O;return[{_A:f"{type.capitalize()}",_B:_E,_C:'',_D:f"""{B}
spartaqube_obj = Spartaqube()
gauge_data_dict = {A}
# Plot example
plot_example = spartaqube_obj.plot(
...
plot_example"""}]
def sparta_077ace28c3():type='gauge4';B=_F;D={_G:_J,_H:_K,_I:_L};A=_N;C=_O;return[{_A:f"{type.capitalize()}",_B:_E,_C:'',_D:f"""{B}
spartaqube_obj = Spartaqube()
gauge_data_dict = {A}
# Plot example
plot_example = spartaqube_obj.plot(
