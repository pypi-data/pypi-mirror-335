...
def sparta_c0dc62715d(user_obj):
	B=user_obj
	...
	return A
def sparta_72aad935ff(json_data,user_obj):
...
def sparta_d838a3ed68(json_data,user_obj):
...
def sparta_b1bad52ebe(json_data,user_obj):
	...
	return{_C:1}
def sparta_a40e5b8e62(json_data,user_obj):
