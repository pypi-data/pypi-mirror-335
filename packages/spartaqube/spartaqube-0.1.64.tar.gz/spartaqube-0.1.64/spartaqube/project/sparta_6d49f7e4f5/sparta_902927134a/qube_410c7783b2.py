...
from project.sparta_d3863a192d.qube_2cbcb52244 import timeout
from project.sparta_6d49f7e4f5.sparta_bb74460757.qube_795f848f90 import convert_to_dataframe,sparta_cfece85c36
from project.sparta_6d49f7e4f5.sparta_bb74460757.qube_96ecfb2e32 import sparta_dac749eee2
from project.logger_config import logger
B_DEBUG=_B
SEND_INTERVAL=.8
def sparta_1baba57120():return conf_settings.DEFAULT_TIMEOUT
def sparta_08e29dcb68(file_path=_A,text=_A):
	A=file_path
...
class IPythonKernel:
	...
	async def initialize_kernel(B):
		...
		A+='django.setup()\n';D=sparta_3acf216d77()['project'];E=sparta_3acf216d77()['project/core/api'];A+=f'sys.path.insert(0, r"{str(D)}")\n';A+=f'sys.path.insert(0, r"{str(E)}")\n';A+=f'os.environ["api_key"] = "{B.api_key}"\n'
	...
	async def activate_venv(C,venv_name):
		def D():B=sparta_dac749eee2();A=os.path.join(B,'sq_venv');A=os.path.normpath(A);os.makedirs(A,exist_ok=_C);return A
