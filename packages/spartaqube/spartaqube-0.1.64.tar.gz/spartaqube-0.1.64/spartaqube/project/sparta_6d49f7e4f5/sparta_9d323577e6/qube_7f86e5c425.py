...
def sparta_366b4f8cf1(user_obj):
	...
	return B
def sparta_2def09947a(json_data,user_obj):
	g='notebooks';f='dashboards';e='widgets';d=False;c='plot_chart_id';S=True;R='description_trunc';P='description';O='name_trunc';N='name';C=user_obj;G=json_data['keyword'].lower();D=120;E=sparta_366b4f8cf1(C)
