...
from project.sparta_3bc15131c6.sparta_ef73db400d.qube_a300615bb6 import sparta_976fb3087b
...
class Spartaqube:
	...
	def get_widget_data(A,widget_id):B={_D:'get_widget_data',_B:widget_id};return sparta_976fb3087b(B,A.user_obj)
	def sparta_4766ab7476(A,widget_id):B={_D:'has_widget_id',_B:widget_id};return sparta_976fb3087b(B,A.user_obj)
	...
	def plot(V,*W,**A):
		...
		if E is _A:
			L=sparta_813aa1a49c(b_return_type_id=_C)
	...
	def get_connector_tables(A,connector_id):B={_D:'get_connector_tables',_H:connector_id};return sparta_976fb3087b(B,A.user_obj)
	def get_data_from_connector(I,connector_id,table=_A,sql_query=_A,output_format=_A,dynamic_inputs=_A):
		...
		A['dynamic_inputs']=H;B=sparta_976fb3087b(A,I.user_obj);C=False
		if F is _A:C=_C
		...
		return B
	def apply_method(B,method_name,*D,**C):A=C;A[_D]=method_name;return sparta_976fb3087b(A,B.user_obj)
