...
def sparta_9315ce97d4(type=_M):B=_F;D={_G:_J,_H:_K,_I:_L};A=_N;C='{\n        "showTicks": True,\n        "renderTicks": {\n            "showTicks": True,\n            "divisions": 10,\n        },\n    }';return[{_A:f"{type.capitalize()}",_B:_E,_C:'',_D:f"""{B}
...
plot_example"""}]
def sparta_3ea646fa7d():return sparta_9315ce97d4(type=_M)
def sparta_b2beca9a06():return sparta_9315ce97d4(type='gauge2')
def sparta_2a54dca4d2():type='gauge3';B=_F;D={_G:_J,_H:_K,_I:_L};A={'min':0,'max':100,'value':34};C=_O;return[{_A:f"{type.capitalize()}",_B:_E,_C:'',_D:f"""{B}
spartaqube_obj = Spartaqube()
gauge_data_dict = {A}
# Plot example
plot_example = spartaqube_obj.plot(
...
plot_example"""}]
def sparta_ce95739cec():type='gauge4';B=_F;D={_G:_J,_H:_K,_I:_L};A=_N;C=_O;return[{_A:f"{type.capitalize()}",_B:_E,_C:'',_D:f"""{B}
spartaqube_obj = Spartaqube()
gauge_data_dict = {A}
# Plot example
plot_example = spartaqube_obj.plot(
