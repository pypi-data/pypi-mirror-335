...
def sparta_9315ce97d4(type='line'):A=_F;B={_H:_K,_I:_L,_J:_M};C=_N;D=_O;return[{_A:f"Simple {type}",_B:_E,_C:'',_D:f"""{A}
...
plot_example"""}]
def sparta_76e311cbe9():return sparta_9315ce97d4(type='line')
def sparta_4c66d9be42():return sparta_9315ce97d4(type='bar')
def sparta_d2cf639bb3():return sparta_9315ce97d4(type='scatter')
def sparta_90948e6f3d():A=_F;type='area';B={_H:_K,_I:_L,_J:_M};C=_N;D=_O;return[{_A:f"Simple {type}",_B:_E,_C:'',_D:f"""{A}
import yfinance as yf
spartaqube_obj = Spartaqube()
# Fetch the data for Apple (ticker symbol: AAPL)
apple_price_df = yf.Ticker(\"AAPL\").history(period=\"1y\")
...
plot_example"""}]
def sparta_76bf256023(type='pie'):A=_F;D={_H:_K,_I:_L,_J:_M};B='{\n    "datasets": [\n        {\n            "datalabels": {\n                "display": True,\n                "color": "red",\n                "font": {\n                    "family": "Azonix",\n                    "size": 20,\n                }\n            },\n        }\n    ]\n  }';C='{\n    "datasets": [\n        {\n            "backgroundColor": [\'red\', \'blue\', \'green\'],\n            "borderColor": [\'red\', \'blue\', \'green\'],\n        }\n    ]\n  }';return[{_A:f"Simple {type}",_B:_E,_C:'',_D:f"""{A}
import yfinance as yf
spartaqube_obj = Spartaqube()
# Plot example
plot_example = spartaqube_obj.plot(
...
plot_example"""}]
def sparta_9604ea0467():return sparta_76bf256023(type='donut')
def sparta_c88ec30533():return sparta_76bf256023(type='polar')
def sparta_52374e3ac9():type='bubble';A=_F;B={_H:_K,_I:_L,_J:_M};C=_N;D=_O;return[{_A:f"Simple {type}",_B:_E,_C:'',_D:f"""{A}
import yfinance as yf
spartaqube_obj = Spartaqube()
# Fetch the data for Apple (ticker symbol: AAPL)
apple_price_df = yf.Ticker(\"AAPL\").history(period=\"1y\")
...
plot_example"""}]
def sparta_c7aad7b9a0():A=_F;B={_H:_K,_I:_L,_J:_M};C=_N;D=_O;type='barH';return[{_A:f"Simple horizontal bar",_B:_E,_C:'',_D:f"""{A}
import yfinance as yf
spartaqube_obj = Spartaqube()
# Fetch the data for Apple (ticker symbol: AAPL)
apple_price_df = yf.Ticker(\"AAPL\").history(period=\"1y\")
...
plot_example"""}]
def sparta_e486b3ee81():A=_F;type='radar';C={_H:_K,_I:_L,_J:_M};D=_N;E=_O;B='{\n    "datasets": [\n        {\n            "tension": 0\n        }\n    ]\n  }';return[{_A:f"Simple {type}",_B:_E,_C:'',_D:f'''{A}
import yfinance as yf
spartaqube_obj = Spartaqube()
# Plot example
plot_example = spartaqube_obj.plot(
...
plot_example'''}]
def sparta_5e8d16084e():A=_F;type='mixed';B='{\n    "datasets": [\n        {\n            "type": \'bar\',\n        },\n        {\n            "type": \'line\',\n        }\n    ]\n  }';return[{_A:f"Simple {type}",_B:_E,_C:'',_D:f"""{A}
import yfinance as yf
spartaqube_obj = Spartaqube()
# Fetch the data for Apple (ticker symbol: AAPL)
apple_price_df = yf.Ticker(\"AAPL\").history(period=\"1y\")
...
plot_example"""}]
def sparta_8c823f6d66():A=_F;type='histogram';return[{_A:f"Simple {type}",_B:_E,_C:'',_D:f"""{A}
import yfinance as yf
spartaqube_obj = Spartaqube()
# Fetch the data for Apple (ticker symbol: AAPL)
apple_price_df = yf.Ticker(\"AAPL\").history(period=\"1y\")
