...
def sparta_8491adb7c5(user_obj):
	B=user_obj
	...
	return A
def sparta_e398208026(json_data,user_obj):
...
def sparta_2122b73a37(json_data,user_obj):
...
def sparta_3caa1ea485(json_data,user_obj):
	...
	return{_C:1}
def sparta_8f9091b7a2(json_data,user_obj):
