...
class ProbeConfig(TypedDict, total=False):
    video: Union[Literal["all"], list[VideoCodec]]
    audio: Union[Literal["all"], list[AudioCodec]]
    microphone: Union[Literal["all"], list[AudioCodec]]
