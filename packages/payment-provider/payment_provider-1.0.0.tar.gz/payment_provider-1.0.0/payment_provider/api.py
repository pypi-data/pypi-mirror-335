...
from payment_provider.configuration import (__api_url__, __protocol__, __r_type__)
from payment_provider import exceptions

import os
import requests
import logging
import payment_provider.helpers as helper
import payment_provider.utils as utils
...
class Api(object):
    ...
    def __init__(self, **kwargs):
        ...
        if not self.merchant_id or not self.secret_key:
            ...
            self.secret_key = os.environ.get('PAYMENT_SECRETKEY', '')
        domain = kwargs.get('api_domain', 'pay.hutko.org')
