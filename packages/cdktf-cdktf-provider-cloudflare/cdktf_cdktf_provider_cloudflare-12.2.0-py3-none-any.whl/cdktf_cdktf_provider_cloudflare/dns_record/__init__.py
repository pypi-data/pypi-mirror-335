...
class DnsRecord(
    ...
    def __init__(
        ...
        *,
        ...
        :param name: DNS record name (or @ for the zone apex) in Punycode. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/dns_record#name DnsRecord#name}
        :param ttl: Time To Live (TTL) of the DNS record in seconds. Setting to 1 means 'automatic'. Value must be between 60 and 86400, with the minimum reduced to 30 for Enterprise zones. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/dns_record#ttl DnsRecord#ttl}
        :param type: Record type. Available values: "A". Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/dns_record#type DnsRecord#type}
        :param zone_id: Identifier. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/dns_record#zone_id DnsRecord#zone_id}
        :param comment: Comments or notes about the DNS record. This field has no effect on DNS responses. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/dns_record#comment DnsRecord#comment}
        :param content: A valid IPv4 address. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/dns_record#content DnsRecord#content}
        :param data: Components of a CAA record. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/dns_record#data DnsRecord#data}
        :param priority: Required for MX, SRV and URI records; unused by other record types. Records with lower priorities are preferred. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/dns_record#priority DnsRecord#priority}
        :param proxied: Whether the record is receiving the performance and security benefits of Cloudflare. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/dns_record#proxied DnsRecord#proxied}
        :param settings: Settings for the DNS record. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/dns_record#settings DnsRecord#settings}
        :param tags: Custom tags for the DNS record. This field has no effect on DNS responses. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/dns_record#tags DnsRecord#tags}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing DnsRecord that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/dns_record#import import section} in the documentation of this resource for the id to use
    ...
    def put_data(
        ...
        *,
        ...
        '''
        :param algorithm: Algorithm. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/dns_record#algorithm DnsRecord#algorithm}
        :param altitude: Altitude of location in meters. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/dns_record#altitude DnsRecord#altitude}
        :param certificate: Certificate. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/dns_record#certificate DnsRecord#certificate}
        :param digest: Digest. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/dns_record#digest DnsRecord#digest}
        :param digest_type: Digest Type. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/dns_record#digest_type DnsRecord#digest_type}
        :param fingerprint: fingerprint. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/dns_record#fingerprint DnsRecord#fingerprint}
        :param flags: Flags for the CAA record. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/dns_record#flags DnsRecord#flags}
        :param key_tag: Key Tag. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/dns_record#key_tag DnsRecord#key_tag}
        :param lat_degrees: Degrees of latitude. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/dns_record#lat_degrees DnsRecord#lat_degrees}
        :param lat_direction: Latitude direction. Available values: "N", "S". Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/dns_record#lat_direction DnsRecord#lat_direction}
        :param lat_minutes: Minutes of latitude. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/dns_record#lat_minutes DnsRecord#lat_minutes}
        :param lat_seconds: Seconds of latitude. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/dns_record#lat_seconds DnsRecord#lat_seconds}
        :param long_degrees: Degrees of longitude. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/dns_record#long_degrees DnsRecord#long_degrees}
        :param long_direction: Longitude direction. Available values: "E", "W". Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/dns_record#long_direction DnsRecord#long_direction}
        :param long_minutes: Minutes of longitude. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/dns_record#long_minutes DnsRecord#long_minutes}
        :param long_seconds: Seconds of longitude. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/dns_record#long_seconds DnsRecord#long_seconds}
        :param matching_type: Matching Type. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/dns_record#matching_type DnsRecord#matching_type}
        :param order: Order. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/dns_record#order DnsRecord#order}
        :param port: The port of the service. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/dns_record#port DnsRecord#port}
        :param precision_horz: Horizontal precision of location. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/dns_record#precision_horz DnsRecord#precision_horz}
        :param precision_vert: Vertical precision of location. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/dns_record#precision_vert DnsRecord#precision_vert}
        :param preference: Preference. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/dns_record#preference DnsRecord#preference}
        :param priority: priority. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/dns_record#priority DnsRecord#priority}
        :param protocol: Protocol. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/dns_record#protocol DnsRecord#protocol}
        :param public_key: Public Key. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/dns_record#public_key DnsRecord#public_key}
        :param regex: Regex. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/dns_record#regex DnsRecord#regex}
        :param replacement: Replacement. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/dns_record#replacement DnsRecord#replacement}
        :param selector: Selector. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/dns_record#selector DnsRecord#selector}
        :param service: Service. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/dns_record#service DnsRecord#service}
        :param size: Size of location in meters. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/dns_record#size DnsRecord#size}
        :param tag: Name of the property controlled by this record (e.g.: issue, issuewild, iodef). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/dns_record#tag DnsRecord#tag}
        :param target: target. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/dns_record#target DnsRecord#target}
        :param type: Type. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/dns_record#type DnsRecord#type}
        :param usage: Usage. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/dns_record#usage DnsRecord#usage}
        :param value: Value of the record. This field's semantics depend on the chosen tag. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/dns_record#value DnsRecord#value}
        :param weight: The record weight. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/dns_record#weight DnsRecord#weight}
        '''
    ...
    def put_settings(
        ...
        *,
        ...
        '''
        :param flatten_cname: If enabled, causes the CNAME record to be resolved externally and the resulting address records (e.g., A and AAAA) to be returned instead of the CNAME record itself. This setting is unavailable for proxied records, since they are always flattened. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/dns_record#flatten_cname DnsRecord#flatten_cname}
        :param ipv4_only: When enabled, only A records will be generated, and AAAA records will not be created. This setting is intended for exceptional cases. Note that this option only applies to proxied records and it has no effect on whether Cloudflare communicates with the origin using IPv4 or IPv6. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/dns_record#ipv4_only DnsRecord#ipv4_only}
        :param ipv6_only: When enabled, only AAAA records will be generated, and A records will not be created. This setting is intended for exceptional cases. Note that this option only applies to proxied records and it has no effect on whether Cloudflare communicates with the origin using IPv4 or IPv6. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/dns_record#ipv6_only DnsRecord#ipv6_only}
        '''
