...
class StreamWatermarkA(
    ...
    def __init__(
        ...
        *,
        ...
        :param account_id: The account identifier tag. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/stream_watermark#account_id StreamWatermarkA#account_id}
        :param file: The image file to upload. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/stream_watermark#file StreamWatermarkA#file}
        :param identifier: The unique identifier for a watermark profile. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/stream_watermark#identifier StreamWatermarkA#identifier}
        :param name: A short description of the watermark profile. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/stream_watermark#name StreamWatermarkA#name}
        :param opacity: The translucency of the image. A value of ``0.0`` makes the image completely transparent, and ``1.0`` makes the image completely opaque. Note that if the image is already semi-transparent, setting this to ``1.0`` will not make the image completely opaque. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/stream_watermark#opacity StreamWatermarkA#opacity}
        :param padding: The whitespace between the adjacent edges (determined by position) of the video and the image. ``0.0`` indicates no padding, and ``1.0`` indicates a fully padded video width or length, as determined by the algorithm. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/stream_watermark#padding StreamWatermarkA#padding}
        :param position: The location of the image. Valid positions are: ``upperRight``, ``upperLeft``, ``lowerLeft``, ``lowerRight``, and ``center``. Note that ``center`` ignores the ``padding`` parameter. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/stream_watermark#position StreamWatermarkA#position}
        :param scale: The size of the image relative to the overall size of the video. This parameter will adapt to horizontal and vertical videos automatically. ``0.0`` indicates no scaling (use the size of the image as-is), and ``1.0 ``fills the entire video. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/stream_watermark#scale StreamWatermarkA#scale}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing StreamWatermarkA that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/stream_watermark#import import section} in the documentation of this resource for the id to use
