...
class Ruleset(
    ...
    def __init__(
        ...
        *,
        ...
        :param kind: The kind of the ruleset. Available values: "managed", "custom", "root", "zone". Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#kind Ruleset#kind}
        :param name: The human-readable name of the ruleset. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#name Ruleset#name}
        :param phase: The phase of the ruleset. Available values: "ddos_l4", "ddos_l7", "http_config_settings", "http_custom_errors", "http_log_custom_fields", "http_ratelimit", "http_request_cache_settings", "http_request_dynamic_redirect", "http_request_firewall_custom", "http_request_firewall_managed", "http_request_late_transform", "http_request_origin", "http_request_redirect", "http_request_sanitize", "http_request_sbfm", "http_request_transform", "http_response_compression", "http_response_firewall_managed", "http_response_headers_transform", "magic_transit", "magic_transit_ids_managed", "magic_transit_managed", "magic_transit_ratelimit". Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#phase Ruleset#phase}
        :param account_id: The Account ID to use for this endpoint. Mutually exclusive with the Zone ID. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#account_id Ruleset#account_id}
        :param description: An informative description of the ruleset. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#description Ruleset#description}
        :param rules: The list of rules in the ruleset. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#rules Ruleset#rules}
        :param zone_id: The Zone ID to use for this endpoint. Mutually exclusive with the Account ID. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#zone_id Ruleset#zone_id}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing Ruleset that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#import import section} in the documentation of this resource for the id to use
...
class RulesetRules:
    def __init__(
        ...
        *,
        ...
        '''
        :param action: The action to perform when the rule matches. Available values: "block". Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#action Ruleset#action}
        :param action_parameters: The parameters configuring the rule's action. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#action_parameters Ruleset#action_parameters}
        :param description: An informative description of the rule. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#description Ruleset#description}
        :param enabled: Whether the rule should be executed. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#enabled Ruleset#enabled}
        :param exposed_credential_check: Configure checks for exposed credentials. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#exposed_credential_check Ruleset#exposed_credential_check}
        :param expression: The expression defining which traffic will match the rule. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#expression Ruleset#expression}
        :param logging: An object configuring the rule's logging behavior. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#logging Ruleset#logging}
        :param ratelimit: An object configuring the rule's ratelimit behavior. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#ratelimit Ruleset#ratelimit}
        :param ref: The reference of the rule (the rule ID by default). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#ref Ruleset#ref}
        '''
...
class RulesetRulesActionParameters:
    def __init__(
        ...
        *,
        ...
        '''
        :param additional_cacheable_ports: List of additional ports that caching can be enabled on. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#additional_cacheable_ports Ruleset#additional_cacheable_ports}
        :param algorithms: Custom order for compression algorithms. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#algorithms Ruleset#algorithms}
        :param automatic_https_rewrites: Turn on or off Automatic HTTPS Rewrites. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#automatic_https_rewrites Ruleset#automatic_https_rewrites}
        :param autominify: Select which file extensions to minify automatically. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#autominify Ruleset#autominify}
        :param bic: Turn on or off Browser Integrity Check. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#bic Ruleset#bic}
        :param browser_ttl: Specify how long client browsers should cache the response. Cloudflare cache purge will not purge content cached on client browsers, so high browser TTLs may lead to stale content. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#browser_ttl Ruleset#browser_ttl}
        :param cache: Mark whether the request’s response from origin is eligible for caching. Caching itself will still depend on the cache-control header and your other caching configurations. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#cache Ruleset#cache}
        :param cache_key: Define which components of the request are included or excluded from the cache key Cloudflare uses to store the response in cache. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#cache_key Ruleset#cache_key}
        :param cache_reserve: Mark whether the request's response from origin is eligible for Cache Reserve (requires a Cache Reserve add-on plan). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#cache_reserve Ruleset#cache_reserve}
        :param content: Error response content. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#content Ruleset#content}
        :param content_type: Content-type header to set with the response. Available values: "application/json", "text/xml", "text/plain", "text/html". Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#content_type Ruleset#content_type}
        :param cookie_fields: The cookie fields to log. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#cookie_fields Ruleset#cookie_fields}
        :param disable_apps: Turn off all active Cloudflare Apps. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#disable_apps Ruleset#disable_apps}
        :param disable_rum: Turn off Real User Monitoring (RUM). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#disable_rum Ruleset#disable_rum}
        :param disable_zaraz: Turn off Zaraz. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#disable_zaraz Ruleset#disable_zaraz}
        :param edge_ttl: TTL (Time to Live) specifies the maximum time to cache a resource in the Cloudflare edge network. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#edge_ttl Ruleset#edge_ttl}
        :param email_obfuscation: Turn on or off Email Obfuscation. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#email_obfuscation Ruleset#email_obfuscation}
        :param fonts: Turn on or off Cloudflare Fonts. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#fonts Ruleset#fonts}
        :param from_list: Serve a redirect based on a bulk list lookup. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#from_list Ruleset#from_list}
        :param from_value: Serve a redirect based on the request properties. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#from_value Ruleset#from_value}
        :param headers: Map of request headers to modify. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#headers Ruleset#headers}
        :param host_header: Rewrite the HTTP Host header. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#host_header Ruleset#host_header}
        :param hotlink_protection: Turn on or off the Hotlink Protection. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#hotlink_protection Ruleset#hotlink_protection}
        :param id: The ID of the ruleset to execute. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#id Ruleset#id} Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param increment: Increment contains the delta to change the score and can be either positive or negative. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#increment Ruleset#increment}
        :param matched_data: The configuration to use for matched data logging. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#matched_data Ruleset#matched_data}
        :param mirage: Turn on or off Mirage. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#mirage Ruleset#mirage}
        :param opportunistic_encryption: Turn on or off Opportunistic Encryption. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#opportunistic_encryption Ruleset#opportunistic_encryption}
        :param origin: Override the IP/TCP destination. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#origin Ruleset#origin}
        :param origin_cache_control: When enabled, Cloudflare will aim to strictly adhere to RFC 7234. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#origin_cache_control Ruleset#origin_cache_control}
        :param origin_error_page_passthru: Generate Cloudflare error pages from issues sent from the origin server. When on, error pages will trigger for issues from the origin Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#origin_error_page_passthru Ruleset#origin_error_page_passthru}
        :param overrides: A set of overrides to apply to the target ruleset. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#overrides Ruleset#overrides}
        :param phases: A list of phases to skip the execution of. This option is incompatible with the ruleset and rulesets options. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#phases Ruleset#phases}
        :param polish: Configure the Polish level. Available values: "off", "lossless", "lossy". Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#polish Ruleset#polish}
        :param products: A list of legacy security products to skip the execution of. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#products Ruleset#products}
        :param raw_response_fields: The raw response fields to log. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#raw_response_fields Ruleset#raw_response_fields}
        :param read_timeout: Define a timeout value between two successive read operations to your origin server. Historically, the timeout value between two read options from Cloudflare to an origin server is 100 seconds. If you are attempting to reduce HTTP 524 errors because of timeouts from an origin server, try increasing this timeout value. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#read_timeout Ruleset#read_timeout}
        :param request_fields: The raw request fields to log. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#request_fields Ruleset#request_fields}
        :param respect_strong_etags: Specify whether or not Cloudflare should respect strong ETag (entity tag) headers. When off, Cloudflare converts strong ETag headers to weak ETag headers. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#respect_strong_etags Ruleset#respect_strong_etags}
        :param response: The response to show when the block is applied. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#response Ruleset#response}
        :param response_fields: The transformed response fields to log. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#response_fields Ruleset#response_fields}
        :param rocket_loader: Turn on or off Rocket Loader. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#rocket_loader Ruleset#rocket_loader}
        :param rules: A mapping of ruleset IDs to a list of rule IDs in that ruleset to skip the execution of. This option is incompatible with the ruleset option. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#rules Ruleset#rules}
        :param ruleset: A ruleset to skip the execution of. This option is incompatible with the rulesets, rules and phases options. Available values: "current". Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#ruleset Ruleset#ruleset}
        :param rulesets: A list of ruleset IDs to skip the execution of. This option is incompatible with the ruleset and phases options. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#rulesets Ruleset#rulesets}
        :param security_level: Configure the Security Level. Available values: "off", "essentially_off", "low", "medium", "high", "under_attack". Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#security_level Ruleset#security_level}
        :param server_side_excludes: Turn on or off Server Side Excludes. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#server_side_excludes Ruleset#server_side_excludes}
        :param serve_stale: Define if Cloudflare should serve stale content while getting the latest content from the origin. If on, Cloudflare will not serve stale content while getting the latest content from the origin. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#serve_stale Ruleset#serve_stale}
        :param sni: Override the Server Name Indication (SNI). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#sni Ruleset#sni}
        :param ssl: Configure the SSL level. Available values: "off", "flexible", "full", "strict", "origin_pull". Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#ssl Ruleset#ssl}
        :param status_code: The status code to use for the error. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#status_code Ruleset#status_code}
        :param sxg: Turn on or off Signed Exchanges (SXG). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#sxg Ruleset#sxg}
        :param transformed_request_fields: The transformed request fields to log. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#transformed_request_fields Ruleset#transformed_request_fields}
        :param uri: URI to rewrite the request to. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#uri Ruleset#uri}
        '''
...
class RulesetRulesActionParametersAlgorithms:
    def __init__(self, *, name: typing.Optional[builtins.str] = None) -> None:
        '''
        :param name: Name of compression algorithm to enable. Available values: "none", "auto", "default", "gzip", "brotli". Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#name Ruleset#name}
        '''
        if __debug__:
...
class RulesetRulesActionParametersAutominify:
    def __init__(
        ...
        *,
        ...
        '''
        :param css: Minify CSS files. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#css Ruleset#css}
        :param html: Minify HTML files. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#html Ruleset#html}
        :param js: Minify JS files. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#js Ruleset#js}
        '''
        if __debug__:
...
class RulesetRulesActionParametersBrowserTtl:
    def __init__(
        ...
        *,
        ...
        '''
        :param mode: Determines which browser ttl mode to use. Available values: "respect_origin", "bypass_by_default", "override_origin". Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#mode Ruleset#mode}
        :param default: The TTL (in seconds) if you choose override_origin mode. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#default Ruleset#default}
        '''
        if __debug__:
...
class RulesetRulesActionParametersCacheKey:
    def __init__(
        ...
        *,
        ...
        '''
        :param cache_by_device_type: Separate cached content based on the visitor’s device type. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#cache_by_device_type Ruleset#cache_by_device_type}
        :param cache_deception_armor: Protect from web cache deception attacks while allowing static assets to be cached. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#cache_deception_armor Ruleset#cache_deception_armor}
        :param custom_key: Customize which components of the request are included or excluded from the cache key. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#custom_key Ruleset#custom_key}
        :param ignore_query_strings_order: Treat requests with the same query parameters the same, regardless of the order those query parameters are in. A value of true ignores the query strings' order. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#ignore_query_strings_order Ruleset#ignore_query_strings_order}
        '''
...
class RulesetRulesActionParametersCacheKeyCustomKey:
    def __init__(
        ...
        *,
        ...
        '''
        :param cookie: The cookies to include in building the cache key. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#cookie Ruleset#cookie}
        :param header: The header names and values to include in building the cache key. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#header Ruleset#header}
        :param host: Whether to use the original host or the resolved host in the cache key. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#host Ruleset#host}
        :param query_string: Use the presence of parameters in the query string to build the cache key. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#query_string Ruleset#query_string}
        :param user: Characteristics of the request user agent used in building the cache key. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#user Ruleset#user}
        '''
...
class RulesetRulesActionParametersCacheKeyCustomKeyCookie:
    def __init__(
        ...
        *,
        ...
        '''
        :param check_presence: Checks for the presence of these cookie names. The presence of these cookies is used in building the cache key. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#check_presence Ruleset#check_presence}
        :param include: Include these cookies' names and their values. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#include Ruleset#include}
        '''
        if __debug__:
...
class RulesetRulesActionParametersCacheKeyCustomKeyHeader:
    def __init__(
        ...
        *,
        ...
        '''
        :param check_presence: Checks for the presence of these header names. The presence of these headers is used in building the cache key. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#check_presence Ruleset#check_presence}
        :param contains: For each header name and list of values combination, check if the request header contains any of the values provided. The presence of the request header and whether any of the values provided are contained in the request header value is used in building the cache key. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#contains Ruleset#contains}
        :param exclude_origin: Whether or not to include the origin header. A value of true will exclude the origin header in the cache key. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#exclude_origin Ruleset#exclude_origin}
        :param include: Include these headers' names and their values. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#include Ruleset#include}
        '''
        if __debug__:
...
class RulesetRulesActionParametersCacheKeyCustomKeyHost:
    def __init__(
        ...
        *,
        ...
        '''
        :param resolved: Use the resolved host in the cache key. A value of true will use the resolved host, while a value or false will use the original host. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#resolved Ruleset#resolved}
        '''
        if __debug__:
...
class RulesetRulesActionParametersCacheKeyCustomKeyOutputReference(
    ...
    def put_query_string(
        ...
        *,
        ...
        '''
        :param exclude: A list of query string parameters NOT used to build the cache key. All parameters present in the request but missing in this list will be used to build the cache key. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#exclude Ruleset#exclude}
        :param include: A list of query string parameters used to build the cache key. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#include Ruleset#include}
        '''
    ...
    def put_user(
        ...
        *,
        ...
        '''
        :param device_type: Use the user agent's device type in the cache key. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#device_type Ruleset#device_type}
        :param geo: Use the user agents's country in the cache key. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#geo Ruleset#geo}
        :param lang: Use the user agent's language in the cache key. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#lang Ruleset#lang}
        '''
...
class RulesetRulesActionParametersCacheKeyCustomKeyQueryStringExclude:
    def __init__(
        ...
        *,
        ...
        '''
        :param all: Determines whether to exclude all query string parameters from the cache key. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#all Ruleset#all}
        :param list: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#list Ruleset#list}.
        '''
        if __debug__:
...
class RulesetRulesActionParametersCacheKeyCustomKeyQueryStringInclude:
    def __init__(
        ...
        *,
        ...
        '''
        :param all: Determines whether to include all query string parameters in the cache key. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#all Ruleset#all}
        :param list: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#list Ruleset#list}.
        '''
        if __debug__:
...
class RulesetRulesActionParametersCacheReserve:
    def __init__(
        ...
        *,
        ...
        '''
        :param eligible: Determines whether cache reserve is enabled. If this is true and a request meets eligibility criteria, Cloudflare will write the resource to cache reserve. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#eligible Ruleset#eligible}
        :param minimum_file_size: The minimum file size eligible for store in cache reserve. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#minimum_file_size Ruleset#minimum_file_size}
        '''
        if __debug__:
...
class RulesetRulesActionParametersCookieFields:
    def __init__(self, *, name: builtins.str) -> None:
        '''
        :param name: The name of the field. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#name Ruleset#name}
        '''
        if __debug__:
...
class RulesetRulesActionParametersEdgeTtl:
    def __init__(
        ...
        *,
        ...
        '''
        :param mode: edge ttl options Available values: "respect_origin", "bypass_by_default", "override_origin". Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#mode Ruleset#mode}
        :param default: The TTL (in seconds) if you choose override_origin mode. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#default Ruleset#default}
        :param status_code_ttl: List of single status codes, or status code ranges to apply the selected mode. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#status_code_ttl Ruleset#status_code_ttl}
        '''
        if __debug__:
...
class RulesetRulesActionParametersEdgeTtlStatusCodeTtl:
    def __init__(
        ...
        *,
        ...
        '''
        :param value: Time to cache a response (in seconds). A value of 0 is equivalent to setting the Cache-Control header with the value "no-cache". A value of -1 is equivalent to setting Cache-Control header with the value of "no-store". Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#value Ruleset#value}
        :param status_code: Set the ttl for responses with this specific status code. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#status_code Ruleset#status_code}
        :param status_code_range: The range of status codes used to apply the selected mode. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#status_code_range Ruleset#status_code_range}
        '''
...
class RulesetRulesActionParametersEdgeTtlStatusCodeTtlOutputReference(
    ...
    def put_status_code_range(
        ...
        *,
        ...
        '''
        :param from_: response status code lower bound. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#from Ruleset#from}
        :param to: response status code upper bound. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#to Ruleset#to}
        '''
...
class RulesetRulesActionParametersFromListStruct:
    def __init__(
        ...
        *,
        ...
        '''
        :param key: Expression that evaluates to the list lookup key. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#key Ruleset#key}
        :param name: The name of the list to match against. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#name Ruleset#name}
        '''
        if __debug__:
...
class RulesetRulesActionParametersFromValue:
    def __init__(
        ...
        *,
        ...
        '''
        :param preserve_query_string: Keep the query string of the original request. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#preserve_query_string Ruleset#preserve_query_string}
        :param status_code: The status code to be used for the redirect. Available values: 301, 302, 303, 307, 308. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#status_code Ruleset#status_code}
        :param target_url: The URL to redirect the request to. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#target_url Ruleset#target_url}
        '''
...
class RulesetRulesActionParametersFromValueOutputReference(
    ...
    def put_target_url(
        ...
        *,
        ...
        '''
        :param expression: An expression to evaluate to get the URL to redirect the request to. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#expression Ruleset#expression}
        :param value: The URL to redirect the request to. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#value Ruleset#value}
        '''
...
class RulesetRulesActionParametersHeaders:
    def __init__(
        ...
        *,
        ...
        '''
        :param operation: Available values: "remove". Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#operation Ruleset#operation}
        :param expression: Expression for the header value. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#expression Ruleset#expression}
        :param value: Static value for the header. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#value Ruleset#value}
        '''
        if __debug__:
...
class RulesetRulesActionParametersMatchedData:
    def __init__(self, *, public_key: builtins.str) -> None:
        '''
        :param public_key: The public key to encrypt matched data logs with. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#public_key Ruleset#public_key}
        '''
        if __debug__:
...
class RulesetRulesActionParametersOrigin:
    def __init__(
        ...
        *,
        ...
        '''
        :param host: Override the resolved hostname. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#host Ruleset#host}
        :param port: Override the destination port. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#port Ruleset#port}
        '''
        if __debug__:
...
class RulesetRulesActionParametersOutputReference(
    ...
    def put_overrides(
        ...
        *,
        ...
        '''
        :param action: An action to override all rules with. This option has lower precedence than rule and category overrides. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#action Ruleset#action}
        :param categories: A list of category-level overrides. This option has the second-highest precedence after rule-level overrides. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#categories Ruleset#categories}
        :param enabled: Whether to enable execution of all rules. This option has lower precedence than rule and category overrides. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#enabled Ruleset#enabled}
        :param rules: A list of rule-level overrides. This option has the highest precedence. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#rules Ruleset#rules}
        :param sensitivity_level: A sensitivity level to set for all rules. This option has lower precedence than rule and category overrides and is only applicable for DDoS phases. Available values: "default", "medium", "low", "eoff". Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#sensitivity_level Ruleset#sensitivity_level}
        '''
    ...
    def put_response(
        ...
        *,
        ...
        '''
        :param content: The content to return. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#content Ruleset#content}
        :param content_type: The type of the content to return. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#content_type Ruleset#content_type}
        :param status_code: The status code to return. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#status_code Ruleset#status_code}
        '''
    ...
    def put_serve_stale(
        ...
        *,
        ...
        '''
        :param disable_stale_while_updating: Defines whether Cloudflare should serve stale content while updating. If true, Cloudflare will not serve stale content while getting the latest content from the origin. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#disable_stale_while_updating Ruleset#disable_stale_while_updating}
        '''
    ...
    def put_sni(self, *, value: builtins.str) -> None:
        '''
        :param value: The SNI override. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#value Ruleset#value}
        '''
    ...
    def put_uri(
        ...
        *,
        ...
        '''
        :param path: Path portion rewrite. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#path Ruleset#path}
        :param query: Query portion rewrite. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#query Ruleset#query}
        '''
...
class RulesetRulesActionParametersOverridesCategories:
    def __init__(
        ...
        *,
        ...
        '''
        :param category: The name of the category to override. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#category Ruleset#category}
        :param action: The action to override rules in the category with. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#action Ruleset#action}
        :param enabled: Whether to enable execution of rules in the category. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#enabled Ruleset#enabled}
        :param sensitivity_level: The sensitivity level to use for rules in the category. Available values: "default", "medium", "low", "eoff". Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#sensitivity_level Ruleset#sensitivity_level}
        '''
        if __debug__:
...
class RulesetRulesActionParametersOverridesRules:
    def __init__(
        ...
        *,
        ...
        '''
        :param id: The ID of the rule to override. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#id Ruleset#id} Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param action: The action to override the rule with. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#action Ruleset#action}
        :param enabled: Whether to enable execution of the rule. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#enabled Ruleset#enabled}
        :param score_threshold: The score threshold to use for the rule. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#score_threshold Ruleset#score_threshold}
        :param sensitivity_level: The sensitivity level to use for the rule. Available values: "default", "medium", "low", "eoff". Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#sensitivity_level Ruleset#sensitivity_level}
        '''
        if __debug__:
...
class RulesetRulesActionParametersRawResponseFields:
    def __init__(
        ...
        *,
        ...
        '''
        :param name: The name of the field. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#name Ruleset#name}
        :param preserve_duplicates: Whether to log duplicate values of the same header. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#preserve_duplicates Ruleset#preserve_duplicates}
        '''
        if __debug__:
...
class RulesetRulesActionParametersUriOutputReference(
    ...
    def put_path(
        ...
        *,
        ...
        '''
        :param expression: Expression to evaluate for the replacement value. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#expression Ruleset#expression}
        :param value: Predefined replacement value. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#value Ruleset#value}
        '''
...
class RulesetRulesExposedCredentialCheck:
    def __init__(
        ...
        *,
        ...
        '''
        :param password_expression: Expression that selects the password used in the credentials check. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#password_expression Ruleset#password_expression}
        :param username_expression: Expression that selects the user ID used in the credentials check. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#username_expression Ruleset#username_expression}
        '''
        if __debug__:
...
class RulesetRulesLogging:
    def __init__(
        ...
        *,
        ...
        '''
        :param enabled: Whether to generate a log when the rule matches. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#enabled Ruleset#enabled}
        '''
        if __debug__:
...
class RulesetRulesOutputReference(
    ...
    def put_ratelimit(
        ...
        *,
        ...
        '''
        :param characteristics: Characteristics of the request on which the ratelimiter counter will be incremented. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#characteristics Ruleset#characteristics}
        :param period: Period in seconds over which the counter is being incremented. Available values: 10, 60, 600, 3600. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#period Ruleset#period}
        :param counting_expression: Defines when the ratelimit counter should be incremented. It is optional and defaults to the same as the rule's expression. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#counting_expression Ruleset#counting_expression}
        :param mitigation_timeout: Period of time in seconds after which the action will be disabled following its first execution. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#mitigation_timeout Ruleset#mitigation_timeout}
        :param requests_per_period: The threshold of requests per period after which the action will be executed for the first time. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#requests_per_period Ruleset#requests_per_period}
        :param requests_to_origin: Defines if ratelimit counting is only done when an origin is reached. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#requests_to_origin Ruleset#requests_to_origin}
        :param score_per_period: The score threshold per period for which the action will be executed the first time. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#score_per_period Ruleset#score_per_period}
        :param score_response_header_name: The response header name provided by the origin which should contain the score to increment ratelimit counter on. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.2.0/docs/resources/ruleset#score_response_header_name Ruleset#score_response_header_name}
        '''
