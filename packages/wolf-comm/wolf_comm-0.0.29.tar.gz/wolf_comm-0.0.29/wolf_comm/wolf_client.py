...
from wolf_comm.models import Temperature, Parameter, Device, Pressure, ListItemParameter, \
    PercentageParameter, UnitParameter, Value, ListItem, HoursParameter, PowerParameter, EnergyParameter, RPMParameter, FlowParameter, FrequencyParameter
...
# api/portal/WriteParameterValues
    ...
    def _map_parameter(parameter: dict, parent: str) -> Parameter:
        ...
        if UNIT in parameter:
            ...
            return UnitParameter(value_id, name, parent, parameter_id, bundle_id, readonly)
