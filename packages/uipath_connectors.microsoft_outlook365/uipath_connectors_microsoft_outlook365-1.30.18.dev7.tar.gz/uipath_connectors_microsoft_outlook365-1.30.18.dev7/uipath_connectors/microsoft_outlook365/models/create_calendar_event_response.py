...
from ..models.create_calendar_event_response_event_type import (
    CreateCalendarEventResponseEventType,
)
import datetime
from ..models.create_calendar_event_response_online_meeting import (
    CreateCalendarEventResponseOnlineMeeting,
)
from ..models.create_calendar_event_response_response_status import (
    CreateCalendarEventResponseResponseStatus,
)
from ..models.create_calendar_event_response_location import (
...
from ..models.create_calendar_event_response_locations_array_item_ref import (
    CreateCalendarEventResponseLocationsArrayItemRef,
)
from ..models.create_calendar_event_response_attendees_array_item_ref import (
...
class CreateCalendarEventResponse(BaseModel):
    """
    Attributes:
        attendees (Optional[list['CreateCalendarEventResponseAttendeesArrayItemRef']]):
        ...
        last_modified_date_time (Optional[datetime.datetime]): The date and time when the calendar entry was last
                updated.
        location (Optional[CreateCalendarEventResponseLocation]):
        locations (Optional[list['CreateCalendarEventResponseLocationsArrayItemRef']]):
        online_meeting (Optional[CreateCalendarEventResponseOnlineMeeting]):
        ...
        response_status (Optional[CreateCalendarEventResponseResponseStatus]):
        ...
        type_ (Optional[CreateCalendarEventResponseEventType]): Specifies the type of calendar event or action.
    ...
    location: Optional["CreateCalendarEventResponseLocation"] = Field(
        alias="location", default=None
    )
    locations: Optional[list["CreateCalendarEventResponseLocationsArrayItemRef"]] = (
        Field(alias="locations", default=None)
    )
    online_meeting: Optional["CreateCalendarEventResponseOnlineMeeting"] = Field(
    ...
    response_status: Optional["CreateCalendarEventResponseResponseStatus"] = Field(
        alias="responseStatus", default=None
    )
    transaction_id: Optional[str] = Field(alias="transactionId", default=None)
    type_: Optional[CreateCalendarEventResponseEventType] = Field(
