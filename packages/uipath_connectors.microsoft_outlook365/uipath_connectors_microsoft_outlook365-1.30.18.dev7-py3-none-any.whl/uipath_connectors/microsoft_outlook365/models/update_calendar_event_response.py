...
from ..models.update_calendar_event_response_event_sensitivity_level import (
    UpdateCalendarEventResponseEventSensitivityLevel,
)
from ..models.update_calendar_event_response_event_type import (
    UpdateCalendarEventResponseEventType,
)
from ..models.update_calendar_event_response_importance import (
    UpdateCalendarEventResponseImportance,
)
from ..models.update_calendar_event_response_show_as_status import (
    UpdateCalendarEventResponseShowAsStatus,
)
import datetime
from ..models.update_calendar_event_response_response_status import (
    UpdateCalendarEventResponseResponseStatus,
)
from ..models.update_calendar_event_response_locations_array_item_ref import (
    UpdateCalendarEventResponseLocationsArrayItemRef,
)
from ..models.update_calendar_event_response_online_meeting import (
...
from ..models.update_calendar_event_response_location import (
    UpdateCalendarEventResponseLocation,
)
from ..models.update_calendar_event_response_end import UpdateCalendarEventResponseEnd
from ..models.update_calendar_event_response_attendees_array_item_ref import (
...
from ..models.update_calendar_event_response_body import UpdateCalendarEventResponseBody
from ..models.update_calendar_event_response_recurrence import (
...
class UpdateCalendarEventResponse(BaseModel):
    ...
    Attributes:
        allow_new_time_proposals (Optional[bool]): Indicates if attendees can propose new times for the event. Example:
                True.
        attendees (Optional[list['UpdateCalendarEventResponseAttendeesArrayItemRef']]):
        body (Optional[UpdateCalendarEventResponseBody]):
        ...
        importance (Optional[UpdateCalendarEventResponseImportance]): Defines the priority level of the calendar event.
        ...
        last_modified_date_time (Optional[datetime.datetime]): The date and time when the calendar entry was last
                updated.
        location (Optional[UpdateCalendarEventResponseLocation]):
        locations (Optional[list['UpdateCalendarEventResponseLocationsArrayItemRef']]):
        online_meeting (Optional[UpdateCalendarEventResponseOnlineMeeting]):
        ...
        recurrence (Optional[UpdateCalendarEventResponseRecurrence]):
        ...
        response_status (Optional[UpdateCalendarEventResponseResponseStatus]):
        sensitivity (Optional[UpdateCalendarEventResponseEventSensitivityLevel]): Indicates the privacy level of the
                calendar event.
        show_as (Optional[UpdateCalendarEventResponseShowAsStatus]): Indicates how the event appears on the calendar,
                like busy or free.
        ...
        type_ (Optional[UpdateCalendarEventResponseEventType]): Specifies the type of calendar event or action.
    ...
    body: Optional["UpdateCalendarEventResponseBody"] = Field(
    ...
    importance: Optional[UpdateCalendarEventResponseImportance] = Field(
    ...
    location: Optional["UpdateCalendarEventResponseLocation"] = Field(
        alias="location", default=None
    )
    locations: Optional[list["UpdateCalendarEventResponseLocationsArrayItemRef"]] = (
        Field(alias="locations", default=None)
    )
    online_meeting: Optional["UpdateCalendarEventResponseOnlineMeeting"] = Field(
    ...
    recurrence: Optional["UpdateCalendarEventResponseRecurrence"] = Field(
    ...
    response_status: Optional["UpdateCalendarEventResponseResponseStatus"] = Field(
        alias="responseStatus", default=None
    )
    sensitivity: Optional[UpdateCalendarEventResponseEventSensitivityLevel] = Field(
        alias="sensitivity", default=None
    )
    show_as: Optional[UpdateCalendarEventResponseShowAsStatus] = Field(
    ...
    type_: Optional[UpdateCalendarEventResponseEventType] = Field(
