...
class ForwardEmailBody(BaseModel):
    """
    Attributes:
        body (ForwardEmailRequest):
        file (Optional[File]): Attachment to be sent with email
    """

    model_config = ConfigDict(extra="allow", populate_by_name=True)

    body: "ForwardEmailRequest" = Field(alias="body")
    ...
    @classmethod
    def from_dict(cls: Type["ForwardEmailBody"], src_dict: Dict[str, Any]):
