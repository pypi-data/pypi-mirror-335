...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["base_path", "prn", "content_guard", "name", "pulp_created", "pulp_last_updated", "hidden", "no_content_change_since", "pulp_href", "pulp_labels", "base_url"]
