...
class MillSettings(google.protobuf.message.Message):
    ...
    MINIMUM_SLOT_FIELD_NUMBER: builtins.int
    ...
    *before* any toolpathing and will return results that are a subset
    ...
    """
    minimum_slot: builtins.float
    """What is the minimum size slot as a fraction of tool radius.
    This must be larger than 1.0 as we only support trochoidal
    paths not zero-clearance slotting behavior.
