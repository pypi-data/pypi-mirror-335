...
class RevocationApiClient(OidcApiClient):
    ...
    def _revoke_token(self, token: str, token_hint: str, auth_enricher=None):
        params = {
            "token": token,
    ...
    def revoke_access_token(self, access_token: str, auth_enricher=None) -> None:
        """
        Revoke the specified access token.
        """
        self._revoke_token(access_token, "access_token", auth_enricher)

    def revoke_refresh_token(self, refresh_token: str, auth_enricher=None) -> None:
        """
