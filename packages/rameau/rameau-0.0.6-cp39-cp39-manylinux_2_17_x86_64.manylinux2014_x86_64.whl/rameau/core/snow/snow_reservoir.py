...
class SnowReservoir(AbstractWrapper):
    ...
    def melting(self) -> Parameter:
        ...
        `Parameter`
        """
        return self._m.getMelting()

    @melting.setter
    def melting(self, v: Parameter) -> None:
        self._m.setMelting(v._m)

    @property
    @wrap_property(Parameter)
    def retention(self) -> Parameter:
        """Maximum water retention of the snowpack (%).
        ...
        `Parameter`
        """
        return self._m.getRetention()

    @retention.setter
    def retention(self, v: Parameter) -> None:
        self._m.setRetention(v._m)

    @property
    @wrap_property(DegreeDayParameters)
    def degree_day(self) -> DegreeDayParameters:
        """Degree day model parameters.
        ...
        `DegreeDayParameters`
        """
        return self._m.getDegreeDay()

    @degree_day.setter
    def degree_day(self, v: DegreeDayParameters) -> None:
        self._m.setDegreeDay(v._m)

    @property
    @wrap_property(SnowCorrectionParameters)
    def snow_correction(self) -> SnowCorrectionParameters:
        """Correction terms of meteorological inputs applied during the
        snow melting physical processes.

        Returns
        -------
        `SnowCorrectionParameters`
        """
        return self._m.getSnowCorrection()

    @snow_correction.setter
    def snow_correction(self, v: SnowCorrectionParameters) -> None:
        self._m.setSnowCorrection(v._m)
    ...
    def swe(self) -> float:
        ...
        `float`
        """
        return self._m.getSnowDepth()

    @swe.setter
    def swe(self, v: float) -> None:
        self._m.setSnowDepth(v)
    ...
    def r(self) -> float:
        ...
        `float`
        """
        return self._m.getWaterRetention()

    @r.setter
    def r(self, v: float) -> None:
        self._m.setWaterRetention(v)
