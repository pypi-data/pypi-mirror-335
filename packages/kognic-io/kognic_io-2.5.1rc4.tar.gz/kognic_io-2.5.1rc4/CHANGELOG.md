...
- Bug fixes in new scene model
  - Optional fields default to None in most cases
  - If shutter timestamps not set they will not be validated
  - If postpone_external_resource_import is set to false it will be included in body
