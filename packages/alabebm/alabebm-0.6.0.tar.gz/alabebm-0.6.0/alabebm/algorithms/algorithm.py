...
def metropolis_hastings(
    ...
    for iteration in range(iterations):
        ...
        if algorithm in ['conjugate_priors', 'mle']:
            ...
            theta_phi_estimates = data_utils.update_theta_phi_estimates(
                biomarker_data,
                theta_phi_default,
        ...
        # Recompute new_ln_likelihood using theta_phi_estimates
        # If hard kmeans, it will use `theta_phi_estimates = theta_phi_default.copy()` defined above
        ln_likelihood, _ = data_utils.compute_total_ln_likelihood_and_stage_likelihoods(
            participant_data,
            non_diseased_ids,
            theta_phi_estimates,
            diseased_stages
