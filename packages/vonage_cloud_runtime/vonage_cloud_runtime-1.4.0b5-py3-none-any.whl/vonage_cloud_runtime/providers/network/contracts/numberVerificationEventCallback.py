...
from vonage_cloud_runtime.providers.network.contracts.INumberVerificationEventCallback import INumberVerificationEventCallback

@dataclass
class NumberVerificationEventCallback(INumberVerificationEventCallback):
    provider: str
