...
class WPConfig:
    ...
    The following environment variables need to be set:
        - DSMUSIC_METADATA_URL: "https://your-site.com/tracks.json"
        - DSMUSIC_UPLOAD_PATH_PREFIX: "/var/www/uploads/"
        - DSMUSIC_UPLOAD_URL_PREFIX: "https://your-site.com/uploads/"
        - DSMUSIC_UPLOADS_MYSQL_PASSWORD: MySQL database password
