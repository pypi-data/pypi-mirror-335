...
class AppsecWafCustomRule(
    ...
    def __init__(
        ...
        *,
        ...
        :param blocking: Indicates whether the WAF custom rule will block the request. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.58.0/docs/resources/appsec_waf_custom_rule#blocking AppsecWafCustomRule#blocking}
        :param enabled: Indicates whether the WAF custom rule is enabled. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.58.0/docs/resources/appsec_waf_custom_rule#enabled AppsecWafCustomRule#enabled}
        :param name: The Name of the WAF custom rule. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.58.0/docs/resources/appsec_waf_custom_rule#name AppsecWafCustomRule#name}
        :param tags: Tags associated with the WAF custom rule. ``category`` and ``type`` tags are required. Supported categories include ``business_logic``, ``attack_attempt`` and ``security_response``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.58.0/docs/resources/appsec_waf_custom_rule#tags AppsecWafCustomRule#tags}
        :param action: action block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.58.0/docs/resources/appsec_waf_custom_rule#action AppsecWafCustomRule#action}
        :param condition: condition block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.58.0/docs/resources/appsec_waf_custom_rule#condition AppsecWafCustomRule#condition}
        :param path_glob: The path glob for the WAF custom rule. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.58.0/docs/resources/appsec_waf_custom_rule#path_glob AppsecWafCustomRule#path_glob}
        :param scope: scope block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.58.0/docs/resources/appsec_waf_custom_rule#scope AppsecWafCustomRule#scope}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing AppsecWafCustomRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/datadog/datadog/3.58.0/docs/resources/appsec_waf_custom_rule#import import section} in the documentation of this resource for the id to use
    ...
    def put_action(
        ...
        *,
        ...
        '''
        :param action: Override the default action to take when the WAF custom rule would block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.58.0/docs/resources/appsec_waf_custom_rule#action AppsecWafCustomRule#action}
        :param parameters: parameters block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.58.0/docs/resources/appsec_waf_custom_rule#parameters AppsecWafCustomRule#parameters}
        '''
...
class AppsecWafCustomRuleActionOutputReference(
    ...
    def put_parameters(
        ...
        *,
        ...
        '''
        :param location: The location to redirect to when the WAF custom rule triggers. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.58.0/docs/resources/appsec_waf_custom_rule#location AppsecWafCustomRule#location}
        :param status_code: The status code to return when the WAF custom rule triggers. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.58.0/docs/resources/appsec_waf_custom_rule#status_code AppsecWafCustomRule#status_code}
        '''
...
class AppsecWafCustomRuleCondition:
    def __init__(
        ...
        *,
        ...
        '''
        :param operator: Operator to use for the WAF Condition. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.58.0/docs/resources/appsec_waf_custom_rule#operator AppsecWafCustomRule#operator}
        :param parameters: parameters block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.58.0/docs/resources/appsec_waf_custom_rule#parameters AppsecWafCustomRule#parameters}
        '''
        if isinstance(parameters, dict):
...
class AppsecWafCustomRuleConditionOutputReference(
    ...
    def put_parameters(
        ...
        *,
        ...
        '''
        :param data: Identifier of a list of data from the denylist. Can only be used as substitution from the list parameter. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.58.0/docs/resources/appsec_waf_custom_rule#data AppsecWafCustomRule#data}
        :param input: input block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.58.0/docs/resources/appsec_waf_custom_rule#input AppsecWafCustomRule#input}
        :param list: List of value to use with the condition. Only used with the phrase_match, !phrase_match, exact_match and !exact_match operator. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.58.0/docs/resources/appsec_waf_custom_rule#list AppsecWafCustomRule#list}
        :param options: options block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.58.0/docs/resources/appsec_waf_custom_rule#options AppsecWafCustomRule#options}
        :param regex: Regex to use with the condition. Only used with match_regex and !match_regex operator. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.58.0/docs/resources/appsec_waf_custom_rule#regex AppsecWafCustomRule#regex}
        :param value: Store the captured value in the specified tag name. Only used with the capture_data operator. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.58.0/docs/resources/appsec_waf_custom_rule#value AppsecWafCustomRule#value}
        '''
...
class AppsecWafCustomRuleConditionParametersInput:
    def __init__(
        ...
        *,
        ...
        '''
        :param address: Input from the request on which the condition should apply. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.58.0/docs/resources/appsec_waf_custom_rule#address AppsecWafCustomRule#address}
        :param key_path: Specific path for the input. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.58.0/docs/resources/appsec_waf_custom_rule#key_path AppsecWafCustomRule#key_path}
        '''
        if __debug__:
...
class AppsecWafCustomRuleConditionParametersOptions:
    def __init__(
        ...
        *,
        ...
        '''
        :param case_sensitive: Evaluate the value as case sensitive. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.58.0/docs/resources/appsec_waf_custom_rule#case_sensitive AppsecWafCustomRule#case_sensitive}
        :param min_length: Only evaluate this condition if the value has a minimum amount of characters. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.58.0/docs/resources/appsec_waf_custom_rule#min_length AppsecWafCustomRule#min_length}
        '''
        if __debug__:
...
class AppsecWafCustomRuleScope:
    def __init__(
        ...
        *,
        ...
        '''
        :param env: The environment scope for the WAF custom rule. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.58.0/docs/resources/appsec_waf_custom_rule#env AppsecWafCustomRule#env}
        :param service: The service scope for the WAF custom rule. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/datadog/datadog/3.58.0/docs/resources/appsec_waf_custom_rule#service AppsecWafCustomRule#service}
        '''
        if __debug__:
