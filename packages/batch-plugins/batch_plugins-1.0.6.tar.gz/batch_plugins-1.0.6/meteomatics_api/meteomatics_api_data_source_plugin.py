...
from application.meteomatics_api.env_vars import *

class MeteomaticsApiDataSourcePlugin(DataSource):

    def __init__(self, object_id: str, batch_id: str, pipeline_conf: dict, download_dir: str) -> None:
        # Env vars
        ...
        self.local_download_path = download_dir
    ...
    def transform_data(self):
        for key, df in self.dfs.items():
            ...
            if set(list(df.columns)) == set(catalog_schema_wo_tech_cols):
