...
setuptools.setup(
    name="certora-cli-alpha-oz-fix-setuptools",
    version="20250320.15.46.177790",
    author="Certora",
    author_email="support@certora.com",
    description="Runner for the Certora Prover",
    long_description="Commit 8d40267.                    Build and Run scripts for executing the Certora Prover on Solidity smart contracts.",
    long_description_content_type="text/markdown",
    url="https://pypi.org/project/certora-cli-alpha-oz-fix-setuptools",
