    ...
    def __init__(
        ...
        *,
        ...
        super(PubSubSource, self).__init__(
            ...
            or load_integration_variable(name=_PUBSUB_PROJECT_ID_NAME, integration_name=name)
            or PubSubSource.__fields__["project_id"].default,
            subscription_id=subscription_id
            or load_integration_variable(name=_PUBSUB_SUBSCRIPTION_ID_NAME, integration_name=name)
            or PubSubSource.__fields__["subscription_id"].default,
            late_arrival_deadline=late_arrival_deadline
            or load_integration_variable(name=_PUBSUB_LATE_ARRIVAL_DEADLINE_NAME, integration_name=name)
            or PubSubSource.__fields__["late_arrival_deadline"].default,
            dead_letter_queue_topic_id=dead_letter_queue_topic_id
            or load_integration_variable(name=_PUBSUB_DEAD_LETTER_QUEUE_TOPIC_ID_NAME, integration_name=name)
