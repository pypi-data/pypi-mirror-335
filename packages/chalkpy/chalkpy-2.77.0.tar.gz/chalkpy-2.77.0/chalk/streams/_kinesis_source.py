    ...
    def __init__(
        ...
        *,
        ...
        super(KinesisSource, self).__init__(
            ...
            or load_integration_variable(name=_KINESIS_STREAM_NAME_NAME, integration_name=name)
            or KinesisSource.__fields__["stream_name"].default,
            stream_arn=stream_arn
            or load_integration_variable(name=_KINESIS_STREAM_ARN_NAME, integration_name=name)
            or KinesisSource.__fields__["stream_arn"].default,
            late_arrival_deadline=late_arrival_deadline
            or load_integration_variable(name=_KINESIS_LATE_ARRIVAL_DEADLINE_NAME, integration_name=name)
            or KinesisSource.__fields__["late_arrival_deadline"].default,
            dead_letter_queue_stream_name=dead_letter_queue_stream_name
            or load_integration_variable(name=_KINESIS_DEAD_LETTER_QUEUE_STREAM_NAME_NAME, integration_name=name)
            or KinesisSource.__fields__["dead_letter_queue_stream_name"].default,
            aws_access_key_id=aws_access_key_id
            or load_integration_variable(name=_KINESIS_AWS_ACCESS_KEY_ID_NAME, integration_name=name)
            or KinesisSource.__fields__["aws_access_key_id"].default,
            aws_secret_access_key=aws_secret_access_key
            or load_integration_variable(name=_KINESIS_AWS_SECRET_ACCESS_KEY_NAME, integration_name=name)
            or KinesisSource.__fields__["aws_secret_access_key"].default,
            aws_session_token=aws_session_token
            or load_integration_variable(name=_KINESIS_AWS_SESSION_TOKEN_NAME, integration_name=name)
            or KinesisSource.__fields__["aws_session_token"].default,
            region_name=region_name
            or load_integration_variable(name=_KINESIS_REGION_NAME_NAME, integration_name=name)
            or KinesisSource.__fields__["region_name"].default,
            endpoint_url=endpoint_url
            or load_integration_variable(name=_KINESIS_ENDPOINT_URL_NAME, integration_name=name)
            or KinesisSource.__fields__["endpoint_url"].default,
            consumer_role_arn=consumer_role_arn
            or load_integration_variable(name=_KINESIS_CONSUMER_ROLE_ARN_NAME, integration_name=name)
