...
class BigQuerySourceImpl(BaseSQLSource):
    ...
    def __init__(
        ...
        *,
        ...
        self.location = location or load_integration_variable(integration_name=name, name=_BQ_LOCATION_NAME)
        self.dataset = dataset or load_integration_variable(integration_name=name, name=_BQ_DATASET_NAME)
        self.project = project or load_integration_variable(integration_name=name, name=_BQ_PROJECT_NAME)
        self.credentials_base64 = credentials_base64 or load_integration_variable(
            integration_name=name, name=_BQ_CREDENTIALS_BASE64_NAME
        )
        self.credentials_path = credentials_path or load_integration_variable(
            integration_name=name, name=_BQ_CREDENTIALS_PATH_NAME
        )
