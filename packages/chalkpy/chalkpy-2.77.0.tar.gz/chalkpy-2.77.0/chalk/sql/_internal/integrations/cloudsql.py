...
from chalk.integrations.named import create_integration_variable
...
class CloudSQLSourceImpl(BaseSQLSource):
    ...
    def __init__(
        ...
        *,
        ...
        self.instance_name = instance_name or os.getenv(prefix + _CLOUDSQL_INSTANCE_NAME_NAME)
        self.db = db or os.getenv(prefix + _CLOUDSQL_DATABASE_NAME)
        self.user = user or os.getenv(prefix + _CLOUDSQL_USER_NAME)
        self.password = password or os.getenv(prefix + _CLOUDSQL_PASSWORD_NAME)
