...
class PvIcon(QWidget):
    def __init__(self, container=None, x=0, y=0, width=100, height=100, image_path="",
    ...
    def create_layout(self):
        ...
        if self._image_path:
            try:
                with open(self._image_path, 'r', encoding='utf-8') as f:
...
if __name__ == "__main__":
    ...
    icon = PvIcon(
        ...
        width=120,
        height=120,
        image_path="C:/path/to/your/icon.svg",  # Replace with your SVG path
        corner_radius=20,
        flip_v=False,
        flip_h=False,
        rotate=0,
