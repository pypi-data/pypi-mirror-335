...
class Windows(Terminal):
    def __init__(self, dev: bool = False):
        ...
        self.carpeta_descargas_personalizada = os.path.join(os.environ["USERPROFILE"], "DescargaPersonalizada")
    ...
    def mover_archivo(self, ruta_archivo: str, ruta_destino: str) -> str:
    ...
    def armar_estructura_de_carpetas(self, ruta: str) -> str:
