...
class TestUtilsFunctions(unittest.TestCase):
    ...
    # Google video for test
    TEST_VIDEO_ID = "Y2VF8tmLFHw"
    ...
    def test_create_dataframe_from_items(self):
        """Test creating DataFrame from items."""
        # Test with empty list
        df = create_dataframe_from_items([])
