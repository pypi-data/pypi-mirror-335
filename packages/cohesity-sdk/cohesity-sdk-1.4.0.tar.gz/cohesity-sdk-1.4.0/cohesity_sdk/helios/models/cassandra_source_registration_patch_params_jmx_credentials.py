...
class CassandraSourceRegistrationPatchParamsJmxCredentials(BaseModel):
    """
    JMX Credentials for this cluster. These should be the same for all the nodes
    """ # noqa: E501
    password: StrictStr = Field(description="JMX password.")
    username: StrictStr = Field(description="JMX username.")
