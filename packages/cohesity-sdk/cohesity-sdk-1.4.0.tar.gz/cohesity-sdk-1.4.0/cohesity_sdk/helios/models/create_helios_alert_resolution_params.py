...
class CreateHeliosAlertResolutionParams(BaseModel):
    """
    Provides Resolution details and the list of Alerts to be resolved
    """ # noqa: E501
    description: StrictStr = Field(description="Specifies the full description about the Resolution.")
    resolution_name: StrictStr = Field(description="Specifies the unique name of the resolution.", alias="resolutionName")
    resolved_alerts: List[CreateHeliosAlertResolutionParamsResolvedAlertsInner] = Field(alias="resolvedAlerts")
    __properties: ClassVar[List[str]] = ["description", "resolutionName", "resolvedAlerts"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "resolvedAlerts": [CreateHeliosAlertResolutionParamsResolvedAlertsInner.from_dict(_item) for _item in obj["resolvedAlerts"]] if obj.get("resolvedAlerts") is not None else None
        })
        return _obj
