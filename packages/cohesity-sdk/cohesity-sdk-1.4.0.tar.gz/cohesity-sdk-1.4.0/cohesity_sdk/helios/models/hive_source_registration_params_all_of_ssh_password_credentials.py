...
class HiveSourceRegistrationParamsAllOfSshPasswordCredentials(BaseModel):
    """
    ...
    """ # noqa: E501
    password: StrictStr = Field(description="SSH password.")
    username: StrictStr = Field(description="SSH username.")
