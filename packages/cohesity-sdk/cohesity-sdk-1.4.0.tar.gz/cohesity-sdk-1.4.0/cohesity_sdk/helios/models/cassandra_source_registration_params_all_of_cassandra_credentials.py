...
class CassandraSourceRegistrationParamsAllOfCassandraCredentials(BaseModel):
    """
    Cassandra Credentials for this cluster.
    """ # noqa: E501
    password: StrictStr = Field(description="Cassandra password.")
    username: StrictStr = Field(description="Cassandra username.")
