...
class Hauptprogramm(tk.Tk):
    ...
    def baueWidgets(self):
        ...
        with Form() as form:
            ...
            Tooltip(form.zusatz, 'Z.B. Altbert Kolbe Heim')
            ...
            Tooltip(form.kontaktdaten, 'Tel.-Nummer(n),\nweitere eMail-Adressen\nu.a.')
            form.lbl_kontaktdaten.grid(column=0, row=12, columnspan=6, sticky=tk.W)
            form.kontaktdaten.grid(column=0, row=13, columnspan=6, sticky=tk.W)
            ...
            form.lbl_bemerkung.grid(column=0, row=14, columnspan=6, sticky=tk.W)
            form.bemerkung.grid(column=0, row=15, columnspan=6, sticky=tk.W)
        ...
        def FactoryPersonListe():
            ...
            form.addWidget(
                ...
                'text',
                label='Adel')
            Tooltip(form.von_und_zu, 'von, van, zu usw.')
            form.addWidget(
                'titel',
                ttk.Entry(self.frmPersonListeInhalt.innerFrame, width=7),
                'text',
                label='Akad.')
            Tooltip(form.titel, 'Dr., Prof. usw.')
            form.addWidget(
                'gebdat',
                ttk.Entry(
            ...
            form.addWidget(
                ...
                'text',
                label='Adress-Zusatz')
            Tooltip(form.zusatz, 'z.B. Albert-Kolbe-Heim, Zi. 68')
            form.addWidget(
                'strasse',
                ttk.Entry(self.frmPersonListeInhalt.innerFrame, width=15),
                'text',
        ...
        with Form() as form:
            ...
            Tooltip(form.name, 'Nur für die Sortierung relevant')
            form.lbl_name.grid(column=0, row=2, sticky=tk.W)
            form.name.grid(column=0, row=3, sticky=tk.W)
            ...
            Tooltip(form.anschrift, 'Name/Bezeichnung, wie er auf dem Etikett erscheint')
        ...
        with Form() as form:
            ...
            Tooltip(form.beleg, 'Eine Belegmail für\nden Versand ans\nGemeindebüro')
        ...
        with Form() as form:
            ...
            Tooltip(form.absender, 'Absender in Kleinstschrift\noben auf die Etiketten drucken')
