...
def main():
    ...
    #px.choropleth_mapbox(peil_per_gebied_epsg4326, geojson=peil_per_gebied_epsg4326.geometry, locations=peil_per_gebied_epsg4326.index, color="T100", hover_data=COL_LIST, mapbox_style="open-street-map", color_continuous_scale="GnBu", center = {"lat":peil_per_gebied_epsg4326.unary_union.centroid.y,
    #                        "lon":peil_per_gebied_epsg4326.unary_union.centroid.x})
