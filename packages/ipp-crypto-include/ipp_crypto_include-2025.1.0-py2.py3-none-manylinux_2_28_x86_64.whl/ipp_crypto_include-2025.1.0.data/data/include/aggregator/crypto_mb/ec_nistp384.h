...
#ifndef BN_OPENSSL_DISABLE
MBXAPI(mbx_status,
       mbx_nistp384_ecpublic_key_ssl_mb8,
       (BIGNUM * pa_pubx[8],
        BIGNUM* pa_puby[8],
        BIGNUM* pa_pubz[8],
...
MBXAPI(mbx_status,
       mbx_nistp384_ecdsa_verify_ssl_mb8,
       (const ECDSA_SIG* const pa_sign[8],
        const int8u* const pa_msg[8],
        const BIGNUM* const pa_pubx[8],
        const BIGNUM* const pa_puby[8],
        const BIGNUM* const pa_pubz[8],
