...
Concept = NewType("Concept", Annotation)
...
class Token(Annotation):
    ...
    def iter(object) -> Generator[Token, None, None]:
        ...
        :type object: :class:`Analysis <wowool.analysis.Analysis>`, :class:`Sentence <wowool.annotation.sentence.Sentence>` or :class:`Concept <wowool.annotation.concept.Concept>`
        ...
        from wowool.annotation import Sentence, Concept
        ...
        if isinstance(object, Document) and object.analysis:
            ...
            raise TypeError(f"Expected Document, Analysis, Sentence, or Concept but got '{type(object)}'")
    ...
    @staticmethod
    def prev(sentence, object: Union[Concept, Token]) -> Token:
