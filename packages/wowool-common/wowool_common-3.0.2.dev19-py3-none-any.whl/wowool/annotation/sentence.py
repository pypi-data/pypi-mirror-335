...
class Sentence(BasicAnnotation):
    """
    :class:`Sentence` is a class that contains all the :class:`Tokens <wowool.annotation.token.Token>` and :class:`Concepts <wowool.annotation.concept.Concept>` of a sentence
    """
    ...
    def __getattr__(self, uri: str):
        ...
        :type: :class:`Concept <wowool.annotation.concept.Concept>`
    ...
    def find_first(self, uri: str):
        ...
        :type: :class:`Concept <wowool.annotation.concept.Concept>`
        """
        concept = Concept(self.begin_offset, self.end_offset, "Sentence")
    ...
    def concepts(self, filter=_filter_pass_thru_concept):
        ...
        """
        yield from Concept.iter(self, filter)
    ...
    @staticmethod
    def _paragraph_iter(paragraph, filter: FilterType = _filter_pass_thru) -> Iterator[Concept]:
