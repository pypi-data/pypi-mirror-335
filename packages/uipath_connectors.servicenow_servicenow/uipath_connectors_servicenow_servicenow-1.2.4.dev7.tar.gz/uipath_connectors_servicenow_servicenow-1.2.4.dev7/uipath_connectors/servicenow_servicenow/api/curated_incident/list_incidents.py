...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        for componentsschemas_list_incidents_list_item_data in _response_200:
            componentsschemas_list_incidents_list_item = ListIncidents.from_dict(
                componentsschemas_list_incidents_list_item_data
            )

            response_200.append(componentsschemas_list_incidents_list_item)
