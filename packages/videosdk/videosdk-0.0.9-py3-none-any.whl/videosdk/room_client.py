    ...
    async def handleConsume(
        ...
        try:
            ...
            if consumer.track.kind == "audio":
                consumer.track.kind = "shareAudio" if "share" in consumer.appData else consumer.track.kind
            else:
                consumer.track.kind = "share" if "share" in consumer.appData else consumer.track.kind
