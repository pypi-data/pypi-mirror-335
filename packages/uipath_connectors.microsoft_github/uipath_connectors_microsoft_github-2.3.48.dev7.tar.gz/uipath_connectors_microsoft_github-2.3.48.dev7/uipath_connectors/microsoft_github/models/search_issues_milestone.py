...
from ..models.search_issues_milestone_milestone_state import (
...
class SearchIssuesMilestone(BaseModel):
    ...
    Attributes:
        ...
        state (Optional[SearchIssuesMilestoneMilestoneState]): The state of the milestone. Example: open.
    ...
    state: Optional[SearchIssuesMilestoneMilestoneState] = Field(
