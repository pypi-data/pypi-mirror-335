...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        for componentsschemas_read_range_list_item_data in _response_200:
            componentsschemas_read_range_list_item = ReadRange.from_dict(
                componentsschemas_read_range_list_item_data
            )

            response_200.append(componentsschemas_read_range_list_item)
