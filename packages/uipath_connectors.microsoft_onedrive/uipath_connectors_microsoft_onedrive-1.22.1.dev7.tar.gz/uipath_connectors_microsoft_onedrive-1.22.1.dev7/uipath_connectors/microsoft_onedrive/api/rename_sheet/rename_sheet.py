...
def sync_detailed(
    ...
    *,
    ...
    if not id and id_lookup:
        ...
        if not found_items:
            raise ValueError("No matches found for id_lookup in CuratedWorksheet")
        if len(found_items) > 1:
            print(
                "Warning: Multiple matches found for id_lookup in CuratedWorksheet. Using the first match."
            )
