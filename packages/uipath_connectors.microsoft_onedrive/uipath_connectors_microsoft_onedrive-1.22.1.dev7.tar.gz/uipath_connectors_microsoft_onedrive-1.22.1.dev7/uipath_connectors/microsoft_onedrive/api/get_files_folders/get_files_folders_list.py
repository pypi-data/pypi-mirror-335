...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        for componentsschemas_get_files_folders_list_list_item_data in _response_200:
            componentsschemas_get_files_folders_list_list_item = (
                GetFilesFoldersList.from_dict(
                    componentsschemas_get_files_folders_list_list_item_data
                )
            )

            response_200.append(componentsschemas_get_files_folders_list_list_item)
