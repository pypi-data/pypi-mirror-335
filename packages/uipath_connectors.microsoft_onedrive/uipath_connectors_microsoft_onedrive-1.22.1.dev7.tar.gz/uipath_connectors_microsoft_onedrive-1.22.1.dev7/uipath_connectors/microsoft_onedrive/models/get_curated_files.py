...
from ..models.get_curated_files_type import GetCuratedFilesType
from ..models.get_curated_files_owner import GetCuratedFilesOwner


class GetCuratedFiles(BaseModel):
    """
    Attributes:
    ...
    owner: Optional["GetCuratedFilesOwner"] = Field(alias="Owner", default=None)
    ...
    type_: Optional[GetCuratedFilesType] = Field(alias="Type", default=None)
    ...
    @classmethod
    def from_dict(cls: Type["GetCuratedFiles"], src_dict: Dict[str, Any]):
