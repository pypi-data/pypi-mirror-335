...
from ..models.get_curated_file_and_folders_type import GetCuratedFileAndFoldersType
from ..models.get_curated_file_and_folders_owner import GetCuratedFileAndFoldersOwner


class GetCuratedFileAndFolders(BaseModel):
    """
    Attributes:
        ...
        owner (Optional[GetCuratedFileAndFoldersOwner]):
        ...
        type_ (Optional[GetCuratedFileAndFoldersType]):  Example: folder.
    ...
    owner: Optional["GetCuratedFileAndFoldersOwner"] = Field(
    ...
    type_: Optional[GetCuratedFileAndFoldersType] = Field(alias="Type", default=None)
    ...
    @classmethod
    def from_dict(cls: Type["GetCuratedFileAndFolders"], src_dict: Dict[str, Any]):
