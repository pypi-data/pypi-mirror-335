...
class ShareFileOrFolderResponse(BaseModel):
    ...
    Attributes:
        ...
        roles (Optional[list[str]]):  Example: read.
        scope (Optional[ShareFileOrFolderResponseShareWith]): Defines the access level or audience for the shared link.
                Example: anonymous.
        ...
        type_ (Optional[ShareFileOrFolderResponsePermission]): Specifies the type of sharing action performed. Example:
                view.
    """
    ...
    scope: Optional[ShareFileOrFolderResponseShareWith] = Field(
        alias="scope", default=None
    )
    share_id: Optional[str] = Field(alias="shareId", default=None)
    type_: Optional[ShareFileOrFolderResponsePermission] = Field(
