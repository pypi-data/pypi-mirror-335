...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = CreateCreateShareLinkResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CreateCreateShareLinkResponse, DefaultError]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[CreateCreateShareLinkResponse, DefaultError]
    """
