...
Currently PyPNM is compatible with **Python 3.10** and higher. If you need PyPNM for older Python version, consider [PyPNM 1.15.1.34](https://pypi.org/project/PyPNM/1.15.1.34/) - this version was tested and proven to work with **Python 3.4** under Windows XP.
...
3. [PyPNM for Python 3.4 at Github](https://github.com/Dnyarri/PyPNM/tree/py34/) - same as above, but compatible with Python 3.4.
