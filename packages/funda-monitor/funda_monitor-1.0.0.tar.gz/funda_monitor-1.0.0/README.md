...
[![Build Status](https://app.travis-ci.com/whchien/funda-monitor.svg?branch=main)](https://app.travis-ci.com/whchien/funda-monitor)
[![codecov](https://codecov.io/gh/whchien/funda-monitor/branch/main/graph/badge.svg?token=QUKTDyeUqp)](https://codecov.io/gh/whchien/funda-monitor)
[![Downloads](https://static.pepy.tech/badge/funda-monitor)](https://pepy.tech/project/funda-monitor)
[![PyPI version](https://img.shields.io/pypi/v/funda-monitor)](https://pypi.org/project/funda-monitor/)
...
Check the  [example notebook](https://colab.research.google.com/drive/1hNzJJRWxD59lrbeDpfY1OUpBz0NktmfW?usp=sharing) for further details. If you find this project helpful, please give it a [star](https://github.com/whchien/funda-monitor).
