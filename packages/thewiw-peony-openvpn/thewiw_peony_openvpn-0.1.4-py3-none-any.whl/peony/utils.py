...
def init_config():
    ...
    try:
        ...
        os.system(f"chown -R {real_user}:{real_user} {config_dir}")
        ...
        for file in ['caddy_settings', 'vpn_settings']:
            ...
            if not config_file.exists():
                try:
                    ...
                    os.system(f"chown {real_user}:{real_user} {config_file}")
...
def get_config_path(name: str = None) -> str:
    ...
    if not os.path.exists(base_path):
        ...
        os.system(f"chown -R $USER:$USER {os.path.dirname(base_path)}")
...
def get_backup_path() -> str:
    ...
    if not os.path.exists(backup_path):
        ...
        os.system(f"chown -R $USER:$USER {base_dir}")
