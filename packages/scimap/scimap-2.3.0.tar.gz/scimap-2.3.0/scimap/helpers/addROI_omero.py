...
Example:
        ...
        # Apply buffered borders to all ROIs with a total buffer of 40 pixels
    ...
    if buffer_roi > 0:
        ...
        duplicate_indices = border_df.index[border_df.index.duplicated(keep=False)]
        border_df = border_df[~border_df.index.isin(duplicate_indices)]
