...
from docker_utils.cli.rich import volumes_progress
from docker_utils.core.docker_client import get_docker_client
...
@volumes.command(help="Backup Docker volumes to a specified directory")
@click.option(
    "-d",
    "--backup-directory",
    required=True,
...
@volumes.command(help="Restore Docker volumes from a backup directory")
@click.option(
    "-d",
    "--backup-directory",
    required=True,
