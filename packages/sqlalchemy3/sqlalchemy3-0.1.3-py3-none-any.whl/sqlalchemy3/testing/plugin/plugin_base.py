...
log = logging.getLogger("sqlalchemy3.testing.plugin_base")
...
def post_begin():
    ...
    from sqlalchemy3 import testing  # noqa
    from sqlalchemy3.testing import fixtures, engines, exclusions  # noqa
    from sqlalchemy3.testing import assertions, warnings, profiling  # noqa
    from sqlalchemy3.testing import config, provision  # noqa
    from sqlalchemy3 import util  # noqa
...
def _register_sqlite_numeric_dialect(opt, file_config):
    from sqlalchemy3.dialects import registry

    registry.register(
        "sqlite.pysqlite_numeric",
        "sqlalchemy3.dialects.sqlite.pysqlite",
...
def _engine_uri(options, file_config):
    ...
    from sqlalchemy3.testing import config
    from sqlalchemy3.testing import provision
    from sqlalchemy3.engine import url as sa_url
...
def _setup_profiling(options, file_config):
    from sqlalchemy3.testing import profiling
