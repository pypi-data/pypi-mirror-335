...
class ConcreteBase:
    ...
    Example::
        ...
        from sqlalchemy3.ext.declarative import ConcreteBase
...
class AbstractConcreteBase(ConcreteBase):
    ...
    Example::
        ...
        from sqlalchemy3.ext.declarative import AbstractConcreteBase
...
class DeferredReflection:
    ...
    objects created so far.   Classes can define it as such::
        ...
        from sqlalchemy3.ext.declarative import declarative_base
        from sqlalchemy3.ext.declarative import DeferredReflection
