...
class SQLAlchemyPlugin(Plugin):
    ...
    def get_attribute_hook(
        ...
        if fullname.startswith(
            "sqlalchemy3.orm.attributes.QueryableAttribute."
        ):
    ...
    def get_additional_deps(
        ...
        return [
            #
            (10, "sqlalchemy3.orm", -1),
            (10, "sqlalchemy3.orm.attributes", -1),
            (10, "sqlalchemy3.orm.decl_api", -1),
        ]
...
def _add_globals(ctx: Union[ClassDefContext, DynamicClassDefContext]) -> None:
    ...
    util.add_global(ctx, "sqlalchemy3.orm", "Mapped", "__sa_Mapped")
