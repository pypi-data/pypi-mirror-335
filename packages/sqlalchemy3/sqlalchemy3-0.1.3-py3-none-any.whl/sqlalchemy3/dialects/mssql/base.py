...
:class:`.Sequence` - and will generate DDL as such::
    ...
    from sqlalchemy3 import Table, MetaData, Column, Integer
...
parameters passed to the :class:`_schema.Identity` object::
    ...
    from sqlalchemy3 import Table, Integer, Column, Identity
...
.. versionchanged:: 1.3.19  The :class:`_schema.Identity` object is
   ...
   functional in the normal way starting from sqlalchemy3 version 1.4.
...
.. sourcecode:: pycon+sql
    ...
    >>> from sqlalchemy3 import Sequence
    >>> from sqlalchemy3.schema import CreateSequence
    >>> from sqlalchemy3.dialects import mssql
    >>> print(
...
specified by the string argument "collation"::
    ...
    from sqlalchemy3 import VARCHAR
