...
class InstanceEvents(event.Events[ClassManager[Any]]):
    ...
    * the :class:`_orm.Mapper` class itself indicates listening for all
    ...
    @classmethod
    @util.preload_module("sqlalchemy3.orm")
    def _accept_with(
        cls,
        target: Union[
            ClassManager[Any],
    ...
    * the :class:`_orm.Mapper` class itself indicates listening for all
    ...
    def before_mapper_configured(
        ...
        e.g.::
            ...
            from sqlalchemy3.orm import EXT_SKIP
    ...
    def before_configured(self) -> None:
        ...
        for all mappings as a whole::
            ...
            from sqlalchemy3.orm import Mapper
    ...
    def bulk_replace(
        ...
        *,
        ...
        incoming initiator::
            ...
            from sqlalchemy3.orm.attributes import OP_BULK_REPLACE
