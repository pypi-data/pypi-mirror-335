...
class Mapper(
    ...
    def __init__(
        ...
        :param polymorphic_on: Specifies the column, attribute, or
          ...
          looks like::
                ...
                from sqlalchemy3.orm import object_mapper
    ...
    @util.preload_module("sqlalchemy3.orm.descriptor_props")
    ...
    @util.preload_module("sqlalchemy3.orm.strategy_options")
...
@util.preload_module("sqlalchemy3.orm.decl_api")
