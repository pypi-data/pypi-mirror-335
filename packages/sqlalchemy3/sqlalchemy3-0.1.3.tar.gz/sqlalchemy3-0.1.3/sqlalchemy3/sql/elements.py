...
class CompilerElement(Visitable):
    ...
    @util.preload_module("sqlalchemy3.engine.default")
    @util.preload_module("sqlalchemy3.engine.url")
    def compile(
        self,
        ...
        **kw: Any,
        ...
        :param compile_kwargs: optional dictionary of additional parameters
            ...
            for the case of passing the ``literal_binds`` flag through::
                ...
                from sqlalchemy3.sql import table, column, select
...
class TextClause(
    ...
    @util.preload_module("sqlalchemy3.sql.selectable")
    def columns(
        self,
        ...
        **types: _TypeEngineArgument[Any],
        ...
        of a "selectable"::
            ...
            from sqlalchemy3.sql import column, text
...
class FunctionFilter(Generative, ColumnElement[_T]):
    ...
    def over(
        ...
        is shorthand for::
            ...
            from sqlalchemy3 import over, funcfilter
...
class quoted_name(util.MemoizedSlots, str):
    ...
    convert from sqlalchemy3's lower-case-means-insensitive convention
    ...
    an unconditionally quoted name::
        ...
        from sqlalchemy3.sql import quoted_name
