...
class TypeEngine(Visitable, Generic[_T]):
    ...
    class Comparator(
        ...
        @util.preload_module("sqlalchemy3.sql.default_comparator")
        def operate(
    ...
    def with_variant(
        ...
        *dialect_names: str,
        ...
        e.g.::
            ...
            from sqlalchemy3.types import String
            from sqlalchemy3.dialects import mysql
    ...
    def _generic_type_affinity(
        ...
        for t in self.__class__.__mro__:
            if (
                t.__module__
                in (
                    "sqlalchemy3.sql.sqltypes",
                    "sqlalchemy3.sql.type_api",
                )
    ...
    def as_generic(self, allow_nulltype: bool = False) -> TypeEngine[_T]:
        ...
        >>> from sqlalchemy3.dialects.mysql import INTEGER
        >>> INTEGER(display_width=4).as_generic()
        Integer()

        >>> from sqlalchemy3.dialects.mysql import NVARCHAR
...
class TypeDecorator(SchemaEventTarget, ExternalType, TypeEngine[_T]):
    ...
    .. warning::
       ...
       be used in order to deal with operators like index operations::
            ...
            from sqlalchemy3 import JSON
            from sqlalchemy3 import TypeDecorator
