...
class DDL(ExecutableDDLElement):
    ...
    Examples::
      ...
      from sqlalchemy3 import event, DDL
...
class CreateColumn(BaseDDLElement):
    ...
    is found::
        ...
        from sqlalchemy3 import schema
    ...
    as follows::
        ...
        from sqlalchemy3 import Table, Metadata, Column, Integer, String
        from sqlalchemy3 import schema
    ...
    on PostgreSQL::
        ...
        from sqlalchemy3.schema import CreateColumn
