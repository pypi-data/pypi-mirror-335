...
def declarative_mixin(cls: Type[_T]) -> Type[_T]:
    ...
    E.g.::
        ...
        from sqlalchemy3.orm import declared_attr
        from sqlalchemy3.orm import declarative_mixin
...
class DeclarativeBase(
    ...
    :paramref:`_orm.registry.type_annotation_map`::
        ...
        from sqlalchemy3 import BigInteger
...
def declarative_base(
    *,
    ...
    method.  That is, the following::
        ...
        from sqlalchemy3.orm import declarative_base

        Base = declarative_base()

    Is equivalent to::

        from sqlalchemy3.orm import registry
...
def as_declarative(**kw: Any) -> Callable[[Type[_T]], Type[_T]]:
    ...
    E.g.::
        ...
        from sqlalchemy3.orm import as_declarative
