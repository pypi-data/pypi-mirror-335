...
if TYPE_CHECKING:
    from sqlalchemy3 import dialects as _dialects
    from sqlalchemy3 import orm as _orm
    from sqlalchemy3.engine import cursor as _engine_cursor
    from sqlalchemy3.engine import default as _engine_default
    from sqlalchemy3.engine import reflection as _engine_reflection
    from sqlalchemy3.engine import result as _engine_result
    from sqlalchemy3.engine import url as _engine_url
    from sqlalchemy3.orm import attributes as _orm_attributes
    from sqlalchemy3.orm import base as _orm_base
    from sqlalchemy3.orm import clsregistry as _orm_clsregistry
    from sqlalchemy3.orm import decl_api as _orm_decl_api
    from sqlalchemy3.orm import decl_base as _orm_decl_base
    from sqlalchemy3.orm import dependency as _orm_dependency
    from sqlalchemy3.orm import descriptor_props as _orm_descriptor_props
    from sqlalchemy3.orm import mapperlib as _orm_mapper
    from sqlalchemy3.orm import properties as _orm_properties
    from sqlalchemy3.orm import relationships as _orm_relationships
    from sqlalchemy3.orm import session as _orm_session
    from sqlalchemy3.orm import state as _orm_state
    from sqlalchemy3.orm import strategies as _orm_strategies
    from sqlalchemy3.orm import strategy_options as _orm_strategy_options
    from sqlalchemy3.orm import util as _orm_util
    from sqlalchemy3.sql import default_comparator as _sql_default_comparator
    from sqlalchemy3.sql import dml as _sql_dml
    from sqlalchemy3.sql import elements as _sql_elements
    from sqlalchemy3.sql import functions as _sql_functions
    from sqlalchemy3.sql import naming as _sql_naming
    from sqlalchemy3.sql import schema as _sql_schema
    from sqlalchemy3.sql import selectable as _sql_selectable
    from sqlalchemy3.sql import sqltypes as _sql_sqltypes
    from sqlalchemy3.sql import traversals as _sql_traversals
    from sqlalchemy3.sql import util as _sql_util
...
class _ModuleRegistry:
    ...
    def __init__(self, prefix="sqlalchemy3."):
