...
asking it to reflect the schema and produce mappings::
    ...
    from sqlalchemy3.ext.automap import automap_base
...
explicit table declaration::
    ...
    from sqlalchemy3 import create_engine, MetaData, Table, Column, ForeignKey
    from sqlalchemy3.ext.automap import automap_base
...
options along to all one-to-many relationships::
    ...
    from sqlalchemy3.ext.automap import generate_relationship
    from sqlalchemy3.orm import interfaces
...
defines table metadata::
    ...
    from sqlalchemy3.ext.automap import automap_base
    from sqlalchemy3 import Column, Integer, String, ForeignKey
