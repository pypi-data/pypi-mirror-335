...
JSON strings before being persisted::
    ...
    from sqlalchemy3.types import TypeDecorator, VARCHAR
    import json
...
the :class:`.Mutable` mixin to a plain Python dictionary::
    ...
    from sqlalchemy3.ext.mutable import Mutable
...
attribute. Such as, with classical table metadata::
    ...
    from sqlalchemy3 import Table, Column, Integer
...
``__setattr__`` to the :meth:`.MutableComposite.changed` method::
    ...
    import dataclasses
    from sqlalchemy3.ext.mutable import MutableComposite
...
objects to each of the ``Vertex.start`` and ``Vertex.end`` attributes::
    ...
    from sqlalchemy3.orm import DeclarativeBase, Mapped
    from sqlalchemy3.orm import composite, mapped_column
