...
class AsyncAttrs:
    ...
    E.g.::
        ...
        from sqlalchemy3.ext.asyncio import AsyncAttrs
    ...
    def get_bind(
        ...
        **kw: Any,
        ...
        :attr:`_asyncio.AsyncEngine.sync_engine` attribute::
            ...
            from sqlalchemy3.ext.asyncio import create_async_engine
            from sqlalchemy3.ext.asyncio import async_sessionmaker
