...
.. sourcecode:: pycon+sql
    ...
    >>> from sqlalchemy3.dialects.sqlite import insert
...
class DATETIME(_DateTimeMixin, sqltypes.DateTime):
    ...
    ``storage_format`` and ``regexp`` parameters, such as::
        ...
        import re
        from sqlalchemy3.dialects.sqlite import DATETIME
...
class DATE(_DateTimeMixin, sqltypes.Date):
    ...
    ``storage_format`` and ``regexp`` parameters, such as::
        ...
        import re
        from sqlalchemy3.dialects.sqlite import DATE
...
class TIME(_DateTimeMixin, sqltypes.Time):
    ...
    ``storage_format`` and ``regexp`` parameters, such as::
        ...
        import re
        from sqlalchemy3.dialects.sqlite import TIME
