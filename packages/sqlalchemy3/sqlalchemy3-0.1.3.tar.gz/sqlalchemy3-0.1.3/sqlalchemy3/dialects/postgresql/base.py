...
:class:`_schema.Column` can be used to control its behavior::
    ...
    from sqlalchemy3 import Table, Column, MetaData, Integer, Computed
...
reflection process as follows::
    ...
    >>> from sqlalchemy3 import Table, MetaData, create_engine, text
...
The :class:`_postgresql.TSVECTOR` type can provide for explicit CAST::
    ...
    from sqlalchemy3.dialects.postgresql import TSVECTOR
    from sqlalchemy3 import select, cast
...
of :class:`.PGInspector`, which offers additional methods::
    ...
    from sqlalchemy3 import create_engine, inspect
...
* ``json_populate_record()``:
  ...
  .. sourcecode:: pycon+sql
    ...
    >>> from sqlalchemy3 import select, func, literal_column
    >>> stmt = select(
...
* ``json_to_record()`` - this form uses a PostgreSQL specific form of derived
  ...
  .. sourcecode:: pycon+sql
    ...
    >>> from sqlalchemy3 import select, func, column, Integer, Text
    >>> stmt = select(
...
* ``unnest()`` - in order to generate a PostgreSQL ARRAY literal, the
  ...
  .. sourcecode:: pycon+sql
    ...
    >>> from sqlalchemy3 import table, column, ARRAY, Integer
    >>> from sqlalchemy3 import select, func
...
.. sourcecode:: pycon+sql
    ...
    >>> from sqlalchemy3 import table, column, func, tuple_
...
.. sourcecode:: pycon+sql
    ...
    >>> from sqlalchemy3 import table, column, func, select
    ...
    def _assert_pg_ts_ext(self, element, **kw):
        if not isinstance(element, _regconfig_fn):
            ...
            raise exc.CompileError(
                ...
                f'"sqlalchemy3.dialects.postgresql" package.  '
                f'Please ensure "import sqlalchemy.dialects.postgresql" is '
                f"called before constructing "
                f'"sqlalchemy3.func.{element.name}()" to ensure registration '
