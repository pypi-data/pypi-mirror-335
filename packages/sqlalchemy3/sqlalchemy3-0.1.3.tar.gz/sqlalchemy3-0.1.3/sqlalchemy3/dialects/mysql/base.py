...
the ``first_connect`` and ``connect`` events::
    ...
    from sqlalchemy3 import create_engine, event
...
* MATCH
  operator support::
        ...
        from sqlalchemy3.dialects.mysql import match
...
.. sourcecode:: pycon+sql
    ...
    >>> from sqlalchemy3.dialects.mysql import insert
...
them ignored on a MySQL / MariaDB backend, use a custom compile rule::
    ...
    from sqlalchemy3.ext.compiler import compiles
    from sqlalchemy3.schema import ForeignKeyConstraint
...
parameter and pass a textual clause that also includes the ON UPDATE clause::
    ...
    from sqlalchemy3 import Table, MetaData, Column, Integer, String, TIMESTAMP
...
:class:`_types.DATETIME` datatypes::
    ...
    from sqlalchemy3 import DateTime
...
updated value should be fetched.  This syntax looks like the following::
    ...
    from sqlalchemy3.schema import FetchedValue
...
``nullable=False``.   The following example illustrates::
    ...
    from sqlalchemy3 import MetaData, Integer, Table, Column, text
    from sqlalchemy3.dialects.mysql import TIMESTAMP
