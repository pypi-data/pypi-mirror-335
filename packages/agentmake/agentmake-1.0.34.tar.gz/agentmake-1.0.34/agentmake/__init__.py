...
SUPPORTED_AI_BACKENDS = ["anthropic", "azure", "azure_deepseek", "cohere", "custom", "deepseek", "genai", "github", "github_deepseek", "googleai", "groq", "llamacpp", "mistral", "ollama", "openai", "vertexai", "xai"]
    ...
    **kwargs, # pass extra options supported by individual backends
    ...
    Args:
        ...
        backend:
            ...
            AI backend
            supported backends: "anthropic", "azure", "azure_deepseek", "cohere", "custom", "deepseek", "genai", "github", "github_deepseek", "googleai", "groq", "llamacpp", "mistral", "ollama", "openai", "vertexai", "xai"
