def translate_into_traditional_chinese_azure_deepseeek(content, **kwargs):
    ...
    model_name = os.getenv("AZURE_DEEPSEEK_REASONER_MODEL")

    client = ChatCompletionsClient(
        endpoint=os.getenv("AZURE_DEEPSEEK_REASONER_API_ENDPOINT"),
        credential=AzureKeyCredential(os.getenv("AZURE_DEEPSEEK_REASONER_API_KEY")),
    )
