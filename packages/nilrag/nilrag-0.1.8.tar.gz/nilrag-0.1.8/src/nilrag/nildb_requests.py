...
class NilDB:
    ...
    async def upload_data(
        self, lst_embedding_shares: list[list[int]], lst_chunk_shares: list[list[bytes]], batch_size: int = 100
    ):
        """
        ...
        Args:
            ...
            batch_size (int, optional): Number of documents to upload in each batch. Defaults to 50.
        ...
        for batch_start in range(0, total_documents, batch_size):
            ...
            print(f"Processing batch {batch_start//batch_size + 1}: documents {batch_start} to {batch_end}")
            ...
            for node_idx, node in enumerate(self.nodes):
                ...
                for doc_idx in range(batch_start, batch_end):
                    ...
                    node_embedding_shares = [e[node_idx] for e in lst_embedding_shares[doc_idx]]
            ...
            # Execute all uploads in the current batch in parallel
            try:
