...
import sys
import os
denss_path = os.path.dirname(os.path.dirname(__file__))
lib_path = os.path.dirname(denss_path)
sys.path.append(denss_path)
sys.path.append(lib_path)
import molass_legacy.KekLib, SerialAnalyzer   # this import is required for DENSS.__init__, but not in this script
