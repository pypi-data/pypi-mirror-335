...
#define   ippCPUID_KNC             0x80000000  /* Intel(R) Xeon Phi(TM) coprocessor                                                       */
 ...
 #define   ippCPUID_AVX_VNNI        INT64_SUFFIX(0x2000000000)       /* Intel(R) Advanced Vector Extensions 2 AVX-VNNI instruction set */
 #define   ippCPUID_AVX_VNNI_INT8   INT64_SUFFIX(0x4000000000)       /* Intel(R) Advanced Vector Extensions 2 AVX-VNNI-INT8 instruction set */
 #define   ippCPUID_AVX_VNNI_INT16  INT64_SUFFIX(0x8000000000)       /* Intel(R) Advanced Vector Extensions 2 AVX-VNNI-INT16 instruction set */
...
#define ippStsInplaceModeNotSupportedErr -9998/* The inplace operation is currently not supported. */
     ...
     /* ippCrypto specific statuses - any changes MUST be done in both repositories -
        Intel IPP & ippCrypto - don't use sts range 1000-2000 - reserved for Crypto */
