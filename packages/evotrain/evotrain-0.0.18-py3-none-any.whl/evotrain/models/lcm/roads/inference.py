...
from evotrain.models.lcm.roads.dataset import (
    NET_LABELS,
...
def load_feats_head(bounds, epsg, year, resolution=10):
    meteo_emb = load_meteo_embeddings(bounds, epsg, year, bounds_buffer=3000, order=2)
...
class Lcm10Inference:
    ...
    def predict(self, feats, feats_head, return_conv=False, scale_feats=True):
        if scale_feats:
        ...
        probs = self.net.model.predict(feats.data, feats_head, return_conv=return_conv)
