...
from evotrain.models.lcm10.v10.config import NET_LABELS
...
def compute_metrics(outputs, targets, num_classes=9, suffix=""):
    # Handle suffix
...
class Net(pl.LightningModule):
    ...
    def load_architecture(self, architecture):
        if architecture == "LcmUnet":
            from evotrain.models.lcm10.v10.arch import LcmUnet as Arch
        elif architecture == "LcmUnetV2":
            from evotrain.models.lcm10.v10.arch import LcmUnetV2 as Arch
        else:
