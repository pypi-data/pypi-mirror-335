...
from evotrain.models.lcm10.v10.dataset import (
    NET_LABELS,
    apply_augmented_scaling,
)
from evotrain.models.lcm10.v10.model import Net
...
def load_config(model_version):
    base_models_path = BASE_MODELS_PATH
    model_name = f"lcm10-unet-base-{model_version}"
...
class Lcm10Net:
    ...
    def config(self):
        if self._config is None:
            self._config = load_config(self.model_version)
        return self._config
    ...
    def predict(self, feats, feats_head, return_conv=False):
        ...
        logger.debug("Calling inference")
