...
from evotrain.models.lsc10.v15.labels import (LSC_COVER_LABELS, LSC_OCCLUSION_LABELS, LSC_ECOSYSTEM_LABELS)

from evotrain.models.lsc10.v15.labels import batch_probs_to_rgb
...
def load_target_probs(val_dataset, sample_id):
    ...
    prob_cover, prob_occlusion, prob_eco, weight_cover, weight_occlusion, weight_eco = val_dataset.read_evov1_target(sample_id, lab_source)
