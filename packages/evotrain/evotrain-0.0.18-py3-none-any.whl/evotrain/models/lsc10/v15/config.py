    ...
    config_dict = dict(
        ...
        model=dict(
            ...
            classes_weights={   
                0: 0.59, # tree
                1: 0.74, # shrub
                2: 0.60, # herbaceous vegetation
                3: 0.55, # not vegetated
                4: 0.84, # water
                5: 0.83, # snow
                ...
                10: 6.10, # mangrove
                11: 1.34, # built-up
                12: 2.60, # herbaceous wetland
                13: 7.13, # lichens
                14: 0.15, # other/natural
            },
            spatial_filters_settings={
                "kernel_size": (9, 7, 5, 3),
                "out_channels": (2, 2, 2, 9),
                "padding_mode": "reflect",
            },
            mlp_hidden_layers=(100, 50, 25),#(400, 300, 200, 100, 50),
            dropout_prob=0.2,
