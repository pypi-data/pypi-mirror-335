...
from evotrain.models.lsc10.v16.model import Net
    ...
    trainer_kwargs = dict(
        ...
        callbacks=[
            ...
            InferencePreview(
                val_dataset,
                tt_logger,
                val_ids=['50RMS_016_41_20200201',
 '53WNP_103_06_20200223',
 '21LYL_103_59_20201202',
 '13SCD_033_45_20200509',
 '34NFK_040_00_20200211',
 '55JDL_080_59_20200425',
 '36QZL_088_24_20200701',
 '49NBD_105_21_20200414',
 '31SED_035_34_20200628',
 '13WES_040_50_20200229',
 '56WNA_026_63_20201022',
 '39UXA_050_10_20200129'],
                years=[2020],
                every_n_steps=250,
                rgb_ids=[2, 1, 0],
            ),
