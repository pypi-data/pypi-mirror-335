...
class xAOD:
    ...
    def setOriginalObjectLink(self, original: func_adl_servicex_xaodr22.xAOD.iparticle.IParticle, copy: func_adl_servicex_xaodr22.xAOD.iparticle.IParticle) -> bool:
        "A method"
        ...

    def getOriginalObject(self, copy: func_adl_servicex_xaodr22.xAOD.iparticle.IParticle) -> func_adl_servicex_xaodr22.xAOD.iparticle.IParticle:
        "A method"
        ...

    def getOriginalObjectLink(self, copy: func_adl_servicex_xaodr22.xAOD.iparticle.IParticle) -> func_adl_servicex_xaodr22.elementlink_datavector_xaod_iparticle__.ElementLink_DataVector_xAOD_IParticle__:
        "A method"
        ...
