...
class CompositeParticle_v1:
    ...
    def mt(self, partIndices: func_adl_servicex_xaodr22.vector_int_.vector_int_, method: func_adl_servicex_xaodr22.xAOD.CompositeParticle_v1.mt.MT.Method) -> float:
        "A method"
        ...
