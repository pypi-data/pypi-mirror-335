...
class TrackParticle_v1:
    ...
    def parameterPosition(self, index: int) -> func_adl_servicex_xaodr22.xaod.xAOD.ParameterPosition:
        "A method"
        ...

    def indexOfParameterAtPosition(self, index: int, position: func_adl_servicex_xaodr22.xaod.xAOD.ParameterPosition) -> bool:
        "A method"
        ...
    ...
    def trackProperties(self) -> func_adl_servicex_xaodr22.xaod.xAOD.TrackProperties:
        "A method"
        ...

    def particleHypothesis(self) -> func_adl_servicex_xaodr22.xaod.xAOD.ParticleHypothesis:
        "A method"
        ...

    def trackFitter(self) -> func_adl_servicex_xaodr22.xaod.xAOD.TrackFitter:
        "A method"
        ...
