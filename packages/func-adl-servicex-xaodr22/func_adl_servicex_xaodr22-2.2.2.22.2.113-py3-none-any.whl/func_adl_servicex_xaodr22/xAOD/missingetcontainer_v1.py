...
class MissingETContainer_v1:
    ...
    def dvlinfo(self) -> func_adl_servicex_xaodr22.DataModel_detail.dvlinfobase.DVLInfoBase:
        "A method"
        ...

    def dvlinfo_v(self) -> func_adl_servicex_xaodr22.DataModel_detail.dvlinfobase.DVLInfoBase:
        "A method"
        ...
