...
_method_map = {
    ...
    'rCoreNumerator': {
        'metadata_type': 'add_method_type_info',
        'type_string': 'xAOD::eFexTauRoI_v1',
        'method_name': 'rCoreNumerator',
        'return_type': 'uint16_t',
    },
    'rCoreDenominator': {
        'metadata_type': 'add_method_type_info',
        'type_string': 'xAOD::eFexTauRoI_v1',
        'method_name': 'rCoreDenominator',
        'return_type': 'uint16_t',
    },
    'rHadNumerator': {
        'metadata_type': 'add_method_type_info',
        'type_string': 'xAOD::eFexTauRoI_v1',
        'method_name': 'rHadNumerator',
        'return_type': 'uint16_t',
    },
    'rHadDenominator': {
        'metadata_type': 'add_method_type_info',
        'type_string': 'xAOD::eFexTauRoI_v1',
        'method_name': 'rHadDenominator',
        'return_type': 'uint16_t',
    },
    'isTOB': {
        'metadata_type': 'add_method_type_info',
...
class eFexTauRoI_v1:
    ...
    def rCoreNumerator(self) -> int:
        "A method"
        ...

    def rCoreDenominator(self) -> int:
        "A method"
        ...

    def rHadNumerator(self) -> int:
        "A method"
        ...

    def rHadDenominator(self) -> int:
        "A method"
        ...
