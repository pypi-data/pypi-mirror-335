...
from os import chdir, makedirs, path, remove
...
dnf install perl-Config-IniFiles.noarch''')
    ...
    def _is_plugin_exists(self, text: str, widget_name: Optional[str] = None) -> None:
        """
    ...
    def _find_children(self) -> None:
        ...
        # <=><=><=><=><=><=><=><=><=><=><=> tes3cmd <=><=><=><=><=><=><=><=><=><=><=>
        self.actionLoad: Union[object, QAction] = self.findChild(QAction, 'actionLoad')
        self.actionSave: Union[object, QAction] = self.findChild(QAction, 'actionSave')
        self.actionSave_as: Union[object, QAction] = self.findChild(QAction, 'actionSave_as')
        self.actionQuit: Union[object, QAction] = self.findChild(QAction, 'actionQuit')
        self.actionAboutMoht: Union[object, QAction] = self.findChild(QAction, 'actionAboutMoht')
        self.actionAboutQt: Union[object, QAction] = self.findChild(QAction, 'actionAboutQt')
        self.actionReportIssue: Union[object, QAction] = self.findChild(QAction, 'actionReportIssue')
        self.actionCheckUpdates: Union[object, QAction] = self.findChild(QAction, 'actionCheckUpdates')

        self.pb_mods_dir: Union[object, QPushButton] = self.findChild(QPushButton, 'pb_mods_dir')
        self.pb_morrowind_dir: Union[object, QPushButton] = self.findChild(QPushButton, 'pb_morrowind_dir')
        self.pb_tes3cmd: Union[object, QPushButton] = self.findChild(QPushButton, 'pb_tes3cmd')
        self.pb_report: Union[object, QPushButton] = self.findChild(QPushButton, 'pb_report')
        self.pb_back_clean: Union[object, QPushButton] = self.findChild(QPushButton, 'pb_back_clean')
        self.pb_clean: Union[object, QPushButton] = self.findChild(QPushButton, 'pb_clean')

        self.cb_rm_backup: Union[object, QCheckBox] = self.findChild(QCheckBox, 'cb_rm_backup')
        self.cb_rm_cache: Union[object, QCheckBox] = self.findChild(QCheckBox, 'cb_rm_cache')
        self.cb_auto_save: Union[object, QCheckBox] = self.findChild(QCheckBox, 'cb_auto_save')

        self.le_mods_dir: Union[object, QLineEdit] = self.findChild(QLineEdit, 'le_mods_dir')
        self.le_morrowind_dir: Union[object, QLineEdit] = self.findChild(QLineEdit, 'le_morrowind_dir')
        self.le_tes3cmd: Union[object, QLineEdit] = self.findChild(QLineEdit, 'le_tes3cmd')

        self.rb_40: Union[object, QRadioButton] = self.findChild(QRadioButton, 'rb_40')
        self.rb_37: Union[object, QRadioButton] = self.findChild(QRadioButton, 'rb_37')
        self.rb_custom: Union[object, QRadioButton] = self.findChild(QRadioButton, 'rb_custom')

        self.stacked_clean: Union[object, QStackedWidget] = self.findChild(QStackedWidget, 'stacked_clean')
        self.tree_report: Union[object, QTreeWidget] = self.findChild(QTreeWidget, 'tree_report')

        # <=><=><=><=><=><=><=><=><=><=><=> omwcmd <=><=><=><=><=><=><=><=><=><=><=>
        self.pb_masters_select: Union[object, QPushButton] = self.findChild(QPushButton, 'pb_masters_select')
        self.pb_masters_run: Union[object, QPushButton] = self.findChild(QPushButton, 'pb_masters_run')
        self.le_masters_plugin: Union[object, QLineEdit] = self.findChild(QLineEdit, 'le_masters_plugin')
        self.l_masters_result: Union[object, QLineEdit] = self.findChild(QLineEdit, 'l_masters_result')
...
class AboutDialog(QDialog):
    ...
    def __init__(self, parent) -> None:
        ...
        self.label: Union[object, QLabel] = self.findChild(QLabel, 'label')
        self.setup_text()
