...
class RunsApi:
    ...
    def get_run_results(
        ...
        include_confidence_scores: Annotated[Optional[StrictBool], Field(description="Whether to include confidence scores in the results. When set to `true`, extraction confidence scores at the extracted field level are included.  The following values are returned at the extracted field level:  - `confidence/model` - `confidence/ocr`  See the response schema for details and descriptions. ")] = None,
        include_validation_results: Annotated[Optional[StrictBool], Field(description="Whether to include validation status in the results. When set to `true`, validation results at the run or document level and extracted field level are included.  The following values are returned at the run or document level:  - `files/documents/validations/final_result_pass`  The following values are returned at the extracted field level:  - `validations/valid` - `validations/alerts`  See the response schema for details and descriptions. ")] = None,
        ...
        :param include_confidence_scores: Whether to include confidence scores in the results. When set to `true`, extraction confidence scores at the extracted field level are included.  The following values are returned at the extracted field level:  - `confidence/model` - `confidence/ocr`  See the response schema for details and descriptions. 
