...
class ConversationsApi:
    ...
    def add_documents_to_conversation(
        ...
        Upload documents to a specified conversation.  <Note> There are some limitations when uploading files to a conversation:   - Files can be up to 50 MB or 800 pages.   - You can upload up to 100 MB per request.   - You can have up to 100 documents per conversation.   - There are specific [supported file types](/overview/limitations#supported-file-types) </Note> 
