...
class RunQueryRequestSourceApp(BaseModel):
    ...
    """ # noqa: E501
    type: StrictStr = Field(description="The source app type. For chatbot queries, use `CHATBOT`. For converse queries, use `CONVERSE`.")
    id: StrictStr = Field(description="The ID of the source app to query. You can query any AI Hub source app to which you have access.  <Tip>You can find the source app ID in its AI Hub URL. For Chatbot, URL will be <span>http</span>s://aihub.instabase.com/hub/apps/**788eba40-5a1f-45f4-ad56-57fb1abe62c7**. For Converse, URL will be <span>http</span>s://aihub.instabase.com/converse/**01930a30-f278-7dc1-be96-9abc5c0530b5**.</Tip>  <Note>Chatbot IDs change with [every version update.](/chat/creating-chatbots#updating-chatbots) For convenience, when making a request to a given version of a chatbot, the query is automatically directed to the latest version of the chatbot.</Note> ")
