...
class OPS_API SelectExt : public BaseOperator {
 public:
  MIND_API_BASE_MEMBER(SelectExt);
  SelectExt();
...
class OPS_API UnstackExt : public BaseOperator {
 public:
...
class OPS_API TransposeExt : public BaseOperator {
 public:
  MIND_API_BASE_MEMBER(TransposeExt);
  TransposeExt();
