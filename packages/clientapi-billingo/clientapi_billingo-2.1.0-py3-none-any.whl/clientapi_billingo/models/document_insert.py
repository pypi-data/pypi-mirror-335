...
class DocumentInsert(BaseModel):
    ...
    advance_invoice: Optional[List[StrictInt]] = None
    discount: Optional[Discount] = None
    instant_payment: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["vendor_id", "partner_id", "block_id", "bank_account_id", "type", "fulfillment_date", "due_date", "payment_method", "language", "currency", "conversion_rate", "electronic", "paid", "items", "comment", "settings", "advance_invoice", "discount", "instant_payment"]
