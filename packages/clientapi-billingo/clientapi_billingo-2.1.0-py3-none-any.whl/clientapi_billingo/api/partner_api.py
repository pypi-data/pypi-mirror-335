...
class PartnerApi:
    ...
    def create_partner(
        self,
        partner: Annotated[Partner, Field(description="Partner object that you would like to store.")],
    ...
    def delete_partner(
        ...
        _param = self._delete_partner_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def delete_partner_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_partner_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def get_partner(
        ...
        _param = self._get_partner_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_partner_with_http_info(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_partner_without_preload_content(
        self,
        id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def list_partner(
        ...
        _param = self._list_partner_serialize(
            page=page,
            per_page=per_page,
            query=query,
            _request_auth=_request_auth,
    ...
    @validate_call
    def list_partner_with_http_info(
        self,
        page: Optional[StrictInt] = None,
        per_page: Optional[Annotated[int, Field(le=100, strict=True, ge=1)]] = None,
        query: Optional[StrictStr] = None,
    ...
    @validate_call
    def list_partner_without_preload_content(
        self,
        page: Optional[StrictInt] = None,
        per_page: Optional[Annotated[int, Field(le=100, strict=True, ge=1)]] = None,
        query: Optional[StrictStr] = None,
    ...
    def update_partner(
        self,
        id: StrictInt,
        partner: Annotated[Partner, Field(description="Partner object that you would like to update.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
