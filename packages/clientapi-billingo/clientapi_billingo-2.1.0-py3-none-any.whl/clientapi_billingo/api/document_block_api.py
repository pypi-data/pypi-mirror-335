...
class DocumentBlockApi:
    ...
    def list_document_block(
        ...
        type: Annotated[Optional[DocumentBlockType], Field(description="Filter document blocks by type")] = None,
        ...
        _param = self._list_document_block_serialize(
            page=page,
            per_page=per_page,
            type=type,
    ...
    @validate_call
    def list_document_block_with_http_info(
        self,
        page: Optional[StrictInt] = None,
        per_page: Optional[Annotated[int, Field(le=100, strict=True, ge=1)]] = None,
        type: Annotated[Optional[DocumentBlockType], Field(description="Filter document blocks by type")] = None,
    ...
    @validate_call
    def list_document_block_without_preload_content(
        self,
        page: Optional[StrictInt] = None,
        per_page: Optional[Annotated[int, Field(le=100, strict=True, ge=1)]] = None,
        type: Annotated[Optional[DocumentBlockType], Field(description="Filter document blocks by type")] = None,
    ...
    def _list_document_block_serialize(
        self,
        page,
        per_page,
        type,
