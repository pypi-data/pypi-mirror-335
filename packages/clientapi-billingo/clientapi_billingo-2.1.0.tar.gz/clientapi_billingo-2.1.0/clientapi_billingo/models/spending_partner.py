...
class SpendingPartner(BaseModel):
    """
    SpendingPartner
    """ # noqa: E501
    ...
    group_member_tax_number: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id", "name", "tax_code", "address", "iban", "swift", "account_number", "phone", "internal_comment", "group_member_tax_number"]
