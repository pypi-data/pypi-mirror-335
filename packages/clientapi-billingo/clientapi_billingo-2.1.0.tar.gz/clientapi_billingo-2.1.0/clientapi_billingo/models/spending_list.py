...
class SpendingList(BaseModel):
    ...
    """ # noqa: E501
    data: Optional[List[SpendingListItem]] = None
    ...
    __properties: ClassVar[List[str]] = ["data", "total", "per_page", "current_page", "last_page", "prev_page_url", "next_page_url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [SpendingListItem.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "total": obj.get("total"),
