...
# im = np.asarray(Image.open(r'C:/Users/Yannick Zander/Nextcloud2/Promotion/maspim/imaging/register/image_classified.png'))

im2 = np.array(Image.open(r'//imaging/register/2020_03_23_Cariaco_535-540cm_Fullerite_0001.bmp').convert('L'))
