...
from maspim.imaging.register.descriptor import Descriptor, rect
from maspim.imaging.learning.synthetic_images import get_image_pair
...
# image, mask = test_synthetic_offset()
# image, mask = test_cl()
...
plt.show()
plt.imshow(d.get_shift_matrix(image.shape))
plt.show()
