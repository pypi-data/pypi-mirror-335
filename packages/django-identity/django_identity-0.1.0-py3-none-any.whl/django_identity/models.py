...
class UserManager(BaseUserManager):
    ...
    def _create_user_obj(self, username, email, password, **extra_fields):
        ...
        # TODO: Check if email already exists before creating user
        user = self.model(username=username, **extra_fields)
        # TODO: Create new email and set as primary for user
...
class Email(models.Model):
    ...
    def email(self, value):
        self._email = self.normalize_email_domain(value)
    ...
    @classmethod
    def normalize_email_domain(cls, email):
        """Normalize email domain by lowercasing it."""
        email = email or ""
