...
class MemberRole(
    ...
    def __init__(
        ...
        *,
        ...
        :param base_access_level: The base access level for the custom role. Valid values are: ``DEVELOPER``, ``GUEST``, ``MAINTAINER``, ``MINIMAL_ACCESS``, ``OWNER``, ``REPORTER``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.10.0/docs/resources/member_role#base_access_level MemberRole#base_access_level}
        :param enabled_permissions: All permissions enabled for the custom role. Valid values are: ``ADMIN_CICD_VARIABLES``, ``ADMIN_COMPLIANCE_FRAMEWORK``, ``ADMIN_GROUP_MEMBER``, ``ADMIN_INTEGRATIONS``, ``ADMIN_MERGE_REQUEST``, ``ADMIN_PROTECTED_BRANCH``, ``ADMIN_PUSH_RULES``, ``ADMIN_RUNNERS``, ``ADMIN_TERRAFORM_STATE``, ``ADMIN_VULNERABILITY``, ``ADMIN_WEB_HOOK``, ``ARCHIVE_PROJECT``, ``MANAGE_DEPLOY_TOKENS``, ``MANAGE_GROUP_ACCESS_TOKENS``, ``MANAGE_MERGE_REQUEST_SETTINGS``, ``MANAGE_PROJECT_ACCESS_TOKENS``, ``MANAGE_SECURITY_POLICY_LINK``, ``READ_ADMIN_CICD``, ``READ_ADMIN_DASHBOARD``, ``READ_CODE``, ``READ_COMPLIANCE_DASHBOARD``, ``READ_CRM_CONTACT``, ``READ_DEPENDENCY``, ``READ_RUNNERS``, ``READ_VULNERABILITY``, ``REMOVE_GROUP``, ``REMOVE_PROJECT`` Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.10.0/docs/resources/member_role#enabled_permissions MemberRole#enabled_permissions}
        :param name: Name for the member role. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.10.0/docs/resources/member_role#name MemberRole#name}
        :param description: Description for the member role. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.10.0/docs/resources/member_role#description MemberRole#description}
        :param group_path: Full path of the namespace to create the member role in. **Required for SAAS** **Not allowed for self-managed**. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.10.0/docs/resources/member_role#group_path MemberRole#group_path}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing MemberRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.10.0/docs/resources/member_role#import import section} in the documentation of this resource for the id to use
