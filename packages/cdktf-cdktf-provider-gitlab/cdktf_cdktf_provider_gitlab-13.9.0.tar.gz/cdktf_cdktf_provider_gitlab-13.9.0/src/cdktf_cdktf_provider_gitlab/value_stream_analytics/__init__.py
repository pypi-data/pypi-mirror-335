...
class ValueStreamAnalytics(
    ...
    def __init__(
        ...
        *,
        ...
        :param name: The name of the value stream. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.10.0/docs/resources/value_stream_analytics#name ValueStreamAnalytics#name}
        :param stages: Stages of the value stream. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.10.0/docs/resources/value_stream_analytics#stages ValueStreamAnalytics#stages}
        :param group_full_path: Full path of the group the value stream is created in. **One of ``group_full_path`` OR ``project_full_path`` is required.**. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.10.0/docs/resources/value_stream_analytics#group_full_path ValueStreamAnalytics#group_full_path}
        :param project_full_path: Full path of the project the value stream is created in. **One of ``group_full_path`` OR ``project_full_path`` is required.**. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.10.0/docs/resources/value_stream_analytics#project_full_path ValueStreamAnalytics#project_full_path}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing ValueStreamAnalytics that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.10.0/docs/resources/value_stream_analytics#import import section} in the documentation of this resource for the id to use
...
class ValueStreamAnalyticsStages:
    def __init__(
        ...
        *,
        ...
        '''
        :param name: The name of the value stream stage. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.10.0/docs/resources/value_stream_analytics#name ValueStreamAnalytics#name}
        :param custom: Boolean whether the stage is customized. If false, it assigns a built-in default stage by name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.10.0/docs/resources/value_stream_analytics#custom ValueStreamAnalytics#custom}
        ...
        :param end_event_label_id: Label ID associated with the end event identifier. In the format of ``gid://gitlab/GroupLabel/<id>`` or ``gid://gitlab/ProjectLabel/<id>``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.10.0/docs/resources/value_stream_analytics#end_event_label_id ValueStreamAnalytics#end_event_label_id}
        :param hidden: Boolean whether the stage is hidden, GitLab provided default stages are hidden by default. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.10.0/docs/resources/value_stream_analytics#hidden ValueStreamAnalytics#hidden}
        ...
        :param start_event_label_id: Label ID associated with the start event identifier. In the format of ``gid://gitlab/GroupLabel/<id>`` or ``gid://gitlab/ProjectLabel/<id>``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.10.0/docs/resources/value_stream_analytics#start_event_label_id ValueStreamAnalytics#start_event_label_id}
        '''
        if __debug__:
