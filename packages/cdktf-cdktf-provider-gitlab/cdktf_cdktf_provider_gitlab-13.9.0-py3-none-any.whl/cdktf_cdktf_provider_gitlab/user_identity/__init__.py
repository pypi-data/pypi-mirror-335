...
class UserIdentity(
    ...
    def __init__(
        ...
        *,
        ...
        :param external_provider: The external provider name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.10.0/docs/resources/user_identity#external_provider UserIdentity#external_provider}
        :param external_uid: A specific external authentication provider UID. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.10.0/docs/resources/user_identity#external_uid UserIdentity#external_uid}
        :param user_id: The GitLab ID of the user. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.10.0/docs/resources/user_identity#user_id UserIdentity#user_id}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing UserIdentity that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.10.0/docs/resources/user_identity#import import section} in the documentation of this resource for the id to use
