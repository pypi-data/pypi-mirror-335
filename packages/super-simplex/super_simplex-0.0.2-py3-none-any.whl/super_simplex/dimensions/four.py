...
def noise_4d_xzyw(x: float, y: float, z: float, w: float, seed: int) -> float:
    ...
    return _noise_4d_unskewed_base(xr, yr, zr, wr, seed)
...
def noise_4d_x_yz_w(x: float, y: float, z: float, w: float, seed: int) -> float:
    ...
    return _noise_4d_unskewed_base(xs, ys, zs, ws, seed)
...
def _noise_4d_unskewed_base(xs: float, ys: float, zs: float, ws: float, seed: int) -> float:
