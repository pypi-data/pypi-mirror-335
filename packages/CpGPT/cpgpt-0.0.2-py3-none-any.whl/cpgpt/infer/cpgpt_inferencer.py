...
class CpGPTInferencer:
    ...
    def download_model(self, model_name: str = "small", overwrite: bool = False, dependencies_dir: Optional[str] = None) -> bool:
    ...
    def download_dependencies(self, species: str = "human", overwrite: bool = False, dependencies_dir: Optional[str] = None) -> bool:
    ...
    def download_cpgcorpus_dataset(self, gse_id: str, overwrite: bool = False, data_dir: Optional[str] = None) -> bool:
