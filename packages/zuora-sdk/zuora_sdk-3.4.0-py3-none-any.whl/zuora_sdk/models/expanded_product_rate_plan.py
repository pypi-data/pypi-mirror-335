...
class ExpandedProductRatePlan(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["productId", "name", "description", "effectiveStartDate", "effectiveEndDate", "grade", "productRatePlanNumber", "id", "createdById", "createdDate", "updatedById", "updatedDate", "product", "productRatePlanCharges", "externalProductRatePlans"]
