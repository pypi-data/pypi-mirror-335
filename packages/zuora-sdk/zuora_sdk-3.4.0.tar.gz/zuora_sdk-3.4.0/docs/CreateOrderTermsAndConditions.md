...
**invoice_separately** | **bool** | Specifies whether the subscription appears on a separate invoice when generates invoices. | [optional] 
...
**term_increase_to_new_contract_line** | **bool** | Reflect the term increase to a new contract line when term increased or converts from Term to Evergreen | [optional] 
...
create_order_terms_and_conditions_instance = CreateOrderTermsAndConditions.from_json(json)
# print the JSON string representation of the object
print(CreateOrderTermsAndConditions.to_json())

# convert the object into a dict
create_order_terms_and_conditions_dict = create_order_terms_and_conditions_instance.to_dict()
# create an instance of CreateOrderTermsAndConditions from a dict
create_order_terms_and_conditions_from_dict = CreateOrderTermsAndConditions.from_dict(create_order_terms_and_conditions_dict)
```
