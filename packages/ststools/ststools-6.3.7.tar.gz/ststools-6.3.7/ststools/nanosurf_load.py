...
def get_grid_information(specs,media,grid,nx,ny):
    ...
    if grid==None:
        return [stm_image_list,{"Hyper_ida":Hyper_ida,"Hyper_volta":Hyper_volta,'name':'nome_do_arq'}]
    else:
        if nx!=1 and ny!=1:#media:
            ...
            return [stm_image_list,{"Hyper_ida":Hyper_ida,"Hyper_volta":Hyper_volta,'name':'nome do arquvi','mapa_ida':MI_ida,'mapa_volta:':MI_volta}]
        else:
            MI_ida = []
            MI_volta =[]
            ...
            return [stm_image_list,{"Hyper_ida":Hyper_ida,"Hyper_volta":Hyper_volta,'name':'nome_do_arq','mapa_ida':MI_ida,'mapa_volta:':MI_volta}]
