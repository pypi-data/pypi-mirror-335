...
from connector.generated.models.o_auth1_credential import OAuth1Credential
...
class AuthCredential(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "oauth", "oauth_client_credentials", "oauth1", "basic", "token", "jwt"]
