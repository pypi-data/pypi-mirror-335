...
var ImageComponent = function (props) {
    ...
    var _b = __read((0,react__WEBPACK_IMPORTED_MODULE_1__.useState)({ width: 800, height: 600 }), 2), containerSize = _b[0], setContainerSize = _b[1];
    ...
    var _d = __read((0,react__WEBPACK_IMPORTED_MODULE_1__.useState)({ x: 0, y: 0, width: 0, height: 0 }), 2), selectionRect = _d[0], setSelectionRect = _d[1];
    ...
    var handleAnnotationClick = function (index, e) {
        if (props.onClickShape) {
            props.onClickShape(index, makeModKeys(e));
        }
    };
    var handleAnnotationMouseEnter = function (index, e) {
        if (props.onMouseEnterShape) {
            props.onMouseEnterShape(index, makeModKeys(e));
        }
    };
    var handleAnnotationMouseLeave = function (index, e) {
        if (props.onMouseLeaveShape) {
            props.onMouseLeaveShape(index, makeModKeys(e));
        }
    };
    var renderAnnotation = function (annotation, index) {
        var style = __assign({ strokeColor: 'red', strokeWidth: 2, fillColor: 'transparent', opacity: 1.0, shape: 'rect', labelPosition: 'top-left', align: 'center', verticalAlign: 'middle', fontSize: 14 }, ((typeof annotation.style !== 'string'
            ? annotation.style
        ...
        if (style.shape === 'polygon') {
            shapeComponent = ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(react_konva__WEBPACK_IMPORTED_MODULE_2__.Line, { points: annotation.points, closed: true, stroke: style.strokeColor, strokeWidth: style.strokeWidth, fill: style.fillColor, opacity: style.opacity, onClick: function (e) { return handleAnnotationClick(index, e); }, onMouseEnter: function (e) { return handleAnnotationMouseEnter(index, e); }, onMouseLeave: function (e) { return handleAnnotationMouseLeave(index, e); } }));
            ...
            shapeComponent = ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(react_konva__WEBPACK_IMPORTED_MODULE_2__.Rect, { x: annotation.points[0], y: annotation.points[1], width: annotation.points[2], height: annotation.points[3], stroke: style.strokeColor, strokeWidth: style.strokeWidth, fill: style.fillColor, opacity: style.opacity, onClick: function (e) { return handleAnnotationClick(index, e); }, onMouseEnter: function (e) { return handleAnnotationMouseEnter(index, e); }, onMouseLeave: function (e) { return handleAnnotationMouseLeave(index, e); } }));
            bbox = {
        ...
        if (annotation.label) {
            var labelPos = (style.labelPosition || 'top-left').toLowerCase();
            var padding = 5;
            labelComponent = ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(react_konva__WEBPACK_IMPORTED_MODULE_2__.Text, { text: annotation.label, fontSize: 14, x: bbox.x + padding, y: bbox.y + padding, width: bbox.width - 2 * padding, height: bbox.height - 2 * padding, fill: "black", align: style.align, verticalAlign: style.verticalAlign, listening: false }));
        }
    ...
    (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", { tabIndex: 0, onKeyDown: handleKeyPress, style: { width: '100%', height: '100%', overflow: 'hidden', outline: 'none' }, ref: containerRef, children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(react_konva__WEBPACK_IMPORTED_MODULE_2__.Stage, { width: containerSize.width, height: containerSize.height, children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(react_konva__WEBPACK_IMPORTED_MODULE_2__.Layer, { x: offsetX, y: offsetY, scaleX: scale, scaleY: scale, children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_konva__WEBPACK_IMPORTED_MODULE_2__.Group, { ref: groupRef, onMouseDown: handleMouseDown, onMouseMove: handleMouseMove, onMouseUp: handleMouseUp, children: [img && (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(react_konva__WEBPACK_IMPORTED_MODULE_2__.Image, { image: img }), props.annotations.map(function (annotation, index) { return renderAnnotation(annotation, index); }), props.mouseSelection.map(function (shape, index) { return renderSelectionShape(shape, index); }), isSelecting && ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(react_konva__WEBPACK_IMPORTED_MODULE_2__.Rect, { x: selectionRect.x, y: selectionRect.y, width: selectionRect.width, height: selectionRect.height, fill: '#89BCFA99', stroke: '#89BCFA', strokeWidth: 1 }))] }) }) }) }));
};
...
/***/ "./client/components/MultiInputSuggest/index.tsx":
/*!*******************************************************!*\
  !*** ./client/components/MultiInputSuggest/index.tsx ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./style.css */ "./client/components/MultiInputSuggest/style.css");
...
var MultiInputSuggest = /** @class */ (function (_super) {
    ...
    function MultiInputSuggest(props) {
        ...
        _this.removeTag = function (i) {
            var _a, _b;
            var newTags = __spreadArray([], __read(_this.props.inputValue || []), false);
            newTags.splice(i, 1);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (MultiInputSuggest);


/***/ }),

/***/ "./client/components/MultiInputSuggest/style.css":
/*!*******************************************************!*\
  !*** ./client/components/MultiInputSuggest/style.css ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __unused_webpack___webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !../../../node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js */ "./node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js");
/* harmony import */ var _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_style_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../node_modules/css-loader/dist/cjs.js!./style.css */ "./node_modules/css-loader/dist/cjs.js!./client/components/MultiInputSuggest/style.css");
...
/***/ "./client/components/SingleInputSuggest/index.tsx":
/*!********************************************************!*\
  !*** ./client/components/SingleInputSuggest/index.tsx ***!
  \********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var react_autosuggest__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! react-autosuggest */ "webpack/sharing/consume/default/react-autosuggest/react-autosuggest");
/* harmony import */ var react_autosuggest__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(react_autosuggest__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./style.css */ "./client/components/SingleInputSuggest/style.css");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var SingleInputSuggest = /** @class */ (function (_super) {
    ...
    function SingleInputSuggest(props) {
        ...
        _this.inputKeyDown = function (event) {
            ...
            if ((event.key === 'Tab' || event.key === 'Enter')) {
                if (!_this.props.hyperlink || typeof _this.props.inputValue === 'object') {
                    _this.props.onRowChange((_a = {}, _a[_this.props.column] = _this.props.inputValue, _a), _this.props.row_id, true);
                }
            }
    ...
    SingleInputSuggest.prototype.render = function () {
        ...
        return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", { onKeyDown: function (event) { return event.defaultPrevented && event.stopPropagation(); }, children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)((react_autosuggest__WEBPACK_IMPORTED_MODULE_2___default()), { ref: this.onAutoSuggestRef, alwaysRenderSuggestions: true, onSuggestionsFetchRequested: this.onSuggestionsFetchRequested, onSuggestionsClearRequested: this.onSuggestionsClearRequested, suggestions: this.props.suggestions, renderInputComponent: this.renderInput, getSuggestionValue: function (val) { return val; }, renderSuggestion: this.renderSuggestion, inputProps: inputProps }) }));
    };
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (SingleInputSuggest);


/***/ }),

/***/ "./client/components/SingleInputSuggest/style.css":
/*!********************************************************!*\
  !*** ./client/components/SingleInputSuggest/style.css ***!
  \********************************************************/
/***/ ((__unused_webpack_module, __unused_webpack___webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !../../../node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js */ "./node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js");
/* harmony import */ var _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_style_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../node_modules/css-loader/dist/cjs.js!./style.css */ "./node_modules/css-loader/dist/cjs.js!./client/components/SingleInputSuggest/style.css");
...
/* harmony import */ var _MultiInputSuggest__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../MultiInputSuggest */ "./client/components/MultiInputSuggest/index.tsx");
/* harmony import */ var _SingleInputSuggest__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../SingleInputSuggest */ "./client/components/SingleInputSuggest/index.tsx");
/* harmony import */ var _BooleanInput__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../BooleanInput */ "./client/components/BooleanInput/index.tsx");
var __assign = (undefined && undefined.__assign) || function () {
    __assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
            s = arguments[i];
...
var TableComponent = react__WEBPACK_IMPORTED_MODULE_1___default().memo(function TableComponent(props) {
    ...
    var _c = __read((0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(undefined), 2), inputValue = _c[0], setInputValue = _c[1];
    ...
    // --- New: Subset support ---
    // Use localSubset if props.subset is undefined.
    var _f = __read((0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(props.subset), 2), localSubset = _f[0], setLocalSubset = _f[1];
    ...
    var getAbsoluteRowIdx = function (relativeIdx) {
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(function () {
        if (props.actions) {
            props.actions.scroll_to_row = function (absRowIdx) {
                var _a;
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(function () {
        ...
        if (props.autoFilter && effectiveFilters && (props.subset === undefined || props.onSubsetChange)) {
            console.log("Re-running filtering");
            ...
            var newSubset = props.rows
                ...
                return Object.entries(lowercaseFilters_1).every(function (_a) {
                    var _b = __read(_a, 2), key = _b[0], value = _b[1];
                    return row[key] !== undefined && row[key].toString().toLowerCase().includes(value);
                });
            })
                .map(function (_a) {
                var idx = _a.idx;
            ...
            setLocalSubset(newSubset);
            (_a = props.onSubsetChange) === null || _a === void 0 ? void 0 : _a.call(props, newSubset);
        }
        else {
            setLocalSubset(undefined);
        }
    }, [effectiveFilters, props.rows, props.autoFilter, props.filters]);
    var handleMouseEnterRow = (0,_utils__WEBPACK_IMPORTED_MODULE_6__.useEventCallback)(function (event, relativeRowIdx) {
        var _a;
        (_a = props.onMouseEnterRow) === null || _a === void 0 ? void 0 : _a.call(props, getAbsoluteRowIdx(relativeRowIdx), (0,_utils__WEBPACK_IMPORTED_MODULE_6__.makeModKeys)(event));
    });
    var handleMouseLeaveRow = (0,_utils__WEBPACK_IMPORTED_MODULE_6__.useEventCallback)(function (event, relativeRowIdx) {
        var _a;
        (_a = props.onMouseLeaveRow) === null || _a === void 0 ? void 0 : _a.call(props, getAbsoluteRowIdx(relativeRowIdx), (0,_utils__WEBPACK_IMPORTED_MODULE_6__.makeModKeys)(event));
    });
        ...
        switch (type) {
                ...
                return {
                    editor: readonly
                        ...
                        : (0,react__WEBPACK_IMPORTED_MODULE_1__.forwardRef)(function (_a, ref) {
                            ...
                            return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_SingleInputSuggest__WEBPACK_IMPORTED_MODULE_9__["default"], { ref: ref, 
                                // EditorProps provide rowIdx.
                                row_id: getAbsoluteRowIdx(rowIdx), inputRef: inputRef, value: row[column.key], column: column.key, inputValue: props.inputValue === undefined ? inputValue : props.inputValue, onInputChange: makeInputChangeHandler(rowIdx, column), suggestions: props.suggestions === undefined ? props.columns[column.idx].choices : props.suggestions, onRowChange: onRowChange, onClose: onClose, hyperlink: true }));
                        }),
                    ...
                    formatter: function (_a) {
                        ...
                        return value ? (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("a", { onClick: function () { var _a; return (_a = props.onClickCellContent) === null || _a === void 0 ? void 0 : _a.call(props, rowIdx, column.key, href); }, children: text }) : null;
                    },
                };
                ...
                return {
                    editor: readonly
                        ...
                        : (0,react__WEBPACK_IMPORTED_MODULE_1__.forwardRef)(function (_a, ref) {
                            ...
                            return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_MultiInputSuggest__WEBPACK_IMPORTED_MODULE_8__["default"], { ref: ref, row_id: getAbsoluteRowIdx(rowIdx), inputRef: inputRef, value: row[column.key], inputValue: props.inputValue === undefined ? inputValue : props.inputValue, column: column.key, suggestions: props.suggestions === undefined ? props.columns[column.idx].choices : props.suggestions, onRowChange: onRowChange, onInputChange: makeInputChangeHandler(rowIdx, column), onClose: onClose, hyperlink: true }));
                        }),
                    headerCellClass: filterable ? "metanno-table-header-filter" : undefined,
                    headerRenderer: function (p) { return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_DraggableHeaderRenderer__WEBPACK_IMPORTED_MODULE_7__["default"], __assign({}, p, { onColumnsReorder: onHeaderDrop, children: makeFilterInput(p.column) }))); },
                    formatter: function (_a) {
                        var row = _a.row, rowIdx = _a.rowIdx, column = _a.column;
                        return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_MultiInputSuggest__WEBPACK_IMPORTED_MODULE_8__.InputTag, { autocontain: true, readOnly: true, hyperlink: true, onClick: function (value) { var _a; return (_a = props.onClickCellContent) === null || _a === void 0 ? void 0 : _a.call(props, rowIdx, column.key, value); }, value: row[column.key] }));
                    },
                };
            case "text":
                return {
                    editor: readonly
                        ...
                        : (0,react__WEBPACK_IMPORTED_MODULE_1__.forwardRef)(function (_a, ref) {
                            ...
                            return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_SingleInputSuggest__WEBPACK_IMPORTED_MODULE_9__["default"], { ref: ref, row_id: getAbsoluteRowIdx(rowIdx), inputRef: inputRef, value: row[column.key], column: column.key, inputValue: props.inputValue === undefined ? inputValue : props.inputValue, onInputChange: makeInputChangeHandler(rowIdx, column), suggestions: props.suggestions === undefined ? props.columns[column.idx].choices : props.suggestions, onRowChange: onRowChange, onClose: onClose }));
                        }),
                    headerCellClass: filterable ? "metanno-table-header-filter" : undefined,
                    headerRenderer: function (p) { return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_DraggableHeaderRenderer__WEBPACK_IMPORTED_MODULE_7__["default"], __assign({}, p, { onColumnsReorder: onHeaderDrop, children: makeFilterInput(p.column) }))); },
                    formatter: function (_a) {
            ...
            case "multi-text":
                return {
                    ...
                    headerCellClass: filterable ? "metanno-table-header-filter" : undefined,
                    headerRenderer: function (p) { return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_DraggableHeaderRenderer__WEBPACK_IMPORTED_MODULE_7__["default"], __assign({}, p, { onColumnsReorder: onHeaderDrop, children: makeFilterInput(p.column) }))); },
                    formatter: function (propsInner) { return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_MultiInputSuggest__WEBPACK_IMPORTED_MODULE_8__.InputTag, __assign({ autocontain: true, readOnly: true }, propsInner, { value: propsInner.row[propsInner.column.key] }))); },
                };
            case "boolean":
                return {
                    formatter: function (_a) {
                        var row = _a.row, rowIdx = _a.rowIdx, column = _a.column, onRowChange = _a.onRowChange, isCellSelected = _a.isCellSelected;
                        return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_BooleanInput__WEBPACK_IMPORTED_MODULE_10__["default"], { isCellSelected: isCellSelected, value: row[column.key], onChange: function (value) {
                                var _a;
    ...
    }, [props.columns, columnsOrder, props.filters, inputValue, props.inputValue, props.suggestions]);
    ...
    var renderRowBase = (0,react__WEBPACK_IMPORTED_MODULE_1__.useCallback)(function renderRow(p) {
        var _a;
        return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(react_data_grid__WEBPACK_IMPORTED_MODULE_4__.Row, __assign({}, p, { onMouseEnter: function (event) { var _a; return (_a = props.onMouseEnterRow) === null || _a === void 0 ? void 0 : _a.call(props, getAbsoluteRowIdx(p.rowIdx), (0,_utils__WEBPACK_IMPORTED_MODULE_6__.makeModKeys)(event)); }, onMouseLeave: function (event) { var _a; return (_a = props.onMouseLeaveRow) === null || _a === void 0 ? void 0 : _a.call(props, getAbsoluteRowIdx(p.rowIdx), (0,_utils__WEBPACK_IMPORTED_MODULE_6__.makeModKeys)(event)); }, className: ((_a = props.highlightedRows) === null || _a === void 0 ? void 0 : _a.includes(p.row[props.rowKey])) ? "metanno-row--highlighted" : "" })));
    }, [props.highlightedRows, props.rowKey]);
    var renderRow = (0,react__WEBPACK_IMPORTED_MODULE_1__.useMemo)(function () { return react__WEBPACK_IMPORTED_MODULE_1___default().memo(renderRowBase); }, [renderRowBase]);
    ...
    var getPositionIndices = (0,_utils__WEBPACK_IMPORTED_MODULE_6__.cachedReconcile)(function (positionParam) {
        if (!positionParam)
            return undefined;
    ...
    var tableHeight = Math.min(headerRowHeight + ROW_HEIGHT * Math.max(props.rows.length, 1), 300);
    return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", { className: "metanno-table", style: { "--min-height": "".concat(tableHeight, "px") }, onBlur: onBlur, children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(react_dnd__WEBPACK_IMPORTED_MODULE_2__.DndProvider, { backend: react_dnd_html5_backend__WEBPACK_IMPORTED_MODULE_3__.HTML5Backend, children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)((react_data_grid__WEBPACK_IMPORTED_MODULE_4___default()), { ref: gridRef, rowKeyGetter: rowKeyGetter, rowHeight: ROW_HEIGHT, selectedPosition: getPositionIndices(props.position !== undefined ? props.position : position), columns: builtColumns, rows: visibleRows, rowRenderer: renderRow, headerRowHeight: headerRowHeight, onRowsChange: onRowsChange, onSelectedPositionChange: handlePositionChange, onScroll: handleScrollBottom }) }) }));
});
...
var processStyle = function (_a) {
    ...
    if (shape === 'underline')
        textColor = '#000000de';
    return {
        base: __assign({ 'borderColor': color, 'backgroundColor': shape === 'underline' ? 'transparent' : backgroundColor, 'color': textColor }, rest),
...
var TextComponent = /** @class */ (function (_super) {
    ...
    function TextComponent(props) {
        ...
        _this.handleKeyUp = function (event) {
            ...
            (_b = (_a = _this.props).onKeyPress) === null || _b === void 0 ? void 0 : _b.call(_a, key, (0,_utils__WEBPACK_IMPORTED_MODULE_4__.makeModKeys)(event), __spreadArray(__spreadArray([], __read(_this.props.mouseSelection), false), __read(spans), false));
        };
        ...
        _this.handleMouseUp = function (event) {
            ...
            if (event.type === "mouseup") {
                ...
                if (spans.length > 0) {
                    ...
                    (_b = (_a = _this.props).onMouseSelect) === null || _b === void 0 ? void 0 : _b.call(_a, (0,_utils__WEBPACK_IMPORTED_MODULE_4__.makeModKeys)(event), spans);
                }
                else {
        ...
        if (props.actions) {
            ...
            props.actions.set("scroll_to_line", function (line) {
                var _a;
                if (line >= 0 && line < _this.linesRef.length && _this.linesRef[line]) {
                    (_a = _this.linesRef[line].current) === null || _a === void 0 ? void 0 : _a.scrollIntoView({ behavior: 'smooth', block: 'center' });
                }
            });
            props.actions.set("scroll_to_span", function (span_id) {
                setTimeout(function () {
                    var _a;
                    if (_this.spansRef[span_id]) {
                        (_a = _this.spansRef[span_id].current) === null || _a === void 0 ? void 0 : _a.scrollIntoView({ behavior: 'smooth', block: 'center' });
                    }
                }, 10);
            });
            props.actions.set("clear_current_mouse_selection", function () {
                window.getSelection().removeAllRanges();
            });
        }
        _this.linesRef = [];
        ...
        _this.processStyles = (0,_utils__WEBPACK_IMPORTED_MODULE_4__.memoize)(function (styles) { return Object.assign.apply(Object, __spreadArray([{}], __read(Object.keys(styles).map(function (key) {
            var _a;
            return (__assign(__assign({}, styles[key]), (_a = {}, _a[key] = processStyle(styles[key]), _a)));
        })), false)); });
        return _this;
    }
    TextComponent.prototype.render = function () {
        ...
        // Return jsx elements
        return ((0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", { className: "metanno-text-view", ref: this.containerRef, onMouseUp: this.handleMouseUp, onKeyDown: this.handleKeyDown, onKeyUp: this.handleKeyUp, tabIndex: 0, children: (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", { className: "text", children: lines.map(function (tokens, lineIndex) {
...
/***/ "./node_modules/css-loader/dist/cjs.js!./client/components/MultiInputSuggest/style.css":
/*!*********************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./client/components/MultiInputSuggest/style.css ***!
  \*********************************************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/css-loader/dist/cjs.js!./client/components/SingleInputSuggest/style.css":
/*!**********************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./client/components/SingleInputSuggest/style.css ***!
  \**********************************************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_cssWithMappingToString_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".rdg-cell .rdg-editor-container > div > .react-autosuggest__container {\n    padding-left: 8px;\n    padding-right: 8px;\n    background: transparent;\n    /*border-bottom: 1px solid #dddddd;*/\n    margin-right: 0px;\n    /*border-right: 1px solid #dddddd;*/\n    box-sizing: border-box;\n}\n\n.rdg-cell .react-autosuggest__input {\n    font-family: inherit;\n    border: none;\n    padding-left: 0;\n    font-size: 14px;\n    width: 100%;\n    height: 100%;\n    color: var(--color);\n    background: transparent;\n}\n\n.rdg-cell .react-autosuggest__input::-ms-clear {\n    display: none;\n}\n\n.rdg-cell .react-autosuggest__input--open {\n    border-bottom-left-radius: 0;\n    border-bottom-right-radius: 0;\n}\n\n.rdg-cell .react-autosuggest__input--focused {\n    outline: none;\n}\n\n.rdg-cell .react-autosuggest__suggestions-container {\n    display: none;\n}\n\n.rdg-cell .rdg-editor-container > div {\n    /*background: white;*/\n}\n\n.rdg-editor-container > div, .rdg-cell-value, .rdg-cell-value > div {\n    height: 100%;\n    width: 100%;\n}\n\n.rdg-editor-container > div > .react-autosuggest__container--open > .react-autosuggest__suggestions-container {\n    left: -1px;\n    right: 0px;\n}\n\n.rdg-cell .react-autosuggest__suggestions-container--open {\n    display: block;\n    position: absolute;\n    top: 100%;\n    min-width: 100%;\n    box-sizing: border-box;\n    border: 1px solid #aaa;\n    background-color: #fff;\n    font-family: 'Open Sans', sans-serif;\n    font-weight: 300;\n    font-size: 14px;\n    border-bottom-left-radius: 4PX;\n    border-bottom-right-radius: 4PX;\n    z-index: 2;\n    max-height: 200px;\n    overflow-y: auto;\n\n    overflow-y: scroll;\n    scrollbar-width: none; /* Firefox */\n    -ms-overflow-style: none; /* Internet Explorer 10+ */\n}\n\n.rdg-cell .react-autosuggest__suggestions-container--open::-webkit-scrollbar {\n    width: 0;\n    height: 0;\n}\n\n.rdg-cell .react-autosuggest__suggestions-list {\n    margin: 0;\n    padding: 0;\n    list-style-type: none;\n}\n\n.rdg-cell .react-autosuggest__suggestion {\n    cursor: pointer;\n    padding: 5px 5px;\n}\n\n.rdg-cell .react-autosuggest__suggestion--highlighted {\n    background-color: #ddd;\n}\n\n.rdg-cell .react-autosuggest__section-container {\n    border-top: 1px dashed #ccc;\n}\n\n.rdg-cell .react-autosuggest__section-container-first {\n    border-top: 0;\n}\n\n.rdg-cell .react-autosuggest__section-title {\n    padding: 10px 0 0 10px;\n    font-size: 12px;\n    color: #777;\n}\n", "",{"version":3,"sources":["webpack://./client/components/SingleInputSuggest/style.css"],"names":[],"mappings":"AAAA;IACI,iBAAiB;IACjB,kBAAkB;IAClB,uBAAuB;IACvB,oCAAoC;IACpC,iBAAiB;IACjB,mCAAmC;IACnC,sBAAsB;AAC1B;;AAEA;IACI,oBAAoB;IACpB,YAAY;IACZ,eAAe;IACf,eAAe;IACf,WAAW;IACX,YAAY;IACZ,mBAAmB;IACnB,uBAAuB;AAC3B;;AAEA;IACI,aAAa;AACjB;;AAEA;IACI,4BAA4B;IAC5B,6BAA6B;AACjC;;AAEA;IACI,aAAa;AACjB;;AAEA;IACI,aAAa;AACjB;;AAEA;IACI,qBAAqB;AACzB;;AAEA;IACI,YAAY;IACZ,WAAW;AACf;;AAEA;IACI,UAAU;IACV,UAAU;AACd;;AAEA;IACI,cAAc;IACd,kBAAkB;IAClB,SAAS;IACT,eAAe;IACf,sBAAsB;IACtB,sBAAsB;IACtB,sBAAsB;IACtB,oCAAoC;IACpC,gBAAgB;IAChB,eAAe;IACf,8BAA8B;IAC9B,+BAA+B;IAC/B,UAAU;IACV,iBAAiB;IACjB,gBAAgB;;IAEhB,kBAAkB;IAClB,qBAAqB,EAAE,YAAY;IACnC,wBAAwB,EAAE,0BAA0B;AACxD;;AAEA;IACI,QAAQ;IACR,SAAS;AACb;;AAEA;IACI,SAAS;IACT,UAAU;IACV,qBAAqB;AACzB;;AAEA;IACI,eAAe;IACf,gBAAgB;AACpB;;AAEA;IACI,sBAAsB;AAC1B;;AAEA;IACI,2BAA2B;AAC/B;;AAEA;IACI,aAAa;AACjB;;AAEA;IACI,sBAAsB;IACtB,eAAe;IACf,WAAW;AACf","sourcesContent":[".rdg-cell .rdg-editor-container > div > .react-autosuggest__container {\n    padding-left: 8px;\n    padding-right: 8px;\n    background: transparent;\n    /*border-bottom: 1px solid #dddddd;*/\n    margin-right: 0px;\n    /*border-right: 1px solid #dddddd;*/\n    box-sizing: border-box;\n}\n\n.rdg-cell .react-autosuggest__input {\n    font-family: inherit;\n    border: none;\n    padding-left: 0;\n    font-size: 14px;\n    width: 100%;\n    height: 100%;\n    color: var(--color);\n    background: transparent;\n}\n\n.rdg-cell .react-autosuggest__input::-ms-clear {\n    display: none;\n}\n\n.rdg-cell .react-autosuggest__input--open {\n    border-bottom-left-radius: 0;\n    border-bottom-right-radius: 0;\n}\n\n.rdg-cell .react-autosuggest__input--focused {\n    outline: none;\n}\n\n.rdg-cell .react-autosuggest__suggestions-container {\n    display: none;\n}\n\n.rdg-cell .rdg-editor-container > div {\n    /*background: white;*/\n}\n\n.rdg-editor-container > div, .rdg-cell-value, .rdg-cell-value > div {\n    height: 100%;\n    width: 100%;\n}\n\n.rdg-editor-container > div > .react-autosuggest__container--open > .react-autosuggest__suggestions-container {\n    left: -1px;\n    right: 0px;\n}\n\n.rdg-cell .react-autosuggest__suggestions-container--open {\n    display: block;\n    position: absolute;\n    top: 100%;\n    min-width: 100%;\n    box-sizing: border-box;\n    border: 1px solid #aaa;\n    background-color: #fff;\n    font-family: 'Open Sans', sans-serif;\n    font-weight: 300;\n    font-size: 14px;\n    border-bottom-left-radius: 4PX;\n    border-bottom-right-radius: 4PX;\n    z-index: 2;\n    max-height: 200px;\n    overflow-y: auto;\n\n    overflow-y: scroll;\n    scrollbar-width: none; /* Firefox */\n    -ms-overflow-style: none; /* Internet Explorer 10+ */\n}\n\n.rdg-cell .react-autosuggest__suggestions-container--open::-webkit-scrollbar {\n    width: 0;\n    height: 0;\n}\n\n.rdg-cell .react-autosuggest__suggestions-list {\n    margin: 0;\n    padding: 0;\n    list-style-type: none;\n}\n\n.rdg-cell .react-autosuggest__suggestion {\n    cursor: pointer;\n    padding: 5px 5px;\n}\n\n.rdg-cell .react-autosuggest__suggestion--highlighted {\n    background-color: #ddd;\n}\n\n.rdg-cell .react-autosuggest__section-container {\n    border-top: 1px dashed #ccc;\n}\n\n.rdg-cell .react-autosuggest__section-container-first {\n    border-top: 0;\n}\n\n.rdg-cell .react-autosuggest__section-title {\n    padding: 10px 0 0 10px;\n    font-size: 12px;\n    color: #777;\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
//# sourceMappingURL=client_style_css-client_dist-globals_ts.2adc92ca00193d926dde.js.map