...
class Diffuser(Diffusion, schedule=DiffusionSchedule):
    ...
    def distribute_timesteps(
        ...
        Args:
            ...
            timesteps_distribution (distributions.Context): The context that generates timesteps
                from this given distribution.
            shape (Sequence): The shape that is needed to be sampled.
            device (device): The device of the timesteps.
        
        Returns:
            Tensor: The randomly sampled timesteps from the given distribution.
        
        """
        dtype = diffusion_schedule.timesteps_dtype
    ...
    def construct_optimization(
        ...
        **diffusion_kwargs
        ...
        """Constructs the optimization source and target.
        ...
        Returns:
            Tensor: The optimization source and target.
    ...
    def make_step(
        ...
        **diffusion_kwargs
        ...
        """
        timestep = cls.distribute_timesteps(diffusion_schedule, timesteps_distribution, input_start.shape[:1], input_start.device)
    ...
    def make_loss(
        ...
        input_middle: Tensor,
        timestep: Tensor,
        optimization_pair: Tuple[Tensor, Tensor],
        ...
        **diffusion_kwargs
        ...
        Args:
            ...
            timestep (Tensor): The diffusion timestep that is used to extract the optimization target.
            optimization_pair (Tuple[Tensor, Tensor]): The optimization pair that is used to feed to
                the loss function.
        ...
        """
        loss = loss_function(*optimization_pair)
    ...
    def calculate_loss(
        ...
        **kwargs
        ...
        optimization_source, optimization_target = cls.construct_optimization(
            diffusion_schedule,
            prediction,
            input_start,
            x_t,
        ...
        return cls.make_loss(
            ...
            x_t,
            timestep,
            (optimization_source, optimization_target),
            weighting,
            *diffusion_args,
            timesteps_distribution=timesteps_distribution,
            parameterization=parameterization,
