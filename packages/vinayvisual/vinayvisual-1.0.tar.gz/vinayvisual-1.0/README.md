This is build to solve visual based problem that are not available in opencv , scipy  and numpy as it provide background support of theories and calculation to solve problem like -
