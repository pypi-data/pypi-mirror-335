r'''
# CDKTF prebuilt bindings for hashicorp/azuread provider version 3.2.0

This repo builds and publishes the [Terraform azuread provider](https://registry.terraform.io/providers/hashicorp/azuread/3.2.0/docs) bindings for [CDK for Terraform](https://cdk.tf).
...
* [Terraform azuread provider](https://registry.terraform.io/providers/hashicorp/azuread/3.2.0)
