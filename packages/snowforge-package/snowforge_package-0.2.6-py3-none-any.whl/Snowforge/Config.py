...
class Config:
    ...
    @staticmethod
    def find_config_file(verbose: bool = False):
        """Finds the first available config file."""
    ...
    def load_config(verbose: bool = False):
        ...
        config_path = Config.find_config_file(verbose)
    ...
    @staticmethod
    def get_snowflake_credentials(profile: str = "default", verbose: bool = False)->dict:
    ...
    @staticmethod
    def get_aws_credentials(profile: str = "default", verbose: bool = False)->dict:
