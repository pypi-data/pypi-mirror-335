...
cdef extern from "ggwave.h" nogil:
    ...
    bool ggwave_isDSSEnabled(ggwave_Instance instance)
    float ggwave_hzPerSample(ggwave_Instance instance)
    int ggwave_heapSize(ggwave_Instance instance)
    int ggwave_txTonesSize(ggwave_Instance instance)
    char ggwave_txGetTone(ggwave_Instance instance, int index)
    bool ggwave_txHasData(ggwave_Instance instance)
    unsigned char ggwave_getDSSMagic(int i)
    void ggwave_rdft(void * f, int N, void * wi, void * wf)
    void ggwave_FFT(const void * src, void * dst, int N, void * wi, void * wf)
    int ggwave_getECCBytesForLength(int length)
