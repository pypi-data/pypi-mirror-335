...
#define GGWAVE_MAX_INSTANCES 4
    ...
    GGWAVE_API int ggwave_protocolCount();
    GGWAVE_API bool ggwave_isDSSEnabled(ggwave_Instance id);
    GGWAVE_API float ggwave_hzPerSample(ggwave_Instance id);
    GGWAVE_API int ggwave_heapSize(ggwave_Instance id);
    GGWAVE_API int ggwave_txTonesSize(ggwave_Instance id);
    GGWAVE_API char ggwave_txGetTone(ggwave_Instance id, int index);
    GGWAVE_API bool ggwave_txHasData(ggwave_Instance id);
    GGWAVE_API unsigned char ggwave_getDSSMagic(int i);
    GGWAVE_API void ggwave_rdft(float * f, int N, int * wi, float * wf);
    GGWAVE_API void ggwave_FFT(const float * src, float * dst, int N, int * wi, float * wf);
    GGWAVE_API int ggwave_getECCBytesForLength(int len);
