...
def JSEasyTable(json_data: dict, table_name: str):
    try:
...
def JSEasyKey(json_data: dict, table, key_or_bulk: str, values: str = None, is_multi: bool = False):
    try:
