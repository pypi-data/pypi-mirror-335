...
def main():
    ...
    helper = argparse.ArgumentParser(prog="batch_solve", description="Solve the Minimum Dominating Set for all undirected graphs encoded in DIMACS format and stored in a directory.")
