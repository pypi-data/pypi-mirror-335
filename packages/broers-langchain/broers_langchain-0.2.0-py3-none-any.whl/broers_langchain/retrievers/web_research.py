...
from broers_langchain.document_loaders import AsyncHtmlLoader
...
class WebResearchRetriever(BaseRetriever):
    ...
    proxies: dict = Field({}, description="proxies")
    ...
    def _get_relevant_documents(
        ...
        if new_urls:
            try:
                loader = AsyncHtmlLoader(web_path=new_urls, proxies=self.proxies)
                ...
                errorMsg = str(err)
                logger.info(f"Get URL Content error: {new_urls} {errorMsg}")
