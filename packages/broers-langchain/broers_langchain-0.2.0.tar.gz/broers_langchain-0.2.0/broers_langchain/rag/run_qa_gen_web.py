...
import tempfile
import gradio as gr
from broers_langchain.rag.qa_corpus.qa_generator import RagQAGenerator
...
with tempfile.TemporaryDirectory(dir=tmpdir) as tmpdir:
    with gr.Blocks(
            css='#margin-top {margin-top: 15px} #center {text-align: center;} #description {text-align: center}') as demo:
        with gr.Row(elem_id='center'):
            gr.Markdown('# Broers qa auto generation Demo')
