...
from broers_langchain.rag.init_retrievers import (BaselineVectorRetriever, KeywordRetriever,
        ...
        if keyword_store:
            ...
            if self.params['elasticsearch'].get('extract_key_by_llm', False):
                extract_key_prompt = import_class(
                    'broers_langchain.rag.prompts.EXTRACT_KEY_PROMPT')
...
if __name__ == '__main__':
    ...
    tool = BroersRAGTool.get_rag_tool(name='rag_knowledge_retrieve',
