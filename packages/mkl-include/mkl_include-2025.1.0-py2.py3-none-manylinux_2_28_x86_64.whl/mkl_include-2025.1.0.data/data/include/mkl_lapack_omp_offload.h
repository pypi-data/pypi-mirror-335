...
#pragma omp MKL_LAPACK_DECLARE_VARIANT_51(cgels,a,b,work,info)
void cgels(const char *trans, const MKL_INT *m, const MKL_INT *n, const MKL_INT *nrhs, MKL_Complex8 *a, const MKL_INT *lda, MKL_Complex8 *b, const MKL_INT *ldb, MKL_Complex8 *work, const MKL_INT *lwork, MKL_INT *info) NOTHROW;

#pragma omp MKL_LAPACK_DECLARE_VARIANT_51(dgels,a,b,work,info)
void dgels(const char *trans, const MKL_INT *m, const MKL_INT *n, const MKL_INT *nrhs, double *a, const MKL_INT *lda, double *b, const MKL_INT *ldb, double *work, const MKL_INT *lwork, MKL_INT *info) NOTHROW;

#pragma omp MKL_LAPACK_DECLARE_VARIANT_51(sgels,a,b,work,info)
void sgels(const char *trans, const MKL_INT *m, const MKL_INT *n, const MKL_INT *nrhs, float *a, const MKL_INT *lda, float *b, const MKL_INT *ldb, float *work, const MKL_INT *lwork, MKL_INT *info) NOTHROW;

#pragma omp MKL_LAPACK_DECLARE_VARIANT_51(zgels,a,b,work,info)
void zgels(const char *trans, const MKL_INT *m, const MKL_INT *n, const MKL_INT *nrhs, MKL_Complex16 *a, const MKL_INT *lda, MKL_Complex16 *b, const MKL_INT *ldb, MKL_Complex16 *work, const MKL_INT *lwork, MKL_INT *info) NOTHROW;
