...
name = "types-rfc3339-validator"
description = "Typing stubs for rfc3339-validator"
long_description = '''
## Typing stubs for rfc3339-validator
...
setup(name=name,
      ...
      project_urls={
          ...
          "Changes": "https://github.com/typeshed-internal/stub_uploader/blob/main/data/changelogs/rfc3339-validator.md",
          "Issue tracker": "https://github.com/python/typeshed/issues",
          "Chat": "https://gitter.im/python/typing",
      },
      install_requires=[],
      packages=['rfc3339_validator-stubs'],
      package_data={'rfc3339_validator-stubs': ['__init__.pyi', 'METADATA.toml', 'py.typed']},
      license="Apache-2.0",
      python_requires=">=3.9",
      classifiers=[
