...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'scann.proto.hash_pb2', globals())
if _descriptor._USE_C_DESCRIPTORS == False:

  DESCRIPTOR._options = None
  _ASYMMETRICHASHERCONFIG.fields_by_name['min_number_machines']._options = None
  _ASYMMETRICHASHERCONFIG.fields_by_name['min_number_machines']._serialized_options = b'\030\001'
  _ASYMMETRICHASHERCONFIG.fields_by_name['use_noise_shaped_training']._options = None
  _ASYMMETRICHASHERCONFIG.fields_by_name['use_noise_shaped_training']._serialized_options = b'\030\001'
  _ASYMMETRICHASHERCONFIG.fields_by_name['partition_level_confidence_interval_stdevs']._options = None
  _ASYMMETRICHASHERCONFIG.fields_by_name['partition_level_confidence_interval_stdevs']._serialized_options = b'\030\001'
  _ASYMMETRICHASHERCONFIG.fields_by_name['min_cluster_size']._options = None
  _ASYMMETRICHASHERCONFIG.fields_by_name['min_cluster_size']._serialized_options = b'\030\001'
  _ASYMMETRICHASHERCONFIG.fields_by_name['use_single_machine_trainer']._options = None
  _ASYMMETRICHASHERCONFIG.fields_by_name['use_single_machine_trainer']._serialized_options = b'\030\001'
  _ASYMMETRICHASHERCONFIG.fields_by_name['use_normalized_residual_quantization']._options = None
  _ASYMMETRICHASHERCONFIG.fields_by_name['use_normalized_residual_quantization']._serialized_options = b'\030\001'
  _HASHCONFIG._serialized_start=109
  _HASHCONFIG._serialized_end=658
  _HASHCONFIG_THRESHOLDTYPE._serialized_start=582
  _HASHCONFIG_THRESHOLDTYPE._serialized_end=658
  _ASYMMETRICHASHERCONFIG._serialized_start=661
  _ASYMMETRICHASHERCONFIG._serialized_end=2522
  _ASYMMETRICHASHERCONFIG_FIXEDPOINTLUTCONVERSIONOPTIONS._serialized_start=2066
  _ASYMMETRICHASHERCONFIG_FIXEDPOINTLUTCONVERSIONOPTIONS._serialized_end=2334
  _ASYMMETRICHASHERCONFIG_FIXEDPOINTLUTCONVERSIONOPTIONS_FLOATTOINTCONVERSIONMETHOD._serialized_start=2281
  _ASYMMETRICHASHERCONFIG_FIXEDPOINTLUTCONVERSIONOPTIONS_FLOATTOINTCONVERSIONMETHOD._serialized_end=2334
  _ASYMMETRICHASHERCONFIG_LOOKUPTYPE._serialized_start=2336
  _ASYMMETRICHASHERCONFIG_LOOKUPTYPE._serialized_end=2396
  _ASYMMETRICHASHERCONFIG_QUANTIZATIONSCHEME._serialized_start=2398
  _ASYMMETRICHASHERCONFIG_QUANTIZATIONSCHEME._serialized_end=2488
  _MINHASHERCONFIG._serialized_start=2524
  _MINHASHERCONFIG._serialized_end=2644
  _BITSAMPLINGHASHERCONFIG._serialized_start=2646
  _BITSAMPLINGHASHERCONFIG._serialized_end=2743
  _PCAHASHERCONFIG._serialized_start=2746
  _PCAHASHERCONFIG._serialized_end=2980
  _BNCHASHERCONFIG._serialized_start=2983
  _BNCHASHERCONFIG._serialized_end=3220
  _STACKEDQUANTIZERSCONFIG._serialized_start=3223
  _STACKEDQUANTIZERSCONFIG._serialized_end=3358
