from detect_image import detect_image_objectives
from detect_video import detect_video_objectives
...
def get_purpose_image(gs_path: str):
    ...
    result = detect_image_objectives(img_bytes)
...
def get_purpose_video(gs_path: str):
    ...
    result = detect_video_objectives(video_uri=gs_path)
    purpose = result['purpose'].value if hasattr(result['purpose'], 'value') else result['purpose']
    return purpose
