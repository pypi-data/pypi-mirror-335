...
class LinearSolver(ngsolve.la.BaseMatrix):
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('pre', 'callback', 'iterations', 'mat', 'residuals', 'plt', 'plotrates', 'tol', 'atol', 'callback_sol', '_final_residual', 'ax', 'fig', 'printrates', 'ress', 'maxiter', 'display', 'clear_output', 'its', 'sol')
