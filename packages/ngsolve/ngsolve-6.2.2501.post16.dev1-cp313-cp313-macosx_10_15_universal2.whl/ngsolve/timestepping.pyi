...
class CrankNicolson:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('time', '_lin_solver_args', 'bfmstar', 'dt', 'gfu_old', '_lin_solver_cls', 'c')
...
class Newmark:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('gfa_old', 'time', '_lin_solver_args', 'gfu_old', 'dt', 'bfmstar', '_lin_solver_cls', 'c', 'gfv_old')
