...
from Cascade.cascade2p.utils import plot_dFF_traces
...
def load_neurons_x_time(file_path):
    ...
    traces = sio.loadmat(file_path)['dff_sig']
...
def load_predictions(file_path):
    ...
    spike_prob = sio.loadmat(file_path)['spk_sig']
...
example_file = r'D:\SynologyDrive\LAB-share\Member-HuJiaHao\fluorescence_corsstalk_correction\HJH_crosstalk_correction\green\1\result.mat'
example_file_predictions = r'D:\SynologyDrive\LAB-share\Member-HuJiaHao\fluorescence_corsstalk_correction\HJH_crosstalk_correction\green\1\result.mat'
model_name = '100Hz_15ms_causalkrnel'
frame_rate = 100
...
"""
model_folder = r'D:\SynologyDrive\LAB-share\Member-HuJiaHao\New_processes\Cascade\Pretrained_models'
discrete_approximation, spike_time_estimates = infer_discrete_spikes(spike_prob,model_name,model_folder=model_folder)
