...
class NIPWindow(QMainWindow, Ui_MainWindow):
    ...
    def load_tiff(self):
        ...
        root.withdraw()
        # get path
        self.load_path = np.str(QFileDialog.getOpenFileName(self, "选择文件", ".tif", "tif file(*.tif)")[0])
    ...
    def load_enhanced(self):
        ...
        root.withdraw()
        # get path
        enhanced_path = np.str(QFileDialog.getOpenFileName(self, "选择文件", ".tif", "tif file(*.tif)")[0])
    ...
    def load_masks(self):
        ...
        root.withdraw()
        # get path
        masks_path = np.str(QFileDialog.getOpenFileName(self, "选择文件", ".mat", "mat file(*.mat)")[0])
        if masks_path == '':
            return
        try:
    ...
    def load_result(self):
        ...
        root.withdraw()
        # get path
        result_path = np.str(QFileDialog.getOpenFileName(self, "选择文件", ".mat", "mat file(*.mat)")[0])
        if result_path == '':
            return
    ...
    def savetiff(self):
        ...
        if hasattr(myWin,'enhanced_image'):
            root = tk.Tk()
            root.withdraw()
            self.save_path = np.str(QFileDialog.getSaveFileName(self, "选择文件", ".tif", "tif file(*.tif)")[0])
    ...
    def save_masks(self):
        if hasattr(myWin, 'properties'):
            root = tk.Tk()
            root.withdraw()
            self.save_path = np.str(QFileDialog.getSaveFileName(self)[0])
            if self.save_path == '':
                return
