    ...
    if n_frames<500:
        ...
        for i in range(n_frames//500):
            ...
            temp_reg_image, ymax, xmax, cmax, ymax1, xmax1, cmax1, nonsense = register.register_frames(refAndMasks, temp_image,
                                                                                                  ...
                                                                                                  ops=ops, nZ=1)
            raw_image = raw_image[500:, :, :]
            reg_image[i*500:i*500+500, :, :] = temp_reg_image
        if n_frames%500 > 1:
            i = i + 1
            temp_reg_image, ymax, xmax, cmax, ymax1, xmax1, cmax1, nonsense = register.register_frames(refAndMasks,
                                                                                                       ...
                                                                                                       bidiphase=ops[
                                                                                                           'bidi_corrected'],
                                                                                                       ops=ops, nZ=1)
            reg_image[i * 500 :, :, :] = temp_reg_image
