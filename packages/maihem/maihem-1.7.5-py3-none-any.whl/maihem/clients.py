...
from maihem.logger import get_logger, add_default_logger
...
class Client:
    ...
    _staging_url: str = "https://api.staging.maihem.com"
    _staging_url_ui: str = "https://cause.staging.maihem.com"
...
class Maihem(Client):
    ...
    def __init__(
        ...
        add_default_logger(logger=self._logger)
