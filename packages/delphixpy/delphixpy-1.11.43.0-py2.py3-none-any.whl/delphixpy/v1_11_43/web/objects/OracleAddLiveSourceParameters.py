...
from delphixpy.v1_11_43.web.objects.AddLiveSourceParameters import AddLiveSourceParameters
...
class OracleAddLiveSourceParameters(AddLiveSourceParameters):
    """
    *(extends* :py:class:`v1_11_43.web.vo.AddLiveSourceParameters` *)* The
    ...
    def source(self):
        ...
        :rtype: :py:class:`v1_11_43.web.vo.OracleLiveSource`
        """
