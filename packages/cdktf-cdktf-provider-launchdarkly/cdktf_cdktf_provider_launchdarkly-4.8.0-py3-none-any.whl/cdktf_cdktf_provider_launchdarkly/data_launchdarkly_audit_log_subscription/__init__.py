...
Refer to the Terraform Registry for docs: [`data_launchdarkly_audit_log_subscription`](https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.25.0/docs/data-sources/audit_log_subscription).
'''
...
class DataLaunchdarklyAuditLogSubscription(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.25.0/docs/data-sources/audit_log_subscription launchdarkly_audit_log_subscription}.'''
...
class DataLaunchdarklyAuditLogSubscriptionConfig(
    ...
    def id(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.25.0/docs/data-sources/audit_log_subscription#id DataLaunchdarklyAuditLogSubscription#id}
    ...
    def integration_key(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.25.0/docs/data-sources/audit_log_subscription#integration_key DataLaunchdarklyAuditLogSubscription#integration_key}
        '''
