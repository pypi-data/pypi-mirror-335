...
class FeatureFlag(
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing FeatureFlag that should be imported. Refer to the {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.25.0/docs/resources/feature_flag#import import section} in the documentation of this resource for the id to use
    ...
    def put_defaults(
        ...
        *,
        ...
        '''
        :param off_variation: The index of the variation the flag will default to in all new environments when off. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.25.0/docs/resources/feature_flag#off_variation FeatureFlag#off_variation}
        :param on_variation: The index of the variation the flag will default to in all new environments when on. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.25.0/docs/resources/feature_flag#on_variation FeatureFlag#on_variation}
        '''
...
class FeatureFlagClientSideAvailability:
    def __init__(
        ...
        *,
        ...
        '''
        :param using_environment_id: Whether this flag is available to SDKs using the client-side ID. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.25.0/docs/resources/feature_flag#using_environment_id FeatureFlag#using_environment_id}
        :param using_mobile_key: Whether this flag is available to SDKs using a mobile key. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.25.0/docs/resources/feature_flag#using_mobile_key FeatureFlag#using_mobile_key}
        '''
        if __debug__:
...
class FeatureFlagCustomProperties:
    def __init__(
        ...
        *,
        ...
        '''
        :param key: The unique custom property key. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.25.0/docs/resources/feature_flag#key FeatureFlag#key}
        :param name: The name of the custom property. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.25.0/docs/resources/feature_flag#name FeatureFlag#name}
        :param value: The list of custom property value strings. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/launchdarkly/launchdarkly/2.25.0/docs/resources/feature_flag#value FeatureFlag#value}
        '''
        if __debug__:
