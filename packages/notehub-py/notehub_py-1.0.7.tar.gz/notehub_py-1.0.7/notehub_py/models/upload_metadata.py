...
class UploadMetadata(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "length", "md5", "crc32", "created", "modified", "source", "contains", "found", "type", "tags", "notes", "firmware"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tags": obj.get("tags"),
            "notes": obj.get("notes"),
            "firmware": Firmware.from_dict(obj["firmware"]) if obj.get("firmware") is not None else None
        })
        return _obj
