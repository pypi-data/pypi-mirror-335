...
class DeviceDfuStatus(BaseModel):
    ...
    dfu_in_progress: Optional[StrictBool] = Field(default=None, description="true if there is a DFU currently in progress")
    current: Optional[DeviceDfuStatusCurrent] = None
    status: Optional[DeviceDfuStateMachine] = None
    __properties: ClassVar[List[str]] = ["device_uid", "dfu_in_progress", "current", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "current": DeviceDfuStatusCurrent.from_dict(obj["current"]) if obj.get("current") is not None else None,
            "status": DeviceDfuStateMachine.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj
