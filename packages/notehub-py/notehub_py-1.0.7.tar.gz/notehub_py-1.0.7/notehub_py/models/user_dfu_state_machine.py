...
class UserDfuStateMachine(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["status", "created", "from_version", "metadata"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "status": UserDfuStateMachineStatus.from_dict(obj["status"]) if obj.get("status") is not None else None,
            "created": obj.get("created"),
            "from_version": obj.get("from_version"),
            "metadata": UploadMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None
        })
        return _obj
