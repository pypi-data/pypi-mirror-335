...
class Alert(BaseModel):
    ...
    monitor_type: Optional[StrictStr] = Field(default=None, description="The type of monitor that triggered the alert")
    field_name: Optional[StrictStr] = Field(default=None, description="The field name that triggered the alert")
    data: Optional[List[AlertDataInner]] = None
    notifications: Optional[List[AlertNotificationsInner]] = None
    __properties: ClassVar[List[str]] = ["uid", "monitor_uid", "monitor_name", "device_uid", "created_at", "value", "resolved", "version", "alert_source", "source", "monitor_type", "field_name", "data", "notifications"]
