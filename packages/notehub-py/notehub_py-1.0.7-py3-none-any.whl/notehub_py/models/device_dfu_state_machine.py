...
class DeviceDfuStateMachine(BaseModel):
    ...
    """ # noqa: E501
    requested_version: Optional[StrictStr] = Field(default=None, description="Version of the firmware that was requested to be installed")
    current_version: Optional[StrictStr] = Field(default=None, description="Version of the firmware that was installed prior to this request")
    initiated: Optional[StrictStr] = Field(default=None, description="RFC3339 datetime of when this update was requested")
    updates: Optional[List[DeviceDfuStateMachineNode]] = None
    __properties: ClassVar[List[str]] = ["requested_version", "current_version", "initiated", "updates"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "updates": [DeviceDfuStateMachineNode.from_dict(_item) for _item in obj["updates"]] if obj.get("updates") is not None else None
        })
        return _obj
