...
class RouteApi:
    ...
    def create_route(
        ...
        notehub_route: Annotated[NotehubRoute, Field(description="Route to be Created")],
    ...
    def update_route(
        ...
        project_uid: StrictStr,
        route_uid: StrictStr,
        notehub_route: Annotated[NotehubRoute, Field(description="Route settings to be updated")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
