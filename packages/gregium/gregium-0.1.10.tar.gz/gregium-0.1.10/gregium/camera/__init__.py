...
manager, allowing easy use of "with"::
    ...
    def on_draw():
        ...
        Found at: https://github.com/pyglet/pyglet/blob/master/examples/window/camera.py
"""

class Camera:
    """ A simple 2D camera that contains the speed and offset."""

    def __init__(self, window: pyglet.window.BaseWindow, scroll_speed=1, min_zoom=1, max_zoom=4):
