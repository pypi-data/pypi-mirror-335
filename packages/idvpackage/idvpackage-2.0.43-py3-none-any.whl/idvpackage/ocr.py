        ...
        if country == 'IRQ':
            ...
            try:
                ...
                dict_mother_surname['mother_last_name_en'] = GoogleTranslator('ar', 'en').translate(
                    dict_mother_surname['mother_last_name']).upper()
            except Exception as e:
            ...
            try:
                ...
                dict_mother_name['mother_first_name_en'] = GoogleTranslator('ar', 'en').translate(
                    dict_mother_name['mother_first_name']).upper()
            except Exception as e:
