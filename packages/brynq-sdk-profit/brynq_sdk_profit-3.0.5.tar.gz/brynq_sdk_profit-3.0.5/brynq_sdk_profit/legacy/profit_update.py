...
class UpdateConnector(BrynQ):
    ...
    def create_person(self, data: dict, overload_fields: dict = None) -> requests.Response:
            ...
            "KnPerson": {
                "Element": {
                    "Fields": {
                        ...
                        "SpNm": True,  # Split birthname
                        "ViUs": data['name_usage'],  # Name usage = birth name
                        # Both point to the same ID, per your snippet
                        # "BcId": data['person_id'],
                        "BcCo": data['person_id'],
                    }
                }
        ...
        # If the user gave us both 'last_name' and 'birthname', you can choose which to use for LaNm:
    ...
    def update_crm_person(self, data: dict, overload_fields: dict = None) -> requests.Response:
        ...
        Key details:
          ...
          - SpNm=True  (split birth name).
          - ViUs=0     (name usage = birth name).
            ...
            "KnPerson": {
                "Element": {
                    "Fields": {
                        ...
                        "SpNm": True,  # Split birthname
                        "ViUs": data['name_usage'],  # Name usage = birth name
                        # Both point to the same ID for matching:
                        # "BcId": data['person_id'],
                        "BcCo": data['person_id'],
                    }
                }
    ...
    def new_employee_with_first_contract(self, data: dict, overload_fields: dict = None) -> requests.Response:
        ...
        allowed_fields_salary = ['step', 'salary_scale', 'salary_scale_type', 'function_scale',
                                 'function_scale_type', 'salary_year',
