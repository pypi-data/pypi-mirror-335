...
class UpdateConnector(BrynQ):
    ...
    def update_person_person(self, data: dict, overload_fields: dict = None) -> requests.Response:
        """
    ...
    def update_person(self, data: dict, overload_fields: dict = None, method='PUT') -> requests.Response:
        ...
        This method is more specific than `update_person_person`, as it also requires
