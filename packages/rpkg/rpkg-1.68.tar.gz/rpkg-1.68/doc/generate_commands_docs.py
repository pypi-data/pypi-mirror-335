...
if __name__ == '__main__':
    ...
    config = configparser.ConfigParser()  # empty config
    # client needs empty config object to be passed because some methods
    # in client work with the config, although they don't need specific values
    client = pyrpkg.cli.cliClient(name=args.app_name, config=config)
