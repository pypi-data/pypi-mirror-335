...
class HydraEmailManager:
    ...
    def baixar_emails(self, user_email, folder_id, is_read=None, file_format="eml", subject_filter=None, from_filter=None, body_filter=None, order_by=None, limit=None):
        if self.headers:
            ...
            if response.status_code == 200:
                ...
                for email in emails:
                    ...
                    email_data.append({
                        ...
                        "subject": subject,
                        "body": body,
                        "attachments": [attachment["name"] for attachment in attachments if attachment["@odata.type"] == "#microsoft.graph.fileAttachment"]
                    })
                return email_data
            else:
