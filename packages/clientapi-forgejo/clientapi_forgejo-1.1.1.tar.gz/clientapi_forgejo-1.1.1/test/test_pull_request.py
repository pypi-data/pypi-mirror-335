    ...
    def make_instance(self, include_optional) -> PullRequest:
        ...
        if include_optional:
            return PullRequest(
                ...
                base = clientapi_forgejo.models.pr_branch_info.PRBranchInfo(
                    label = '', 
                    ref = '', 
                    repo = clientapi_forgejo.models.repository.Repository(
                ...
                head = clientapi_forgejo.models.pr_branch_info.PRBranchInfo(
                    label = '', 
                    ref = '', 
                    repo = clientapi_forgejo.models.repository.Repository(
                        allow_fast_forward_only_merge = True, 
                ...
                merged_by = clientapi_forgejo.models.user.User(
                    active = True, 
                    avatar_url = '', 
                    created = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    description = '', 
