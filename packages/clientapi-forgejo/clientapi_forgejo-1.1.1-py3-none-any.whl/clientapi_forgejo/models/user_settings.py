...
class UserSettings(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["description", "diff_view_style", "enable_repo_unit_hints", "full_name", "hide_activity", "hide_email", "language", "location", "pronouns", "theme", "website"]
