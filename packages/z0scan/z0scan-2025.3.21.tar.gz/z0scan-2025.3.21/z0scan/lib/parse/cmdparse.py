...
def cmd_line_parser(argv=None):
    ...
    parser.add_argument("--debug", dest="debug", action="store_true", default=config.DEBUG, help="Show programs's exception")
    ...
    request.add_argument("--timeout", dest="timeout", help="Seconds to wait before timeout connection (Default {})".format(config.TIMEOUT), type=int)
    request.add_argument("--retry", dest="retry", type=int, help="Time out retrials times (Default {})".format(config.RETRY))
