import{r as t,j as o,bo as z,l as c,O as w,R as P,E as b,cx as k,ei as S,ej as F,ek as L,el as l,v as C,em as E}from"./vendor-BT2CVKel.js";import{c as R,x as I,D as j,M as A,N as T}from"./vendor-arizeai-Dzsaenki.js";import{L as _,r as O,d as D,e as G,F as M,f as N,P as V,h as q,M as m,g as U,D as W,i as B,E as J,j as K,k as $,p as H,l as Q,n as p,o as Y,q as X,s as Z,S as oo,t as lo,v as ao,w as ro,x as co,y as u,z as f,A as y,B as go,C as eo,G as bo,H as no,I as io,J as so,K as to,N as mo,O as po,Q as uo,U as fo,V as yo,W as vo,X as ho,Y as xo,Z as zo,_ as wo,$ as Po,a0 as ko,a1 as So,a2 as Fo,a3 as Lo,a4 as Co,a5 as Eo,a6 as Ro,a7 as Io,a8 as jo,a9 as Ao,aa as To,ab as _o,ac as Oo,ad as Do,ae as Go,af as Mo}from"./pages-DV4OMLyH.js";import{z as No,dO as Vo,by as qo,R as Uo,dP as Wo,dQ as Bo}from"./components-B1h2vIB3.js";import"./vendor-three-C5WAXd5r.js";import"./vendor-codemirror-D2R3PB3i.js";import"./vendor-shiki-dzrzjP7E.js";import"./vendor-recharts-DetvdWCF.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))s(r);new MutationObserver(r=>{for(const g of r)if(g.type==="childList")for(const n of g.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&s(n)}).observe(document,{childList:!0,subtree:!0});function i(r){const g={};return r.integrity&&(g.integrity=r.integrity),r.referrerPolicy&&(g.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?g.credentials="include":r.crossOrigin==="anonymous"?g.credentials="omit":g.credentials="same-origin",g}function s(r){if(r.ep)return;r.ep=!0;const g=i(r);fetch(r.href,g)}})();const v="arize-phoenix-feature-flags",d={__RESET__:!1};function Jo(){const a=localStorage.getItem(v);if(!a)return d;try{const e=JSON.parse(a);return Object.assign({},d,e)}catch{return d}}const h=t.createContext(null);function Ko(){const a=P.useContext(h);if(a===null)throw new Error("useFeatureFlags must be used within a FeatureFlagsProvider");return a}function $o(a){const[e,i]=t.useState(Jo()),s=r=>{localStorage.setItem(v,JSON.stringify(r)),i(r)};return o(h.Provider,{value:{featureFlags:e,setFeatureFlags:s},children:o(Ho,{children:a.children})})}function Ho(a){const{children:e}=a,{featureFlags:i,setFeatureFlags:s}=Ko(),[r,g]=t.useState(!1);return z("ctrl+shift+f",()=>g(!0)),c(w,{children:[e,o(j,{type:"modal",isDismissable:!0,onDismiss:()=>g(!1),children:r&&o(R,{title:"Feature Flags",children:o(No,{height:"size-1000",padding:"size-100",children:Object.keys(i).map(n=>o(I,{isSelected:i[n],onChange:x=>s({...i,[n]:x}),children:n},n))})})})]})}const Qo=b`
  :root {
...
`;function gl(){const{theme:a="dark"}=A();return o(k,{styles:b(Xo,Yo,a==="dark"?Zo:ol,ll(a),Qo,al,rl,cl)})}const el=S(F(c(l,{path:"/",errorElement:o(Do,{}),children:[o(l,{path:"/login",element:o(_,{})}),o(l,{path:"/reset-password",element:o(D,{}),loader:O}),o(l,{path:"/reset-password-with-token",element:o(G,{})}),o(l,{path:"/forgot-password",element:o(M,{})}),o(l,{element:o(Oo,{}),loader:N,children:c(l,{element:o(_o,{}),children:[o(l,{path:"/profile",handle:{crumb:()=>"profile"},element:o(V,{})}),o(l,{index:!0,loader:q}),c(l,{path:"/model",handle:{crumb:()=>"model"},element:o(K,{}),children:[o(l,{index:!0,element:o(m,{})}),o(l,{element:o(m,{}),children:o(l,{path:"dimensions",children:o(l,{path:":dimensionId",element:o(W,{}),loader:U})})}),o(l,{path:"embeddings",children:o(l,{path:":embeddingDimensionId",element:o(J,{}),loader:B,handle:{crumb:a=>a.embedding.name}})})]}),c(l,{path:"/projects",handle:{crumb:()=>"projects"},element:o(ro,{}),children:[o(l,{index:!0,element:o($,{})}),c(l,{path:":projectId",loader:H,handle:{crumb:a=>a.project.name},children:[o(l,{index:!0,element:o(Q,{})}),c(l,{element:o(ao,{}),children:[o(l,{path:"traces",element:o(Y,{}),children:o(l,{path:":traceId",element:o(p,{})})}),o(l,{path:"spans",element:o(X,{}),children:o(l,{path:":traceId",element:o(p,{})})}),o(l,{path:"sessions",element:o(lo,{}),children:o(l,{path:":sessionId",element:o(oo,{}),loader:Z})})]})]})]}),c(l,{path:"/datasets",handle:{crumb:()=>"datasets"},children:[o(l,{index:!0,element:o(co,{})}),c(l,{path:":datasetId",loader:u,handle:{crumb:a=>a.dataset.name},children:[c(l,{element:o(no,{}),loader:u,children:[o(l,{index:!0,element:o(y,{}),loader:f}),o(l,{path:"experiments",element:o(y,{}),loader:f}),o(l,{path:"examples",element:o(bo,{}),loader:go,children:o(l,{path:":exampleId",element:o(eo,{})})})]}),o(l,{path:"compare",handle:{crumb:()=>"compare"},loader:io,element:o(so,{})})]})]}),c(l,{path:"/playground",handle:{crumb:()=>"Playground"},children:[o(l,{index:!0,element:o(to,{})}),o(l,{path:"spans/:spanId",element:o(po,{}),loader:mo,handle:{crumb:a=>a.span.__typename==="Span"?`span ${a.span.spanId}`:"span unknown"}})]}),c(l,{path:"/prompts",handle:{crumb:()=>"prompts"},children:[o(l,{index:!0,element:o(fo,{}),loader:uo}),c(l,{path:":promptId",loader:yo,shouldRevalidate:()=>!0,handle:{crumb:a=>a.prompt.__typename==="Prompt"?a.prompt.name:"unknown"},children:[c(l,{element:o(So,{}),children:[o(l,{index:!0,element:o(vo,{})}),o(l,{path:"versions",loader:ho,element:o(wo,{}),children:o(l,{path:":versionId",loader:xo,element:o(zo,{})})}),o(l,{path:"config",element:o(ko,{}),loader:Po})]}),o(l,{path:"playground",element:o(Lo,{}),loader:Fo,handle:{crumb:()=>"playground"}})]})]}),o(l,{path:"/apis",element:o(Co,{}),handle:{crumb:()=>"APIs"}}),o(l,{path:"/support",element:o(Eo,{}),handle:{crumb:()=>"support"}}),c(l,{path:"/settings",element:o(To,{}),handle:{crumb:()=>"settings"},children:[o(l,{path:"general",loader:Ro,element:o(Io,{}),handle:{crumb:()=>"general"}}),o(l,{path:"providers",loader:jo,element:o(Ao,{}),handle:{crumb:()=>"providers"}})]})]})})]})),{basename:window.Config.basename});function bl(){return o(L,{router:el})}function nl(){return o(Go,{children:o(Vo,{children:o(il,{})})})}function il(){const{theme:a}=qo();return o(T,{theme:a,mountGlobalStyles:!1,children:c(C.RelayEnvironmentProvider,{environment:Uo,children:[o(gl,{}),o($o,{children:o(Wo,{children:o(Mo,{children:o(t.Suspense,{children:o(Bo,{children:o(bl,{})})})})})})]})})}const sl=document.getElementById("root"),tl=E.createRoot(sl);tl.render(o(nl,{}));
