...
class TrackExportPayload(BaseModel):
    """
    TrackExportPayload
    """ # noqa: E501
    track_run_id: StrictInt = Field(description="The identifier of a Track Run.")
    ...
    __properties: ClassVar[List[str]] = ["track_run_id", "operation_name", "mode", "limit", "tag_ids"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TrackExportPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TrackExportPayload from a dict"""
        if obj is None:
            return None
