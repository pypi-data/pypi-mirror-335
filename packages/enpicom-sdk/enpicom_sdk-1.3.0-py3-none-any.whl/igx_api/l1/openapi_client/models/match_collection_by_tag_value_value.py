...
class MatchCollectionByTagValueValue(BaseModel):
    """
    MatchCollectionByTagValueValue
    """ # noqa: E501
    tag_id: Union[StrictFloat, StrictInt]
    tag_value: StrictStr
    __properties: ClassVar[List[str]] = ["tag_id", "tag_value"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MatchCollectionByTagValueValue from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MatchCollectionByTagValueValue from a dict"""
        if obj is None:
            return None
