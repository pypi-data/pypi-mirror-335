...
class GetCollectionIdNotFoundResponse(BaseModel):
    """
    GetCollectionIdNotFoundResponse
    """ # noqa: E501
    result: StrictStr
    message: StrictStr
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetCollectionIdNotFoundResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetCollectionIdNotFoundResponse from a dict"""
        if obj is None:
            return None
