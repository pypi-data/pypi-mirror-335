...
class JobStartedResponse(BaseModel):
    """
    Response to a request to start a job. <br> Contains the ID of the job that was started. Which can be used to check the state of the job and get the results.
    """ # noqa: E501
    job_id: StrictInt
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of JobStartedResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of JobStartedResponse from a dict"""
        if obj is None:
            return None
