...
class PROTOBUF_EXPORT ProfileOptions final :
 ...
 public:
  ...
  enum : int {
    ...
    kIgnoreStartErrorFieldNumber = 13,
  ...
  void clear_ignore_start_error();
  bool ignore_start_error() const;
  void set_ignore_start_error(bool value);
  private:
  bool _internal_ignore_start_error() const;
  void _internal_set_ignore_start_error(bool value);
  public:
...
// bool ignore_start_error = 13;
inline void ProfileOptions::clear_ignore_start_error() {
  _impl_.ignore_start_error_ = false;
}
inline bool ProfileOptions::_internal_ignore_start_error() const {
  return _impl_.ignore_start_error_;
}
inline bool ProfileOptions::ignore_start_error() const {
  // @@protoc_insertion_point(field_get:tensorflow.ProfileOptions.ignore_start_error)
  return _internal_ignore_start_error();
}
inline void ProfileOptions::_internal_set_ignore_start_error(bool value) {
  
  _impl_.ignore_start_error_ = value;
}
inline void ProfileOptions::set_ignore_start_error(bool value) {
  _internal_set_ignore_start_error(value);
  // @@protoc_insertion_point(field_set:tensorflow.ProfileOptions.ignore_start_error)
}
