        ...
        if self.download_data:
            ...
            for process_step_dict in self.sap_operation_list:
                ...
                if function_name == 'login_sap':
                    need_clear, except_str = sap_operation_dict.get('need_clear', False), sap_operation_dict.get('except_str', 'Common')
                    sap_automation.login_sap(sap_operation_dict['sap_system'], sap_operation_dict['username'], sap_operation_dict['password'], need_clear, except_str)
