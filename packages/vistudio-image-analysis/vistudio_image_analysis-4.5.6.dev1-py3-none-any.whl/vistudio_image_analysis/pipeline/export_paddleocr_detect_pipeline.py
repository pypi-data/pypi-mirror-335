...
from vistudio_image_analysis.processor.exporter.paddleocr.paddleocr_preprocessor import \
    PaddleOCRDetectFormatPreprocessor
...
class ExportPaddleOCRDetectPipeline(BaseExportPipeline):
    """
    ...
    def run(self, parallelism: int = 10):
        ...
        # 第二步 formatter 算子
        paddleocr_format_preprocessor = PaddleOCRDetectFormatPreprocessor(counter=self.counter)
