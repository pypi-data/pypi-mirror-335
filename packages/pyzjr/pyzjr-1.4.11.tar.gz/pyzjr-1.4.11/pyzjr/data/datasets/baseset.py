...
class BaseDataset(Dataset):
    ...
    def read_image(self, filename, target_shape=None, to_rgb=True, normalize=True, pad_color=(128, 128, 128)):
        ...
        if target_shape is not None:
            img = resizepad(img, target_shape, pad_color=pad_color)
    ...
    def auguments(self, imglists, prob=.5, target_shape=None):
        if target_shape is not None:
