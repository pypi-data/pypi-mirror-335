"""Driver for L9110 motor controller over I2C."""

# Phát hiện môi trường Python hay MicroPython
try:
    # Python 3 với smbus2
    from smbus2 import SMBus
    IS_MICROPYTHON = False
except ImportError:
    # MicroPython với machine
...
class L9110:
    ...
    Attributes:
        ...
        bus: I2C bus object (SMBus for Python, I2C for MicroPython).
    """
    ...
    def __init__(self, address=0x40, bus=None, bus_number=1):
        ...
        Args:
            ...
            bus: Pre-initialized I2C bus object (optional).
        ...
        if bus is not None:
            ...
            if IS_MICROPYTHON:
                # MicroPython: mặc định sử dụng I2C(1) hoặc cần cấu hình cụ thể
                self.bus = I2C(bus_number)  # Có thể cần điều chỉnh tùy board
            else:
                # Python 3: sử dụng SMBus
    ...
    def __exit__(self, exc_type, exc_value, traceback):
        ...
        if not IS_MICROPYTHON:
            self.bus.close()  # Chỉ SMBus có phương thức close()
    ...
    def _send_data(self, data):
        ...
        try:
            if IS_MICROPYTHON:
                # MicroPython sử dụng write_buf
                self.bus.writeto(self.address, bytearray(data))
            else:
                # Python 3 sử dụng write_i2c_block_data
