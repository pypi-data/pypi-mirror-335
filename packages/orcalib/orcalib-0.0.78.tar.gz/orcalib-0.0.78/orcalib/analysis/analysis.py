...
def run_analyses(
    ...
    *analyses: MemorysetAnalysis,
    ...
    >>> run_analyses(
    ...     memoryset,
    ...     MemorysetDuplicateMetrics(possible_duplicate_threshold=0.95),
    ...
    for memory_batch in tqdm(
        ...
        safely_call_on_progress(on_progress, offset, memoryset_num_rows)
    ...
    safely_call_on_progress(on_progress, memoryset_num_rows, memoryset_num_rows)

    # TODO: include finish steps in the progress reporting somehow
