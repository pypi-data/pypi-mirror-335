...
PROMPTS = {
    ...
    "FindElements": types.Prompt(
        ...
        arguments=[
            types.PromptArgument(
                name="isInstance",
                description="Whether to search for instances or types",
                required=False
            ),
            types.PromptArgument(
                name="categoryId",
                description="Category ID to search Revit Category Id",
            ),
            types.PromptArgument(
                name="categoryName",
                description="Category name to search categoryName. must be provided.  (optional)",
                required=True
            ),
        ],
    ),
