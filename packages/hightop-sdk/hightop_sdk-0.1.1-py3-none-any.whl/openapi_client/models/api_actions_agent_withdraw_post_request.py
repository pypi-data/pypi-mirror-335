...
class ApiActionsAgentWithdrawPostRequest(BaseModel):
    """
    ApiActionsAgentWithdrawPostRequest
    """ # noqa: E501
    ...
    vault_token: Optional[Any] = Field(description="Ethereum address", alias="vaultToken")
    ...
    __properties: ClassVar[List[str]] = ["agenticWallet", "legoId", "asset", "vaultToken", "amount", "message", "localMessageId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiActionsAgentWithdrawPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiActionsAgentWithdrawPostRequest from a dict"""
        if obj is None:
            return None
