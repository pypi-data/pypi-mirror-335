...
class ActionCreateResponseMessage(BaseModel):
    """
    ActionCreateResponseMessage
    """ # noqa: E501
    id: StrictStr
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ActionCreateResponseMessage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ActionCreateResponseMessage from a dict"""
        if obj is None:
            return None
