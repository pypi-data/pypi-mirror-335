...
class ApiUserCreateWalletPostRequest(BaseModel):
    """
    ApiUserCreateWalletPostRequest
    """ # noqa: E501
    owner_wallet_address: Optional[Any] = Field(description="Ethereum address", alias="ownerWalletAddress")
    __properties: ClassVar[List[str]] = ["ownerWalletAddress"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiUserCreateWalletPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiUserCreateWalletPostRequest from a dict"""
        if obj is None:
            return None
