...
class ApiActionsAgentDepositPostRequest(BaseModel):
    """
    ApiActionsAgentDepositPostRequest
    """ # noqa: E501
    ...
    vault: Optional[Any] = Field(description="Ethereum address")
    ...
    __properties: ClassVar[List[str]] = ["agenticWallet", "legoId", "asset", "vault", "amount", "message", "localMessageId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiActionsAgentDepositPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiActionsAgentDepositPostRequest from a dict"""
        if obj is None:
            return None
