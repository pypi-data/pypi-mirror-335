...
class BatchActionPayload(BaseModel):
    ...
    actions: List[ApiActionsAgentBatchPostRequestActionsInner]
    __properties: ClassVar[List[str]] = ["agenticWallet", "message", "localMessageId", "actions"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BatchActionPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BatchActionPayload from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "actions": [ApiActionsAgentBatchPostRequestActionsInner.from_dict(_item) for _item in obj["actions"]] if obj.get("actions") is not None else None
        })
        return _obj
