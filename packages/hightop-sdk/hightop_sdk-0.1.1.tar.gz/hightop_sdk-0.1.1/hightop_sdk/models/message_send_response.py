...
class MessageSendResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "agenticWallet", "sender", "message", "createdAt", "updatedAt", "localId", "userId", "conversationId", "agent", "Action"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MessageSendResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MessageSendResponse from a dict"""
        if obj is None:
            return None
