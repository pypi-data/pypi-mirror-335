...
class ApiActionsAgentBatchPostRequestActionsInner(BaseModel):
    """
    ApiActionsAgentBatchPostRequestActionsInner
    """ # noqa: E501
    type: ActionType
    lego_id: Optional[Any] = Field(default=None, description="BigInt", alias="legoId")
    ...
    alt_lego_id: Optional[Any] = Field(default=None, description="BigInt", alias="altLegoId")
    ...
    alt_amount: Optional[Any] = Field(default=None, description="BigInt", alias="altAmount")
    __properties: ClassVar[List[str]] = ["type", "legoId", "asset", "amount", "vault", "recipient", "altLegoId", "altVault", "altAsset", "altAmount"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiActionsAgentBatchPostRequestActionsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiActionsAgentBatchPostRequestActionsInner from a dict"""
        if obj is None:
            return None
