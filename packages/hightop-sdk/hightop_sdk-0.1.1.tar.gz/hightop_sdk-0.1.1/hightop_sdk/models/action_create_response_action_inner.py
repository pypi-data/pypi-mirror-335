...
class ActionCreateResponseActionInner(BaseModel):
    """
    ActionCreateResponseActionInner
    """ # noqa: E501
    id: StrictStr
    type: ActionType
    status: ActionStatus
    ...
    __properties: ClassVar[List[str]] = ["id", "type", "status", "legoId", "asset", "vault", "amount", "recipient", "altLegoId", "altVault", "altAsset", "altAmount"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ActionCreateResponseActionInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ActionCreateResponseActionInner from a dict"""
        if obj is None:
            return None
