...
class ApiActionsAgentTransferPostRequest(BaseModel):
    """
    ApiActionsAgentTransferPostRequest
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["agenticWallet", "asset", "amount", "message", "localMessageId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiActionsAgentTransferPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiActionsAgentTransferPostRequest from a dict"""
        if obj is None:
            return None
