...
recording_moving_object_schema = pa.DataFrameSchema(
    ...
    columns={
        'x': pa.Column(float, 
                       ...
                       description='osi3.Vector3d.x'), 
        'y': pa.Column(float, 
                       title='MovingObject.base.position.y',
                       description='osi3.Vector3d.y'),
        'z': pa.Column(float, 
                       title='MovingObject.base.position.z',
                       description='osi3.Vector3d.z'),
        'vel_x': pa.Column(float, 
                           title='MovingObject.base.velocity.x',
                           description='osi3.Vector3d.x'),
        'vel_y': pa.Column(float, 
                           title='MovingObject.base.velocity.y',
                           description='osi3.Vector3d.y'),
        'vel_z': pa.Column(float, 
                           title='MovingObject.base.velocity.z',
                           description='osi3.Vector3d.z'),
        'acc_x': pa.Column(float, 
                           title='MovingObject.base.acceleration.x',
                           description='osi3.Vector3d.x'),
        'acc_y': pa.Column(float, 
                           title='MovingObject.base.acceleration.y',
                           description='osi3.Vector3d.y'),
        'acc_z': pa.Column(float, 
                           title='MovingObject.base.acceleration.z',
                           description='osi3.Vector3d.z'),
        'length': pa.Column(float, 
                            pa.Check.gt(0), 
                            title='MovingObject.base.dimesion.length',
                            description='osi3.Dimenstion3d.length'),
        'width': pa.Column(float, 
                           pa.Check.gt(0), 
        ...
        'type': pa.Column(int, 
                          pa.Check.between(0,4, error=f"Type must be one of {({o.name: o.value for o in betterosi.MovingObjectType})}"), 
                          title="MovingObject.type",
                          description="osi3.MovingObject.Type"),
        'role': pa.Column(int, 
                          pa.Check.between(-1,10, error=f"Type must be one of {({o.name: o.value for o in betterosi.MovingObjectVehicleClassificationRole})}"),
                          title='MovingObject.vehicle_classification.role',
                          description='osi3.MovingObject.VehicleClassification.Role'),
        'subtype': pa.Column(int,  
                             pa.Check.between(-1, 17, error=f"Subtype must be one of {({o.name: o.value for o in betterosi.MovingObjectVehicleClassificationType})}"),
        ...
        'idx': pa.Column(int, 
                         pa.Check.ge(0), 
                         title='MovingObject.id.value',
                         description='osi3.Identifier.value'),
        'total_nanos': pa.Column(int, 
                                 pa.Check.ge(0), 
