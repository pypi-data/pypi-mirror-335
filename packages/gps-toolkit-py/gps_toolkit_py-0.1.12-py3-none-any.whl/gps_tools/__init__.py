...
Calculate distances between coordinates:
    ...
    from gps_toolkit_py import Coordinate
    from gps_toolkit_py import haversine_distance, vincenty_distance
...
Convert between different coordinate systems:
    ...
    from gps_toolkit_py import Coordinate
    from gps_toolkit_py import latlon_to_utm, utm_to_latlon, decimal_to_dms
...
Work with Universal Transverse Mercator coordinates:
    ...
    from gps_toolkit_py import UTMCoordinate
    from gps_toolkit_py import latlon_to_utm, utm_to_latlon
...
Work with Military Grid Reference System coordinates:
    ...
    from gps_toolkit_py import MGRSCoordinate
    from gps_toolkit_py import latlon_to_mgrs, mgrs_to_latlon
...
Example 1: Distance between cities
    from gps_toolkit_py import Coordinate, haversine_distance
...
Example 2: Calculate a path distance
    ...
    from gps_toolkit_py import calculate_path_distance
...
Example 3: Convert coordinates
    from gps_toolkit_py import convert_to_latlon
...
For detailed help on a specific topic, use:
    ...
    if topic in topics:
        ...
        print("For general help, use gps_toolkit_py.help()")
