...
def mgrs_to_utm(mgrs_str: str) -> Tuple[int, str, float, float]:
    ...
    # Handle latitude band correctly
    # Each band represents an 8° latitude range, with C starting at -80°
    # Add the base northing from the latitude band into the final northing
    # MGRS latitude bands and their corresponding base northings in meters
    # These values are the northing offsets for the southern edge of each latitude band
    latitude_band_base_northings = {
        'C': 1100000.0,  # -80° to -72°
        'D': 2000000.0,  # -72° to -64°
        'E': 2900000.0,  # -64° to -56°
        'F': 3800000.0,  # -56° to -48°
        'G': 4700000.0,  # -48° to -40°
        'H': 5600000.0,  # -40° to -32°
        'J': 6500000.0,  # -32° to -24°
        'K': 7400000.0,  # -24° to -16°
        'L': 8300000.0,  # -16° to -8°
        'M': 9200000.0,  # -8° to 0°
        'N': 0.0,        # 0° to 8°
        'P': 800000.0,   # 8° to 16°
        'Q': 1700000.0,  # 16° to 24°
        'R': 2600000.0,  # 24° to 32°
        'S': 3500000.0,  # 32° to 40°
        'T': 4400000.0,  # 40° to 48°
        'U': 5300000.0,  # 48° to 56°
        'V': 6200000.0,  # 56° to 64°
        'W': 7100000.0,  # 64° to 72°
        'X': 8000000.0,  # 72° to 84° (wider than others)
    }
    
    # Reset northing to remove any previous grid square offset
    northing = northing_origin + northing_offset
    
    # Add the base northing for the latitude band
    if zone_letter in latitude_band_base_northings:
        northing += latitude_band_base_northings[zone_letter]
        
        # For southern hemisphere bands (C-M), also add 10,000,000m offset
