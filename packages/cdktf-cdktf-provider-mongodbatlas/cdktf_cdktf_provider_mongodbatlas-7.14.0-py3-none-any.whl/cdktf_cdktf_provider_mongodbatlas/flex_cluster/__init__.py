...
class FlexCluster(
    ...
    def __init__(
        ...
        *,
        ...
        :param name: Human-readable label that identifies the instance. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.30.0/docs/resources/flex_cluster#name FlexCluster#name}
        :param project_id: Unique 24-hexadecimal character string that identifies the project. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.30.0/docs/resources/flex_cluster#project_id FlexCluster#project_id}
        :param provider_settings: Group of cloud provider settings that configure the provisioned MongoDB flex cluster. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.30.0/docs/resources/flex_cluster#provider_settings FlexCluster#provider_settings}
        :param tags: Map that contains key-value pairs between 1 to 255 characters in length for tagging and categorizing the instance. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.30.0/docs/resources/flex_cluster#tags FlexCluster#tags}
        :param termination_protection_enabled: Flag that indicates whether termination protection is enabled on the cluster. If set to ``true``, MongoDB Cloud won't delete the cluster. If set to ``false``, MongoDB Cloud will delete the cluster. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.30.0/docs/resources/flex_cluster#termination_protection_enabled FlexCluster#termination_protection_enabled}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing FlexCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.30.0/docs/resources/flex_cluster#import import section} in the documentation of this resource for the id to use
    ...
    def put_provider_settings(
        ...
        *,
        ...
        '''
        :param backing_provider_name: Cloud service provider on which MongoDB Cloud provisioned the flex cluster. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.30.0/docs/resources/flex_cluster#backing_provider_name FlexCluster#backing_provider_name}
        :param region_name: Human-readable label that identifies the geographic location of your MongoDB flex cluster. The region you choose can affect network latency for clients accessing your databases. For a complete list of region names, see `AWS <https://docs.atlas.mongodb.com/reference/amazon-aws/#std-label-amazon-aws>`_, `GCP <https://docs.atlas.mongodb.com/reference/google-gcp/>`_, and `Azure <https://docs.atlas.mongodb.com/reference/microsoft-azure/>`_. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.30.0/docs/resources/flex_cluster#region_name FlexCluster#region_name}
        '''
