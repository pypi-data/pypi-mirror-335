...
NUMBER_TYPE=[PARAM_STORAGE_USED,PARAM_TEMPERATURE_CURRENT,PARAM_HUMIDITY_CURRENT,PARAM_BATTERY]
                ...
                match ability_level:
                    case 1:
                        ...
                        if (
                            ...
                            imou_ha_device.sensors[sensor_type] = "unknown" if sensor_type not in NUMBER_TYPE else "0"
                    case 2:
                        if (
                            channel_num == 1
