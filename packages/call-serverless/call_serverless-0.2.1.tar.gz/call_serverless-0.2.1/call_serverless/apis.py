...
def call_lambda(
    ...
    Args:
        ...
        path_params (Union[dict, None], optional): Path parameters to send in the request. Defaults to None.
    Returns:
    ...
    payload = format_request(stage, path, method, headers, body, path_params)
