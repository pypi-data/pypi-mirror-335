...
import time
from radiominer import main
from radiominer.main import RadioRecorder, WhisperModel
import shutil
...
class TestRadioTranscription(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.recorder = RadioRecorder(self.stream_url, self.sender, 1, self.base_dir, verbose=True)

    @patch('radiominer.main.whisper.load_model')
