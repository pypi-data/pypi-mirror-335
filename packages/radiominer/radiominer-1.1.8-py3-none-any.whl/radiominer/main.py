...
class RadioRecorder:
    ...
    def __init__(self, stream_url, sender, segment_time=60, base_dir=None, poll_interval=5, whisper_model=WhisperModel.TURBO, quality="64k", record_only=False, transcribe_only=False, verbose=False, ffmpeg_path=None, run_once=False, use_monitor=True):
        if base_dir is None:
            base_dir = os.getcwd()
