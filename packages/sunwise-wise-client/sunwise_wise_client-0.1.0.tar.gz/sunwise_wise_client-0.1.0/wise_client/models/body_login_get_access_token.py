...
T = TypeVar("T", bound="BodyLoginGetAccessToken")


@_attrs_define
class BodyLoginGetAccessToken:
    """
    Attributes:
        username (str):
        password (str):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        body_login_get_access_token = cls(
            username=username,
            password=password,
        ...
        body_login_get_access_token.additional_properties = d
        return body_login_get_access_token
