...
class MainWindow_1(QMainWindow):
    ...
    def cal_hs(self):
        ...
        _, a, b, c, d = fourier_approx_norm_modify(self.chaincode, numofharmoinc, 400, 1,  self.option)
        ...
        if chain_code.size > 0:
            ...
            if circle.isdigit():
                ...
                if numofharmoinc > max_numofharmoinc:
                    ...
                    x_,_,_,_,_ = fourier_approx_norm_modify(chain_code, numofharmoinc, 400, 0, option)
