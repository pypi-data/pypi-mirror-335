...
class StoryElementData(BaseModel):
    ...
    @classmethod
    def create_and_validate(cls, data: dict, element_history: list["StoryElementData"]) -> "StoryElementData":
...
class SequentialStoryProcessor:
    ...
    def register_with_mcp(self, mcp: FastMCP) -> Callable[[dict], ProcessResult]:
        ...
        def sequentialstory(data: dict) -> ProcessResult:
