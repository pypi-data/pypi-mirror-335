...
# Define a protocol for request handlers
...
class Server:
    ...
    def set_request_handler(self, schema: type[Any], handler: RequestHandler) -> None:
        """Set a request handler for a schema."""

    async def connect(self, transport: "StdioServerTransport") -> None:
