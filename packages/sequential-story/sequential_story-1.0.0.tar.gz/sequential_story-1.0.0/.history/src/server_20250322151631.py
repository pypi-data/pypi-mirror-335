...
class SequentialToolsServer:
    ...
    def __init__(self) -> None:
        ...
        self.enabled_tools = set(settings.enabled_tools)
    ...
    def _get_description(self) -> str:
        ...
        thinking_enabled = ToolType.THINKING in self.enabled_tools
        story_enabled = ToolType.STORY in self.enabled_tools
    ...
    def _initialize_tools(self) -> None:
        ...
        if ToolType.STORY in self.enabled_tools:
        ...
        if ToolType.THINKING in self.enabled_tools:
