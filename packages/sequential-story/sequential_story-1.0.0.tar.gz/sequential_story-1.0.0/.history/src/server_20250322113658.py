...
from modelcontextprotocol.types import CallToolRequestSchema, ListToolsRequestSchema, Tool
...
class SequentialStoryServer:
    ...
    async def _handle_list_tools(self, _):
        ...
        Returns:
            Dict: Response containing available tools
    ...
    async def _handle_call_tool(self, request):
        ...
        Returns:
            Dict: Result of tool processing

        """
        if request.params.name == "sequentialstory":
            return self.story_processor.process_element(request.params.arguments)
