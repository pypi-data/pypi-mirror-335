...
class SequentialToolsServer:
    ...
    def _get_description(self) -> str:
        ...
        thinking_enabled = ToolType.THINKING in settings.enabled_tools
        story_enabled = ToolType.STORY in settings.enabled_tools
    ...
    def _initialize_tools(self) -> None:
        ...
        if ToolType.STORY in settings.enabled_tools:
        ...
        if ToolType.THINKING in settings.enabled_tools:
