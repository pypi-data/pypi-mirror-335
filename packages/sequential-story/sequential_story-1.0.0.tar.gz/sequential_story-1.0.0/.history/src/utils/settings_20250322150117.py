...
class Settings(BaseSettings):
    ...
    # Tool configuration
    tools: list[str | ToolType] | None = Field(
        default=None,
    ...
    @classmethod
    def validate_enabled_tools(cls, tools: list[str | ToolType] | None) -> list[str]:
        ...
        for tool in tools:
            ...
            if tool_value in cls.AVAILABLE_TOOLS:
                valid_tools.append(tool_value)
            else:
    ...
    def get_enabled_tools(self) -> list[str]:
        ...
        # Handle both ToolType and string values in the list
        return [tool.value if isinstance(tool, ToolType) else tool for tool in self.tools]
