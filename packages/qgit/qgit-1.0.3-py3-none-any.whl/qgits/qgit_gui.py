...
class SecretSauceWindow:
    ...
    def __init__(self, stdscr):
        ...
        try:
            ...
            print(
                "Error: Could not import SecretSauce. Please ensure qgits/secret_sauce.py exists."
            )
            sys.exit(1)
...
class LandingPage:
    ...
    def __init__(self, stdscr):
        ...
        try:
            ...
            # Create a new menu items list with stats in the correct position
            base_items = QGitConfig.MENU_ITEMS[:-2]  # All items except help and quit
            self.MENU_ITEMS = base_items + [
