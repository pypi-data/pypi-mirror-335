# sdk/callbacks.py
from .global_pb2 import Envelope, RspStkOrderField, RtnStkOrderField, RspStkQryExpendableFundExField, RspStkQryExpendableSharesExField
...
class BaseCallback:
    ...
    def handle_message(self, envelope: Envelope):
        ...
        if envelope.HasField("rsp_stk_order"):
            ...
            self.on_order(envelope.rtn_stk_order)
