...
class WindowActivity(BaseEstimator, TransformerMixin, TimeValidator):
    ...
    out_name_prefix : str, default="rolling_activity_count"
    ...
    time_col: str = "time"
    window_days: int = 30
    out_name_prefix: str = "rolling_activity_count"
    ...
    def transform(self, X: pd.DataFrame) -> pd.DataFrame:
        ...
        out_name = f"{self.out_name_prefix}_{self.window_days}d"
        df[out_name] = (
            df["_count"]
        ...
        df.drop(columns=["_count"], inplace=True)
