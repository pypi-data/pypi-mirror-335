...
class ZCNVMDef(NVMDef):
    ...
    def __init__(self, project_config, unit_cfg, nvm_vars):
        ...
        self.ifndef_wrapper = {
            "start": [f"#ifndef {prefix}NVM_FUNCTIONS_H\n", f"#define {prefix}NVM_FUNCTIONS_H\n"],
            "end": [f"#endif /* {prefix}NVM_FUNCTIONS_H */\n"]
        }
        self.init_function = f"\nvoid {prefix}VcNvmInit(void)"
    ...
    def _append_nvm_rte_function_calls(self):
        ...
        output = self.ifndef_wrapper["start"] + init_function_lines + footer + ["\n"] + main_function + error_status + main_function_lines + footer + self.ifndef_wrapper["end"]
