'''Most important file in jsemulator implementation: PyJs class - father of all PyJs objects'''
...
import jsparser
jsparser.parser.ENABLE_jsemulator_ERRORS = lambda msg: MakeError('SyntaxError', msg)
