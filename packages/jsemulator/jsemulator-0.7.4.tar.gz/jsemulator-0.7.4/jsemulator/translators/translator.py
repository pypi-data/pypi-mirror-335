...
# Enable jsemulator exceptions and pyimport in parser
jsparser.parser.ENABLE_PYIMPORT = True
...
# import jsemulator.pyjs, sys
# # Redefine builtin objects... Do you have a better idea?
# for m in list(sys.modules):
# 	if m.startswith('jsemulator'):
# 		del sys.modules[m]
# del jsemulator.pyjs
# del jsemulator

DEFAULT_HEADER = u'''from jsemulator.pyjs import *
# setting scope
