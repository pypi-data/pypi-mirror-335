...
def require(module_name, include_polyfill=True, update=False, context=None):
    ...
    finally translates the generated JS bundle to Python via jsemulator.
    ...
    :param context: Optional context in which the translated module should be executed in. If provided, the
        header (jsemulator imports) will be skipped as it is assumed that the context already has all the necessary imports.
