...
from ..models.list_sign_request_signers_inputs_array_item_ref_signers_inputs_type import (
    ListSignRequestSignersInputsArrayItemRefSignersInputsType,
)
import datetime
...
class ListSignRequestSignersInputsArrayItemRef(BaseModel):
    ...
    Attributes:
        ...
        type_ (Optional[ListSignRequestSignersInputsArrayItemRefSignersInputsType]): Type of input
    """
    ...
    type_: Optional[ListSignRequestSignersInputsArrayItemRefSignersInputsType] = Field(
