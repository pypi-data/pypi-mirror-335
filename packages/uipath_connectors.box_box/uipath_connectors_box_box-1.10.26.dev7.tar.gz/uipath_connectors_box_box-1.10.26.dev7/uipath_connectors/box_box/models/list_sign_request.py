...
from ..models.list_sign_request_sign_status import ListSignRequestSignStatus
...
class ListSignRequest(BaseModel):
    ...
    Attributes:
        ...
        status (Optional[ListSignRequestSignStatus]): The status of the sign request
    ...
    status: Optional[ListSignRequestSignStatus] = Field(alias="status", default=None)
