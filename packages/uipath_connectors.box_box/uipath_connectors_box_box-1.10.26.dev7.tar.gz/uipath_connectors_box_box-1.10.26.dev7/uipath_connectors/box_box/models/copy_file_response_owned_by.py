...
from ..models.copy_file_response_owned_by_owned_by_type import (
    CopyFileResponseOwnedByOwnedByType,
)
...
class CopyFileResponseOwnedBy(BaseModel):
    ...
    Attributes:
        ...
        type_ (Optional[CopyFileResponseOwnedByOwnedByType]): `user`
    """
    ...
    type_: Optional[CopyFileResponseOwnedByOwnedByType] = Field(
