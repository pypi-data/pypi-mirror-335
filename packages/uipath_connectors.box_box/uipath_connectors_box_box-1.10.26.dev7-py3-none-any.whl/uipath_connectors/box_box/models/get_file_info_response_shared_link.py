...
from ..models.get_file_info_response_shared_link_shared_link_access import (
    GetFileInfoResponseSharedLinkSharedLinkAccess,
)
from ..models.get_file_info_response_shared_link_shared_link_effective_access import (
    GetFileInfoResponseSharedLinkSharedLinkEffectiveAccess,
)
from ..models.get_file_info_response_shared_link_shared_link_effective_permission import (
    GetFileInfoResponseSharedLinkSharedLinkEffectivePermission,
)
import datetime
...
class GetFileInfoResponseSharedLink(BaseModel):
    """
    Attributes:
        access (Optional[GetFileInfoResponseSharedLinkSharedLinkAccess]): The access level for this shared link.
        ...
        effective_access (Optional[GetFileInfoResponseSharedLinkSharedLinkEffectiveAccess]): The effective access level
                for the shared link. This can be a more
                restrictive access level than the value in the `access` field when the
                enterprise settings restrict the allowed access levels.
        effective_permission (Optional[GetFileInfoResponseSharedLinkSharedLinkEffectivePermission]): The effective
    ...
    access: Optional[GetFileInfoResponseSharedLinkSharedLinkAccess] = Field(
