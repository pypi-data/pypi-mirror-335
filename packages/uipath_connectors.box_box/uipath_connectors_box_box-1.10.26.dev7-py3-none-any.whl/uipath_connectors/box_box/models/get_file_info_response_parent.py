...
from ..models.get_file_info_response_parent_parent_type import (
    GetFileInfoResponseParentParentType,
)
...
class GetFileInfoResponseParent(BaseModel):
    ...
    Attributes:
        ...
        type_ (Optional[GetFileInfoResponseParentParentType]): `folder`
    """
    ...
    type_: Optional[GetFileInfoResponseParentParentType] = Field(
