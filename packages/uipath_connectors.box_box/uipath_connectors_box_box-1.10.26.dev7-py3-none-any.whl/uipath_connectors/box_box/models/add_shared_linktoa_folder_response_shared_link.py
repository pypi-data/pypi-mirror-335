...
from ..models.add_shared_linktoa_folder_response_shared_link_shared_link_access import (
    AddSharedLinktoaFolderResponseSharedLinkSharedLinkAccess,
)
from ..models.add_shared_linktoa_folder_response_shared_link_shared_link_effective_access import (
    AddSharedLinktoaFolderResponseSharedLinkSharedLinkEffectiveAccess,
)
from ..models.add_shared_linktoa_folder_response_shared_link_shared_link_effective_permission import (
    AddSharedLinktoaFolderResponseSharedLinkSharedLinkEffectivePermission,
)
import datetime
...
class AddSharedLinktoaFolderResponseSharedLink(BaseModel):
    """
    Attributes:
        access (Optional[AddSharedLinktoaFolderResponseSharedLinkSharedLinkAccess]): The access level for this shared
                link.
        ...
        effective_access (Optional[AddSharedLinktoaFolderResponseSharedLinkSharedLinkEffectiveAccess]): The effective
                access level for the shared link. This can be a more
                restrictive access level than the value in the `access` field when the
                enterprise settings restrict the allowed access levels.
        effective_permission (Optional[AddSharedLinktoaFolderResponseSharedLinkSharedLinkEffectivePermission]): The
                effective permissions for this shared link.
    ...
    access: Optional[AddSharedLinktoaFolderResponseSharedLinkSharedLinkAccess] = Field(
