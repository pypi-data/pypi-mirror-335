...
from ..models.upload_file_version_response_shared_link_shared_link_access import (
    UploadFileVersionResponseSharedLinkSharedLinkAccess,
)
from ..models.upload_file_version_response_shared_link_shared_link_effective_access import (
    UploadFileVersionResponseSharedLinkSharedLinkEffectiveAccess,
)
from ..models.upload_file_version_response_shared_link_shared_link_effective_permission import (
    UploadFileVersionResponseSharedLinkSharedLinkEffectivePermission,
)
import datetime
...
class UploadFileVersionResponseSharedLink(BaseModel):
    """
    Attributes:
        access (Optional[UploadFileVersionResponseSharedLinkSharedLinkAccess]): The access level for this shared link.
        ...
        effective_access (Optional[UploadFileVersionResponseSharedLinkSharedLinkEffectiveAccess]): The effective access
                level for the shared link. This can be a more
                restrictive access level than the value in the `access` field when the
                enterprise settings restrict the allowed access levels.
        effective_permission (Optional[UploadFileVersionResponseSharedLinkSharedLinkEffectivePermission]): The effective
    ...
    access: Optional[UploadFileVersionResponseSharedLinkSharedLinkAccess] = Field(
