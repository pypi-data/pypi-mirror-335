...
class MarkerAssignValueBase(MarkerAssignBase):
    def execute(self, context, command, marker_node, marker_set):
        ...
        return self.assign_value(context, marker_set, var_name, rest[index:].strip())

    def assign_value(self, context, marker_set, var_name, expression):
        self.set_var_raw(context, var_name, self.get_value(context, expression))
