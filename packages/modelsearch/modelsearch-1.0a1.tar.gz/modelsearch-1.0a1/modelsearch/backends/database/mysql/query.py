...
class MatchExpression(Expression):
    ...
    def __init__(
        ...
        )  # We need to provide a default list of columns if the user doesn't specify one. We have a joint index for for 'title' and 'body' (see modelsearch.migrations.0006_customise_indexentry), so we'll pick that one.
