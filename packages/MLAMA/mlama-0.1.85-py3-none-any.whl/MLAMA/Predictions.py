...
#generalized version
def wave_prediction(shift_type, wave_start_shift_matrixrix, predictions, prediction_length, shift, WAVE, waveID,
...
def wave_prediction_with_models(shift_type, wave_start_shift_matrix, predictions, prediction_length, shift, WAVE, waveID,
    ...
    #### Generate ML Data
    shift = shift if shift_type == 'Delay' else 0
    train_x, test_x, train_y, test_y, fit_weeks_ml, pred_weeks_ml = gen_ml(
        wave, shift_type, prediction_length, lagged_amount, prediction_length, predictions, False, shift
    )
