...
class Wave:
  ...
  def get_wave_dates_with_shift_shift(self, shift, wave_start_shift_matrix):#JMM definition. get_wave_dates_with_shift_shift
    """
  ...
  def get_wave_dates_with_shift(self, shift, wave_start_shift_matrix, shift_type='Responsiveness'):
    ...
    """
    if shift_type not in ['shift', 'Responsiveness']:
        raise ValueError("Invalid shift_type. Expected 'shift' or 'Responsiveness'.")

    if shift_type == 'shift':
        return self.get_wave_dates_with_shift_shift(shift, wave_start_shift_matrix)
