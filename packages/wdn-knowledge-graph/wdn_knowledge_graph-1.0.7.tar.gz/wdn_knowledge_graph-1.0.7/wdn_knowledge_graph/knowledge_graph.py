...
def extract_namespace_from_ontology(ontology_file):
    ...
    # Bind all prefixes to their URIs
    for prefix, namespace in g.namespaces():
        print(f"Prefix: {prefix}, Namespace: {namespace}")

    # Extract the wdn namespace (change if needed)
    wdn_namespace = Namespace("http://example.org/ontology/")  # Replace with your actual namespace URI
    g.bind('wdn', wdn_namespace)

    return wdn_namespace
