...
class CreateSubmissionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["status", "submission", "errors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "submission": SubmissionPreview.from_dict(obj["submission"]) if obj.get("submission") is not None else None,
