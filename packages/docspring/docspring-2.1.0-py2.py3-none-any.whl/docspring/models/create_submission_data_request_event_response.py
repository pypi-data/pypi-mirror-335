...
class CreateSubmissionDataRequestEventResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["status", "event", "errors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "event": SubmissionDataRequestEvent.from_dict(obj["event"]) if obj.get("event") is not None else None,
