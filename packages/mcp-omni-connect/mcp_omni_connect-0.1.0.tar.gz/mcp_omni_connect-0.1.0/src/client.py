...
class MCPClient:
    ...
    async def _connect_to_single_server(self, server):
        try:
            connection_type = server["srv_config"].get("type")
    ...
    async def cleanup(self):
        ...
        try:
            ...
            # Close the exit stack (this will close all remaining contexts)
            try:
            ...
            logger.info("All servers disconnected and resources cleared")
        except Exception as e:
