...
setup(
    ...
    name='botasaurus_humancursor',  # Required
    ...
    description="A fork of [HumanCursor](https://github.com/riflosnake/HumanCursor) which brings human-like mouse movements to Botasaurus.",
    license="MIT",
    keywords=["botasaurus_humancursor"],
