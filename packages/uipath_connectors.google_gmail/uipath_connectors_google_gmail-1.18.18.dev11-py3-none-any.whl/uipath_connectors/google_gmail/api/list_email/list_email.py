...
def sync_detailed(
    *,
    ...
    Args:
        ...
        email_folder (str): In email folder.
        unread_only (Optional[bool]): Return only unread emails.
        with_attachments_only (Optional[bool]): Return emails with only attachment.
        important_only (Optional[bool]): Return only important emails.
        starred_only (Optional[bool]): Return only starred emails.
        additional_filters (Optional[str]): Additional filters.
