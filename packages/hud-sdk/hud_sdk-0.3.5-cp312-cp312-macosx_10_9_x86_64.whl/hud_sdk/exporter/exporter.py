...
from ..declarations import send_function_declarations
...
from ..schemas.events import FunctionDeclaration, WorkloadData
...
class Exporter:
    ...
    async def send_json_for_session(
        ...
        elif request_type == "FunctionDeclaration":
            declarations = [FunctionDeclaration(**d) for d in data]
            await send_function_declarations(client, declarations)
