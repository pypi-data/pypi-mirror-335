...
class AWG70KACommandConstants:
    """The AWG70KA command argument constants.
...
class AWG70KACommands:
    """The AWG70KA commands.

    This provides access to all the commands for the AWG70KA device. See the documentation of each
...
class AWG70KAMixin:
    """A mixin that provides access to the AWG70KA commands and constants.

    Properties:
        - ``.command_argument_constants``: The AWG70KA command argument constants.
    ...
    def commands(self) -> AWG70KACommands:
        ...
        This provides access to all the commands for the AWG70KA device. See the documentation of
