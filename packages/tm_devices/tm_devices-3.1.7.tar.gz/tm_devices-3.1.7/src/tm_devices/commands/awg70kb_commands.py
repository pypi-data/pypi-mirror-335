...
from .gen_3rs8qy_awg.auxoutput import AuxoutputItem
from .gen_3rs8qy_awg.awgcontrol import Awgcontrol
...
from .gen_3rs8qy_awg.output import OutputItem
from .gen_3rs8qy_awg.source import Source, SourceItem
from .gen_3rs8qy_awg.synchronize import Synchronize
...
class AWG70KBCommandConstants:
    """The AWG70KB command argument constants.

    This provides access to all the string constants which can be used as arguments for AWG70KB
    commands.
    """
...
class AWG70KBCommands:
    """The AWG70KB commands.

    This provides access to all the commands for the AWG70KB device. See the documentation of each
    ...
    def system(self) -> System:
        ...
        Sub-properties:
            ...
            - ``.sid``: The ``SYSTem:SID`` command tree.
...
class AWG70KBMixin:
    """A mixin that provides access to the AWG70KB commands and constants.

    Properties:
        - ``.command_argument_constants``: The AWG70KB command argument constants.
        - ``.commands``: The AWG70KB commands.
    """

    @cached_property
    def command_argument_constants(self) -> AWG70KBCommandConstants:  # pylint: disable=no-self-use
        """Return the AWG70KB command argument constants.

        This provides access to all the string constants which can be used as arguments for AWG70KB
        commands.
        """
        return AWG70KBCommandConstants()

    @cached_property
    def commands(self) -> AWG70KBCommands:
        """Return the AWG70KB commands.

        This provides access to all the commands for the AWG70KB device. See the documentation of
