...
class SMU2611BCommandConstants:
    """The SMU2611B command argument constants.
...
class SMU2611BCommands:
    """The SMU2611B commands.

    This provides access to all the commands for the SMU2611B device. See the documentation of each
...
class SMU2611BMixin:
    """A mixin that provides access to the SMU2611B commands and constants.

    Properties:
        - ``.command_argument_constants``: The SMU2611B command argument constants.
    ...
    def commands(self) -> SMU2611BCommands:
        ...
        This provides access to all the commands for the SMU2611B device. See the documentation of
