...
reading at index bufferVar.fillcount."""
    ...
    SETTLE_SMOOTH_100NA = "smuX.SETTLE_SMOOTH_100NA"
    """str: Enables the use of range rampers for the 100 nA range."""
    ...
    def __init__(  # noqa: PLR0915
        ...
        # pylint: disable=invalid-name
        self.SETTLE_SMOOTH_100NA = self.SETTLE_SMOOTH_100NA.replace(
            "smuX", f"smu{self._cmd_syntax[3]}"
        )
        # pylint: disable=invalid-name
