...
from .gen_d83qe0_dmm.channel import Channel
from .gen_d83qe0_dmm.display import Display
from .gen_d83qe0_dmm.dmm import Dmm
from .gen_d83qe0_dmm.scan import Scan
from .gen_d83qe0_dmm.slot import SlotItem
from .gen_d83qe0_dmm.trigger import Trigger
...
class DMM6500CommandConstants:
    """The DMM6500 command argument constants.

    This provides access to all the string constants which can be used as arguments for DMM6500
    commands.
    """
...
class DMM6500Commands:
    """The DMM6500 commands.

    This provides access to all the commands for the DMM6500 device. See the documentation of each
...
class DMM6500Mixin:
    """A mixin that provides access to the DMM6500 commands and constants.

    Properties:
        - ``.command_argument_constants``: The DMM6500 command argument constants.
        - ``.commands``: The DMM6500 commands.
    """

    @cached_property
    def command_argument_constants(self) -> DMM6500CommandConstants:  # pylint: disable=no-self-use
        """Return the DMM6500 command argument constants.

        This provides access to all the string constants which can be used as arguments for DMM6500
        commands.
        """
        return DMM6500CommandConstants()

    @cached_property
    def commands(self) -> DMM6500Commands:
        """Return the DMM6500 commands.

        This provides access to all the commands for the DMM6500 device. See the documentation of
