...
class SaveWaveform(SCPICmdWrite, SCPICmdRead):
    ...
    Info:
        ...
        - ``REF<x>`` is the number of the reference waveform source used to save the waveform data.
    ...
    def waveform(self) -> SaveWaveform:
        ...
        Info:
            - ``CH<x>`` is the number of the analog channel waveform source used to save the
              waveform data.
            - ``MATH<x>`` is the number of the math waveform source used to save the waveform data.
            - ``REF<x>`` is the number of the reference waveform source used to save the waveform
              data.
            - ``_DALL`` saves the digital channel waveform data of the specified channel.
            - ``_SV_NORMal`` saves the Normal Spectrum view waveform of the specified channel.
            - ``_SV_AVErage`` saves the Average Spectrum view waveform of the specified channel.
