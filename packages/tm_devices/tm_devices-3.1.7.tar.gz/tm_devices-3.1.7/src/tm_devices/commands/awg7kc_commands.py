...
class AWG7KCCommandConstants:
    """The AWG7KC command argument constants.
...
class AWG7KCCommands:
    """The AWG7KC commands.

    This provides access to all the commands for the AWG7KC device. See the documentation of each
...
class AWG7KCMixin:
    """A mixin that provides access to the AWG7KC commands and constants.

    Properties:
        - ``.command_argument_constants``: The AWG7KC command argument constants.
    ...
    def commands(self) -> AWG7KCCommands:
        ...
        This provides access to all the commands for the AWG7KC device. See the documentation of
