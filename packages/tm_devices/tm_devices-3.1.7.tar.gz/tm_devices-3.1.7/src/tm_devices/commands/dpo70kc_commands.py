...
class DPO70KCCommandConstants:
    """The DPO70KC command argument constants.
...
class DPO70KCCommands:
    """The DPO70KC commands.

    This provides access to all the commands for the DPO70KC device. See the documentation of each
...
class DPO70KCMixin:
    """A mixin that provides access to the DPO70KC commands and constants.

    Properties:
        - ``.command_argument_constants``: The DPO70KC command argument constants.
    ...
    def commands(self) -> DPO70KCCommands:
        ...
        This provides access to all the commands for the DPO70KC device. See the documentation of
