...
from .gen_6srh1x_smu.smu import Smu
from .gen_6srh1x_smu.upgrade import Upgrade
...
class SMU2460Mixin:
    ...
    @cached_property
    def command_argument_constants(self) -> SMU2460CommandConstants:  # pylint: disable=no-self-use
        """Return the SMU2460 command argument constants.

        This provides access to all the string constants which can be used as arguments for SMU2460
        commands.
        """
        return SMU2460CommandConstants()
