...
from .gen_at7jl1_smu.display import Display
...
from .gen_awhjao_smu.status import Status
...
class SMU2612BCommandConstants:
    """The SMU2612B command argument constants.

    This provides access to all the string constants which can be used as arguments for SMU2612B
    commands.
    """
...
class SMU2612BCommands:
    """The SMU2612B commands.

    This provides access to all the commands for the SMU2612B device. See the documentation of each
...
class SMU2612BMixin:
    """A mixin that provides access to the SMU2612B commands and constants.

    Properties:
        - ``.command_argument_constants``: The SMU2612B command argument constants.
        - ``.commands``: The SMU2612B commands.
    """

    @cached_property
    def command_argument_constants(self) -> SMU2612BCommandConstants:  # pylint: disable=no-self-use
        """Return the SMU2612B command argument constants.

        This provides access to all the string constants which can be used as arguments for SMU2612B
        commands.
        """
        return SMU2612BCommandConstants()

    @cached_property
    def commands(self) -> SMU2612BCommands:
        """Return the SMU2612B commands.

        This provides access to all the commands for the SMU2612B device. See the documentation of
        ...
        return SMU2612BCommands(device)
