...
from .gen_6xiuc2_smu.buffer import Buffer
from .gen_6xiuc2_smu.smu import Smu
from .gen_6xiuc2_smu.upgrade import Upgrade
...
class SMU2470CommandConstants:
    """The SMU2470 command argument constants.

    This provides access to all the string constants which can be used as arguments for SMU2470
    commands.
    """
...
class SMU2470Commands:
    """The SMU2470 commands.
...
class SMU2470Mixin:
    """A mixin that provides access to the SMU2470 commands and constants.

    Properties:
        - ``.command_argument_constants``: The SMU2470 command argument constants.
        - ``.commands``: The SMU2470 commands.
    """

    @cached_property
    def command_argument_constants(self) -> SMU2470CommandConstants:  # pylint: disable=no-self-use
        """Return the SMU2470 command argument constants.

        This provides access to all the string constants which can be used as arguments for SMU2470
        commands.
        """
        return SMU2470CommandConstants()

    @cached_property
    def commands(self) -> SMU2470Commands:
        """Return the SMU2470 commands.
