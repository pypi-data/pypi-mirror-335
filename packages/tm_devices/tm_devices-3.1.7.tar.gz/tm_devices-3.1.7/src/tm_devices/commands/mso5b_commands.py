...
class MSO5BCommandConstants:
    """The MSO5B command argument constants.

    This provides access to all the string constants which can be used as arguments for MSO5B
    commands.
    """
...
class MSO5BCommands:
    ...
    This provides access to all the commands for the MSO5B device. See the documentation of each
...
class MSO5BMixin:
    """A mixin that provides access to the MSO5B commands and constants.

    Properties:
        - ``.command_argument_constants``: The MSO5B command argument constants.
        - ``.commands``: The MSO5B commands.
    """

    @cached_property
    def command_argument_constants(self) -> MSO5BCommandConstants:  # pylint: disable=no-self-use
        """Return the MSO5B command argument constants.

        This provides access to all the string constants which can be used as arguments for MSO5B
        commands.
        """
        return MSO5BCommandConstants()

    @cached_property
    def commands(self) -> MSO5BCommands:
