...
from .gen_8wm55i_smu.smux import SmuxItem
...
class SMU2602BCommandConstants:
    """The SMU2602B command argument constants.

    This provides access to all the string constants which can be used as arguments for SMU2602B
    commands.
    """
...
class SMU2602BCommands:
    """The SMU2602B commands.

    This provides access to all the commands for the SMU2602B device. See the documentation of each
...
class SMU2602BMixin:
    """A mixin that provides access to the SMU2602B commands and constants.

    Properties:
        - ``.command_argument_constants``: The SMU2602B command argument constants.
        - ``.commands``: The SMU2602B commands.
    """

    @cached_property
    def command_argument_constants(self) -> SMU2602BCommandConstants:  # pylint: disable=no-self-use
        """Return the SMU2602B command argument constants.

        This provides access to all the string constants which can be used as arguments for SMU2602B
        commands.
        """
        return SMU2602BCommandConstants()

    @cached_property
    def commands(self) -> SMU2602BCommands:
        """Return the SMU2602B commands.

        This provides access to all the commands for the SMU2602B device. See the documentation of
        ...
        return SMU2602BCommands(device)
