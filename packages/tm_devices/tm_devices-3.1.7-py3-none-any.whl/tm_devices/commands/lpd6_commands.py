...
class LPD6CommandConstants:
    """The LPD6 command argument constants.

    This provides access to all the string constants which can be used as arguments for LPD6
    commands.
    """
...
class LPD6Commands:
    ...
    This provides access to all the commands for the LPD6 device. See the documentation of each
...
class LPD6Mixin:
    """A mixin that provides access to the LPD6 commands and constants.

    Properties:
        - ``.command_argument_constants``: The LPD6 command argument constants.
        - ``.commands``: The LPD6 commands.
    """

    @cached_property
    def command_argument_constants(self) -> LPD6CommandConstants:  # pylint: disable=no-self-use
        """Return the LPD6 command argument constants.

        This provides access to all the string constants which can be used as arguments for LPD6
        commands.
        """
        return LPD6CommandConstants()

    @cached_property
    def commands(self) -> LPD6Commands:
        """Return the LPD6 commands.
