...
class MSO5LPCommandConstants:
    """The MSO5LP command argument constants.

    This provides access to all the string constants which can be used as arguments for MSO5LP
    commands.
    """
...
class MSO5LPCommands:
    """The MSO5LP commands.

    This provides access to all the commands for the MSO5LP device. See the documentation of each
...
class MSO5LPMixin:
    """A mixin that provides access to the MSO5LP commands and constants.

    Properties:
        - ``.command_argument_constants``: The MSO5LP command argument constants.
        - ``.commands``: The MSO5LP commands.
    """

    @cached_property
    def command_argument_constants(self) -> MSO5LPCommandConstants:  # pylint: disable=no-self-use
        """Return the MSO5LP command argument constants.

        This provides access to all the string constants which can be used as arguments for MSO5LP
        commands.
        """
        return MSO5LPCommandConstants()

    @cached_property
    def commands(self) -> MSO5LPCommands:
        """Return the MSO5LP commands.

        This provides access to all the commands for the MSO5LP device. See the documentation of
