...
from .gen_6vynmi_smu.smu import Smu
from .gen_6vynmi_smu.trigger import Trigger
from .gen_6vynmi_smu.upgrade import Upgrade
...
class SMU2461Commands:
    """The SMU2461 commands.

    This provides access to all the commands for the SMU2461 device. See the documentation of each
...
class SMU2461Mixin:
    ...
    def commands(self) -> SMU2461Commands:
        ...
        This provides access to all the commands for the SMU2461 device. See the documentation of
