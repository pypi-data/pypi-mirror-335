...
class MDO3KCommandConstants:
    """The MDO3K command argument constants.

    This provides access to all the string constants which can be used as arguments for MDO3K
    commands.
    """
...
class MDO3KCommands:
    ...
    This provides access to all the commands for the MDO3K device. See the documentation of each
...
class MDO3KMixin:
    """A mixin that provides access to the MDO3K commands and constants.

    Properties:
        - ``.command_argument_constants``: The MDO3K command argument constants.
        - ``.commands``: The MDO3K commands.
    """

    @cached_property
    def command_argument_constants(self) -> MDO3KCommandConstants:  # pylint: disable=no-self-use
        """Return the MDO3K command argument constants.

        This provides access to all the string constants which can be used as arguments for MDO3K
        commands.
        """
        return MDO3KCommandConstants()

    @cached_property
    def commands(self) -> MDO3KCommands:
        """Return the MDO3K commands.
