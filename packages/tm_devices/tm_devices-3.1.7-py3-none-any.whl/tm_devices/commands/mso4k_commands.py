...
from .gen_1lh2st_msodpo.search import Search
...
class MSO4KCommandConstants:
    """The MSO4K command argument constants.
...
class MSO4KCommands:
    ...
    This provides access to all the commands for the MSO4K device. See the documentation of each
...
class MSO4KMixin:
    """A mixin that provides access to the MSO4K commands and constants.

    Properties:
        - ``.command_argument_constants``: The MSO4K command argument constants.
