...
class MDO4KCommandConstants:
    """The MDO4K command argument constants.

    This provides access to all the string constants which can be used as arguments for MDO4K
    commands.
    """
...
class MDO4KCommands:
    ...
    This provides access to all the commands for the MDO4K device. See the documentation of each
    ...
    def rf(self) -> Rf:
        ...
        Sub-properties:
            ...
            - ``.rf_frequency``: The ``RF:RF_FREQuency`` command tree.
...
class MDO4KMixin:
    """A mixin that provides access to the MDO4K commands and constants.

    Properties:
        - ``.command_argument_constants``: The MDO4K command argument constants.
        - ``.commands``: The MDO4K commands.
    """

    @cached_property
    def command_argument_constants(self) -> MDO4KCommandConstants:  # pylint: disable=no-self-use
        """Return the MDO4K command argument constants.

        This provides access to all the string constants which can be used as arguments for MDO4K
        commands.
        """
        return MDO4KCommandConstants()

    @cached_property
    def commands(self) -> MDO4KCommands:
        """Return the MDO4K commands.
