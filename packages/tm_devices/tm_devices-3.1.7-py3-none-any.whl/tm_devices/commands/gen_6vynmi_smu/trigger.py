...
class TriggerModel(BaseTSPCmd):
    ...
    Properties and methods:
        ...
        - ``.setblock_trigger_block_source_pulse_output()``: The
          ``trigger.model.setblock() - trigger.BLOCK_SOURCE_PULSE_OUTPUT`` function.
    ...
    def setblock_trigger_block_source_pulse_output(self, block_number: int, state: str) -> None:
        """Run the ``trigger.model.setblock() - trigger.BLOCK_SOURCE_PULSE_OUTPUT`` function.
        ...
        Args:
            block_number: The sequence of the block in the trigger model.
            state: Turn the source pulse off.
        ...
        try:
            self._device.write(  # type: ignore[union-attr]
                f"{self._cmd_syntax}.setblock({block_number}, "
                f"trigger.BLOCK_SOURCE_PULSE_OUTPUT, "
                f"{state})"
            )
        except AttributeError as error:
            msg = f"No TSPControl object was provided, unable to run the ``{self._cmd_syntax}.setblock()`` function."  # noqa: E501
