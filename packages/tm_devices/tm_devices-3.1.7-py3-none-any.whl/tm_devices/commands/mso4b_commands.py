...
class MSO4BCommandConstants:
    """The MSO4B command argument constants.

    This provides access to all the string constants which can be used as arguments for MSO4B
    commands.
    """
...
class MSO4BCommands:
    ...
    This provides access to all the commands for the MSO4B device. See the documentation of each
...
class MSO4BMixin:
    """A mixin that provides access to the MSO4B commands and constants.

    Properties:
        - ``.command_argument_constants``: The MSO4B command argument constants.
        - ``.commands``: The MSO4B commands.
    """

    @cached_property
    def command_argument_constants(self) -> MSO4BCommandConstants:  # pylint: disable=no-self-use
        """Return the MSO4B command argument constants.

        This provides access to all the string constants which can be used as arguments for MSO4B
        commands.
        """
        return MSO4BCommandConstants()

    @cached_property
    def commands(self) -> MSO4BCommands:
        """Return the MSO4B commands.
