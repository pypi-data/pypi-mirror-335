...
class AFG3KBCommandConstants:
    """The AFG3KB command argument constants.

    This provides access to all the string constants which can be used as arguments for AFG3KB
    commands.
    """
...
class AFG3KBCommands:
    """The AFG3KB commands.

    This provides access to all the commands for the AFG3KB device. See the documentation of each
...
class AFG3KBMixin:
    """A mixin that provides access to the AFG3KB commands and constants.

    Properties:
        - ``.command_argument_constants``: The AFG3KB command argument constants.
        - ``.commands``: The AFG3KB commands.
    """

    @cached_property
    def command_argument_constants(self) -> AFG3KBCommandConstants:  # pylint: disable=no-self-use
        """Return the AFG3KB command argument constants.

        This provides access to all the string constants which can be used as arguments for AFG3KB
        commands.
        """
        return AFG3KBCommandConstants()

    @cached_property
    def commands(self) -> AFG3KBCommands:
        """Return the AFG3KB commands.

        This provides access to all the commands for the AFG3KB device. See the documentation of
