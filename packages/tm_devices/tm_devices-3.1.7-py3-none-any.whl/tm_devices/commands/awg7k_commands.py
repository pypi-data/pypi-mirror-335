...
class AWG7KCommandConstants:
    """The AWG7K command argument constants.

    This provides access to all the string constants which can be used as arguments for AWG7K
    commands.
    """
...
class AWG7KCommands:
    ...
    This provides access to all the commands for the AWG7K device. See the documentation of each
...
class AWG7KMixin:
    """A mixin that provides access to the AWG7K commands and constants.

    Properties:
        - ``.command_argument_constants``: The AWG7K command argument constants.
        - ``.commands``: The AWG7K commands.
    """

    @cached_property
    def command_argument_constants(self) -> AWG7KCommandConstants:  # pylint: disable=no-self-use
        """Return the AWG7K command argument constants.

        This provides access to all the string constants which can be used as arguments for AWG7K
        commands.
        """
        return AWG7KCommandConstants()

    @cached_property
    def commands(self) -> AWG7KCommands:
        """Return the AWG7K commands.
