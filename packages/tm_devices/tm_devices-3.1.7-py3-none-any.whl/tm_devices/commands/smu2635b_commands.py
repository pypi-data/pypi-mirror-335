...
class SMU2635BCommandConstants:
    """The SMU2635B command argument constants.

    This provides access to all the string constants which can be used as arguments for SMU2635B
    commands.
    """
    ...
    SMUX_SETTLE_SMOOTH_100NA = "smuX.SETTLE_SMOOTH_100NA"
...
class SMU2635BCommands:
    """The SMU2635B commands.

    This provides access to all the commands for the SMU2635B device. See the documentation of each
...
class SMU2635BMixin:
    ...
    @cached_property
    def command_argument_constants(self) -> SMU2635BCommandConstants:  # pylint: disable=no-self-use
        """Return the SMU2635B command argument constants.

        This provides access to all the string constants which can be used as arguments for SMU2635B
        commands.
        """
        return SMU2635BCommandConstants()

    @cached_property
    def commands(self) -> SMU2635BCommands:
        """Return the SMU2635B commands.

        This provides access to all the commands for the SMU2635B device. See the documentation of
        ...
        return SMU2635BCommands(device)
