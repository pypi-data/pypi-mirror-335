...
class TriggerABusBItemRs232cTxDataValue(SCPICmdWrite, SCPICmdRead):
    ...
    Usage:
        ...
        - Using the ``.verify(value)`` method will send the
          ...
          returned value does not match ``value``.
        - Using the ``.write(value)`` method will send the
          ``TRIGger:A:BUS:B<x>:RS232C:TX:DATa:VALue value`` command.
...
class TriggerABusBItemRs232cRxDataValue(SCPICmdWrite, SCPICmdRead):
    ...
    Usage:
        ...
        - Using the ``.verify(value)`` method will send the
          ...
          returned value does not match ``value``.
        - Using the ``.write(value)`` method will send the
          ``TRIGger:A:BUS:B<x>:RS232C:RX:DATa:VALue value`` command.
