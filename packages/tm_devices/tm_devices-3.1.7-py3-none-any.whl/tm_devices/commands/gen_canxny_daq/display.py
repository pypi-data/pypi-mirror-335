...
class Display(BaseTSPCmd):
    ...
    Constants:
        ...
        - ``.SCREEN_NONSWITCH_SWIPE``: Display NONSWITCH swipe screen (only available when a card
          with non-switching  channels is installed and rear terminals are selected).
        - ``.SCREEN_PROCESSING``: Open a screen that uses minimal CPU resources.
        - ``.SCREEN_READING_TABLE``: Display Reading Table screen.
        - ``.SCREEN_SCAN_SWIPE``: Display SCAN swipe screen (only available when a card is installed
          and rear terminals are selected).
...
the instrument."""  # noqa: E501
    ...
    SCREEN_CHANNEL_CONTROL = "display.SCREEN_CHANNEL_CONTROL"
    """str: Display the channel control screen."""
    SCREEN_CHANNEL_SCAN = "display.SCREEN_CHANNEL_SCAN"
    """str: Display channel scan screen."""
    SCREEN_CHANNEL_SETTINGS = "display.SCREEN_CHANNEL_SETTINGS"
    """str: Display channel settings screen."""
    SCREEN_CHANNEL_SWIPE = "display.SCREEN_CHANNEL_SWIPE"
    """str: Display CHANNEL swipe screen (only available when a card is installed and rear terminals are selected)."""  # noqa: E501
    SCREEN_FUNCTIONS_SWIPE = "display.SCREEN_FUNCTIONS_SWIPE"
    """str: Display the Functions swipe screen."""
    ...
    SCREEN_NONSWITCH_SWIPE = "display.SCREEN_NONSWITCH_SWIPE"
    """str: Display NONSWITCH swipe screen (only available when a card with non-switching  channels is installed and rear terminals are selected)."""  # noqa: E501
    ...
    SCREEN_SCAN_SWIPE = "display.SCREEN_SCAN_SWIPE"
    """str: Display SCAN swipe screen (only available when a card is installed and rear terminals are selected)."""  # noqa: E501
    SCREEN_SECONDARY_SWIPE = "display.SCREEN_SECONDARY_SWIPE"
    """str: Display the SECONDARY swipe screen."""
