...
class AWG5KCommandConstants:
    """The AWG5K command argument constants.

    This provides access to all the string constants which can be used as arguments for AWG5K
    commands.
    """
...
class AWG5KCommands:
    ...
    This provides access to all the commands for the AWG5K device. See the documentation of each
...
class AWG5KMixin:
    """A mixin that provides access to the AWG5K commands and constants.

    Properties:
        - ``.command_argument_constants``: The AWG5K command argument constants.
        - ``.commands``: The AWG5K commands.
    """

    @cached_property
    def command_argument_constants(self) -> AWG5KCommandConstants:  # pylint: disable=no-self-use
        """Return the AWG5K command argument constants.

        This provides access to all the string constants which can be used as arguments for AWG5K
        commands.
        """
        return AWG5KCommandConstants()

    @cached_property
    def commands(self) -> AWG5KCommands:
        """Return the AWG5K commands.
