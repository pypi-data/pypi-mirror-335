...
from .gen_9mzp2j_smu.digio import Digio
from .gen_9mzp2j_smu.display import Display
from .gen_9mzp2j_smu.tsplink import Tsplink
from .gen_9nnkq7_smu.status import Status
...
class SMU2614BCommandConstants:
    """The SMU2614B command argument constants.

    This provides access to all the string constants which can be used as arguments for SMU2614B
    commands.
    """
    ...
    SERIAL_FLOW_HARDWARE = "serial.FLOW_HARDWARE"
    SERIAL_FLOW_NONE = "serial.FLOW_NONE"
    SERIAL_PARITY_EVEN = "serial.PARITY_EVEN"
    SERIAL_PARITY_NONE = "serial.PARITY_NONE"
    SERIAL_PARITY_ODD = "serial.PARITY_ODD"
    ...
    STATUS_QUESTIONABLE_HIGHV_NOT_READY = "status.questionable.HIGHV_NOT_READY"
...
class SMU2614BCommands:
    """The SMU2614B commands.

    This provides access to all the commands for the SMU2614B device. See the documentation of each
...
class SMU2614BMixin:
    """A mixin that provides access to the SMU2614B commands and constants.

    Properties:
        - ``.command_argument_constants``: The SMU2614B command argument constants.
        - ``.commands``: The SMU2614B commands.
    """

    @cached_property
    def command_argument_constants(self) -> SMU2614BCommandConstants:  # pylint: disable=no-self-use
        """Return the SMU2614B command argument constants.

        This provides access to all the string constants which can be used as arguments for SMU2614B
        commands.
        """
        return SMU2614BCommandConstants()

    @cached_property
    def commands(self) -> SMU2614BCommands:
        """Return the SMU2614B commands.

        This provides access to all the commands for the SMU2614B device. See the documentation of
        ...
        return SMU2614BCommands(device)
