...
class JetAlgorithmType:
    ...
    def algName(self, id: func_adl_servicex_xaodr21.xAOD.jetalgorithmtype.JetAlgorithmType.ID) -> str:
        "A method"
        ...

    def algId(self, n: str) -> func_adl_servicex_xaodr21.xAOD.jetalgorithmtype.JetAlgorithmType.ID:
        "A method"
        ...
