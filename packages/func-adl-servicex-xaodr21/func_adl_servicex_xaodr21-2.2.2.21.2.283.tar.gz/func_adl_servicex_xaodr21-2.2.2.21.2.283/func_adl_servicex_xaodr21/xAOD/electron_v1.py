...
class Electron_v1:
    ...
    def trackCaloMatchValue(self, value: float, information: func_adl_servicex_xaodr21.xAOD.egammaparameters.EgammaParameters.TrackCaloMatchType) -> bool:
        "A method"
        ...

    def setTrackCaloMatchValue(self, value: float, information: func_adl_servicex_xaodr21.xAOD.egammaparameters.EgammaParameters.TrackCaloMatchType) -> bool:
        "A method"
        ...

    def trackParticleSummaryValue(self, value: int, information: func_adl_servicex_xaodr21.xaod.xAOD.SummaryType, index: int) -> bool:
        "A method"
        ...

    def trackParticleSummaryIntValue(self, information: func_adl_servicex_xaodr21.xaod.xAOD.SummaryType, index: int) -> int:
        "A method"
        ...

    def trackParticleSummaryFloatValue(self, information: func_adl_servicex_xaodr21.xaod.xAOD.SummaryType, index: int) -> float:
        "A method"
        ...
