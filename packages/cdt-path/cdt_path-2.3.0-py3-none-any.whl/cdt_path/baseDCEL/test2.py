...
e12, e21 = dcel.add_edge(v1, v2, None, None, None)  
e23, e32 = dcel.add_edge(v2, v3, None, None, None)  # v3 -> v2  
e34, e43 = dcel.add_edge(v3, v4, None, None, None)  # v4 -> v3  
e41, e14 = dcel.add_edge(v4, v1, None, None, None)  # v1 -> v4  
  
# 设置面  
f1 = dcel.add_face(e12)  
...
v1.x=0.74
print(v1.leaving_edge)
incident_edges=v1.incident_edges()
