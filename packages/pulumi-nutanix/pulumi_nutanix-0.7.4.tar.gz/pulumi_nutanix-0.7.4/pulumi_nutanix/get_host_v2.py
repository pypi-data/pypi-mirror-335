...
class GetHostV2Result:
    ...
    def default_vhd_container_uuid(self) -> str:
        """
    ...
    def default_vhd_location(self) -> str:
        """
    ...
    def default_vm_container_uuid(self) -> str:
        """
    ...
    def default_vm_location(self) -> str:
        """
        - Default VM location.
        """
    ...
    def failover_cluster_fqdn(self) -> str:
        """
    ...
    def failover_cluster_node_status(self) -> str:
        """
    ...
    def gpu_lists(self) -> Sequence[str]:
        """
        - GPU attached list.
        """
    ...
    def is_hardware_virtualized(self) -> bool:
        """
    ...
    def is_secure_booted(self) -> bool:
        """
        - Secure boot status.
        """
    ...
    def rackable_unit_uuid(self) -> str:
        """
        - Rackable unit UUID.
        """
...
def get_host_v2(cluster_ext_id: Optional[str] = None,
    ...
    :param str cluster_ext_id: - (Required) cluster uuid
    :param str ext_id: - (Required) host uuid
    """
    __args__ = dict()
