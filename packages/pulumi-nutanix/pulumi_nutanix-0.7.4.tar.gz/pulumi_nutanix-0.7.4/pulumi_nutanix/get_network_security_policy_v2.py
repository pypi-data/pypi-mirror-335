...
class GetNetworkSecurityPolicyV2Result:
    ...
    def is_hitlog_enabled(self) -> bool:
        """
    ...
    def is_ipv6_traffic_allowed(self) -> bool:
        """
    ...
    def secured_groups(self) -> Sequence[str]:
        """
    ...
    def vpc_references(self) -> Sequence[str]:
        """
...
def get_network_security_policy_v2(ext_id: Optional[str] = None,
    ...
    :param str ext_id: Network security policy UUID.
    """
    __args__ = dict()
