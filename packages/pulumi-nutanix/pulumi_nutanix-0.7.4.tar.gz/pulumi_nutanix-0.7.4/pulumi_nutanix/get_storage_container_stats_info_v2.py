...
def get_storage_container_stats_info_v2_output(end_time: Optional[pulumi.Input[str]] = None,
                                               ext_id: Optional[pulumi.Input[str]] = None,
                                               sampling_interval: Optional[pulumi.Input[Optional[int]]] = None,
                                               start_time: Optional[pulumi.Input[str]] = None,
                                               stat_type: Optional[pulumi.Input[Optional[str]]] = None,
