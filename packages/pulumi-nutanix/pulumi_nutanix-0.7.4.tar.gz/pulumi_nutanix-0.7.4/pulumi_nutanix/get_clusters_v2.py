...
def get_clusters_v2(apply: Optional[str] = None,
    ...
    :param str apply: -(Optional) A URL query parameter that allows clients to specify a sequence of transformations to the entity set, such as groupby, filter, aggregate etc. As of now only support for groupby exists.For example '\\$apply=groupby((templateName))' would get all templates grouped by templateName. 
...
def get_clusters_v2_output(apply: Optional[pulumi.Input[Optional[str]]] = None,
