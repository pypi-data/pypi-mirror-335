...
class PbrV2Args:
    ...
    def vpc_ext_id(self) -> pulumi.Input[str]:
        return pulumi.get(self, "vpc_ext_id")

    @vpc_ext_id.setter
    def vpc_ext_id(self, value: pulumi.Input[str]):
...
class _PbrV2State:
    def __init__(__self__, *,
                 ...
                 vpc_ext_id: Optional[pulumi.Input[str]] = None,
    ...
    @property
    @pulumi.getter(name="vpcExtId")
    def vpc_ext_id(self) -> Optional[pulumi.Input[str]]:
        return pulumi.get(self, "vpc_ext_id")

    @vpc_ext_id.setter
    def vpc_ext_id(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "vpc_ext_id", value)
...
class PbrV2(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="vpcExtId")
    def vpc_ext_id(self) -> pulumi.Output[str]:
        return pulumi.get(self, "vpc_ext_id")
