...
class GetSubnetV2Result:
    ...
    def cluster_reference(self) -> str:
        """
    ...
    def is_advanced_networking(self) -> bool:
        """
    ...
    def network_function_chain_reference(self) -> str:
        """
    ...
    def virtual_switch_reference(self) -> str:
        """
...
def get_subnet_v2(ext_id: Optional[str] = None,
    ...
    :param str ext_id: - (Required) The UUID of the subnet.
