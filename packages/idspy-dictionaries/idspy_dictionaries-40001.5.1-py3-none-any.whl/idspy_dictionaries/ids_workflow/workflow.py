...
class WorkflowComponent(IdsBaseClass):
    ...
    :ivar execution_mode : Component execution mode for current workflow cycle. 0 means the component is not executed and the workflow uses results from previous workflow cycle. 1 means the component is executed for this workflow cycle.
    :ivar time_interval_request : Simulation time interval for which this component is requested to compute its results
    :ivar time_interval_elapsed : Simulation time interval for which this component has last computed its results
    :ivar control_float : Array of real workflow control parameters used by this component (component specific)
    :ivar control_integer : Array of integer workflow control parameters used by this component (component specific)
    """
    ...
    execution_mode: Optional[int] = field(
        default=999999999, metadata={"imas_type": "INT_0D", "field_type": int}
    )
    time_interval_request: Optional[float] = field(
        default=9e40, metadata={"imas_type": "FLT_0D", "field_type": float}
    )
    time_interval_elapsed: Optional[float] = field(
        default=9e40, metadata={"imas_type": "FLT_0D", "field_type": float}
    )
    control_float: Optional[np.ndarray] = field(
    ...
    control_integer: Optional[np.ndarray] = field(
        default_factory=lambda: np.zeros(shape=(0,) * 1, dtype=int),
        metadata={
            "imas_type": "INT_1D",
            "ndims": 1,
...
class WorkflowCycle(IdsBaseClass):
    ...
    :ivar component : Control parameters for the set of participting components defined in ../../component
    :ivar time : Time
    """
    ...
    component: Optional[WorkflowComponent] = field(
        default_factory=lambda: StructArray(type_input=WorkflowComponent),
        metadata={
            "imas_type": "workflow_component",
            "ndims": 1,
            "coordinates": {"coordinate1": "1...N"},
            "field_type": WorkflowComponent,
        },
    )
...
class WorkflowTimeLoop(IdsBaseClass):
    ...
    component: Optional[CodeConstant] = field(
        default_factory=lambda: StructArray(type_input=CodeConstant),
        metadata={
            "imas_type": "code_constant",
            "ndims": 1,
            "coordinates": {"coordinate1": "1...N"},
            "field_type": CodeConstant,
        },
    )
    time_end: Optional[float] = field(
        default=9e40, metadata={"imas_type": "FLT_0D", "field_type": float}
    )
    workflow_cycle: Optional[WorkflowCycle] = field(
        default_factory=lambda: StructArray(type_input=WorkflowCycle),
        metadata={
            "imas_type": "workflow_cycle",
            "ndims": 1,
            "coordinates": {"coordinate1": "time"},
            "field_type": WorkflowCycle,
        },
    )
...
class Workflow(IdsBaseClass):
    ...
    :ivar ids_properties :
    :ivar time_loop : Description of a workflow based on a time loop which calls components defined in component_list sequentially  during each cycle of the loop (workflow_cycle).
    :ivar code :
    ...
    time_loop: Optional[WorkflowTimeLoop] = field(
        default=None,
        metadata={
            "imas_type": "workflow_time_loop",
            "field_type": WorkflowTimeLoop,
        },
    )
