...
class IronCoreSegment(IdsBaseClass):
    ...
    :ivar magnetization_r : Magnetization M of the iron segment along the major radius axis, assumed to be constant inside a given iron segment. Reminder : H = 1/mu0 * B - mur * M;
    :ivar magnetization_z : Magnetization M of the iron segment along the vertical axis, assumed to be constant inside a given iron segment. Reminder : H = 1/mu0 * B - mur * M;
    """
    ...
    magnetization_r: Optional[SignalFlt1D] = field(
        default=None,
        metadata={"imas_type": "signal_flt_1d", "field_type": SignalFlt1D},
    )
    magnetization_z: Optional[SignalFlt1D] = field(
        default=None,
        metadata={"imas_type": "signal_flt_1d", "field_type": SignalFlt1D},
    )
...
class IronCore(IdsBaseClass):
    ...
    segment: Optional[IronCoreSegment] = field(
        default_factory=lambda: StructArray(type_input=IronCoreSegment),
        metadata={
