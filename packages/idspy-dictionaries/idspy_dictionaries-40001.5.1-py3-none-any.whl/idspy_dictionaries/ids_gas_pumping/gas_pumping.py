...
class GasPumpingSpecies(IdsBaseClass):
    ...
    :ivar label : String identifying the neutral molecule (e.g. H2, D2, T2, N2, ...)
...
class GasPumpingDuct(IdsBaseClass):
    ...
    species: Optional[GasPumpingSpecies] = field(
        default_factory=lambda: StructArray(type_input=GasPumpingSpecies),
        metadata={
            "imas_type": "gas_pumping_species",
            "ndims": 1,
            "coordinates": {"coordinate1": "1...N"},
            "field_type": GasPumpingSpecies,
        },
    )
    flow_rate: Optional[SignalFlt1D] = field(
        default=None,
...
class GasPumping(IdsBaseClass):
    ...
    duct: Optional[GasPumpingDuct] = field(
        default_factory=lambda: StructArray(type_input=GasPumpingDuct),
        metadata={
            "imas_type": "gas_pumping_duct",
            "ndims": 1,
            "coordinates": {"coordinate1": "1...N"},
            "field_type": GasPumpingDuct,
        },
    )
