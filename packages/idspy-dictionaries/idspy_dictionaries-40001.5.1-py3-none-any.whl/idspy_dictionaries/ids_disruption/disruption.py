...
class DisruptionHaloCurrents(IdsBaseClass):
    ...
    area: Optional[DisruptionHaloCurrentsArea] = field(
        default_factory=lambda: StructArray(
            type_input=DisruptionHaloCurrentsArea
        ),
        metadata={
...
class Disruption(IdsBaseClass):
    ...
    halo_currents: Optional[DisruptionHaloCurrents] = field(
        default_factory=lambda: StructArray(type_input=DisruptionHaloCurrents),
        metadata={
    ...
    profiles_1d: Optional[DisruptionProfiles1D] = field(
        default_factory=lambda: StructArray(type_input=DisruptionProfiles1D),
        metadata={
