...
class PfPlasmaElement(IdsBaseClass):
    ...
    :ivar time : Timebase for the dynamic nodes located at this level of the IDS structure
    """
...
class PfPlasma(IdsBaseClass):
    ...
    element: Optional[PfPlasmaElement] = field(
        default_factory=lambda: StructArray(type_input=PfPlasmaElement),
        metadata={
            "imas_type": "pf_plasma_element",
            "ndims": 1,
            "coordinates": {"coordinate1": "1...N"},
            "field_type": PfPlasmaElement,
        },
    )
