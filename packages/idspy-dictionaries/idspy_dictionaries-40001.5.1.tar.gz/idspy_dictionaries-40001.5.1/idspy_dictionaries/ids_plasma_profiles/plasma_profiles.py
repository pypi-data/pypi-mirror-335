...
class PlasmaProfilesGlobalQuantities(IdsBaseClass):
    ...
    ion: Optional[PlasmaProfilesGlobalQuantitiesIon] = field(
        default_factory=lambda: StructArray(
            type_input=PlasmaProfilesGlobalQuantitiesIon
        ),
        metadata={
...
class PlasmaProfilesProfiles1DIon(IdsBaseClass):
    ...
    state: Optional[PlasmaProfilesProfiles1DIonState] = field(
        default_factory=lambda: StructArray(
            type_input=PlasmaProfilesProfiles1DIonState
        ),
        metadata={
...
class PlasmaProfilesProfiles1DNeutral(IdsBaseClass):
    ...
    state: Optional[PlasmaProfilesProfiles1DNeutralState] = field(
        default_factory=lambda: StructArray(
            type_input=PlasmaProfilesProfiles1DNeutralState
        ),
        metadata={
...
class PlasmaProfilesProfiles1D(IdsBaseClass):
    ...
    ion: Optional[PlasmaProfilesProfiles1DIon] = field(
        default_factory=lambda: StructArray(
            type_input=PlasmaProfilesProfiles1DIon
        ),
        metadata={
    ...
    neutral: Optional[PlasmaProfilesProfiles1DNeutral] = field(
        default_factory=lambda: StructArray(
            type_input=PlasmaProfilesProfiles1DNeutral
        ),
        metadata={
...
class PlasmaProfiles2DIon(IdsBaseClass):
    ...
    state: Optional[PlasmaProfiles2DIonState] = field(
        default_factory=lambda: StructArray(
            type_input=PlasmaProfiles2DIonState
        ),
        metadata={
...
class PlasmaProfilesProfiles2D(IdsBaseClass):
    ...
    ion: Optional[PlasmaProfiles2DIon] = field(
        default_factory=lambda: StructArray(type_input=PlasmaProfiles2DIon),
        metadata={
...
class PlasmaProfilesTimeSliceNeutral(IdsBaseClass):
    ...
    state: Optional[PlasmaProfilesTimeSliceNeutralState] = field(
        default_factory=lambda: StructArray(
            type_input=PlasmaProfilesTimeSliceNeutralState
        ),
        metadata={
...
class PlasmaProfilesTimeSliceIon(IdsBaseClass):
    ...
    state: Optional[PlasmaProfilesTimeSliceIonChargeState] = field(
        default_factory=lambda: StructArray(
            type_input=PlasmaProfilesTimeSliceIonChargeState
        ),
        metadata={
...
class PlasmaProfilesTimeSlice(IdsBaseClass):
    ...
    :ivar psi : Poloidal flux, given on various grid subsets. Integral of magnetic field passing through a contour defined by the intersection of a flux surface passing through the point of interest and a Z=constant plane. If the integration surface is flat, the surface normal vector is in the increasing vertical coordinate direction, Z, namely upwards.
    ...
    ion: Optional[PlasmaProfilesTimeSliceIon] = field(
        default_factory=lambda: StructArray(
            type_input=PlasmaProfilesTimeSliceIon
        ),
        metadata={
    ...
    neutral: Optional[PlasmaProfilesTimeSliceNeutral] = field(
        default_factory=lambda: StructArray(
            type_input=PlasmaProfilesTimeSliceNeutral
        ),
        metadata={
...
class PlasmaProfilesGgdFast(IdsBaseClass):
    ...
    ion: Optional[PlasmaProfilesGgdFastIon] = field(
        default_factory=lambda: StructArray(
            type_input=PlasmaProfilesGgdFastIon
        ),
        metadata={
...
class PlasmaProfiles(IdsBaseClass):
    ...
    profiles_1d: Optional[PlasmaProfilesProfiles1D] = field(
        default_factory=lambda: StructArray(
            type_input=PlasmaProfilesProfiles1D
        ),
        metadata={
    ...
    profiles_2d: Optional[PlasmaProfilesProfiles2D] = field(
        default_factory=lambda: StructArray(
            type_input=PlasmaProfilesProfiles2D
        ),
        metadata={
    ...
    ggd: Optional[PlasmaProfilesTimeSlice] = field(
        default_factory=lambda: StructArray(type_input=PlasmaProfilesTimeSlice),
        metadata={
    ...
    ggd_fast: Optional[PlasmaProfilesGgdFast] = field(
        default_factory=lambda: StructArray(type_input=PlasmaProfilesGgdFast),
        metadata={
