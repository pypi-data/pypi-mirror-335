...
help_texts = {
    ...
    'lino_avanti.lib.avanti.Clients' : _("""Base class for most tables of clients."""),
    ...
    'lino_avanti.lib.courses.Course.can_excuse' : _("""Whether end users can select the workflow state “excused” for presences of calendar entries generated by this course."""),
