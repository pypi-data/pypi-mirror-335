...
class Client(contacts.Person, BeIdCardHolder, UserAuthored, ClientBase,
    ...
    if dd.plugins.avanti.with_asylum:
        ...
        residence_permit = dd.ForeignKey(
            'avanti.ResidencePermit', blank=True, null=True)
        residence_reason = dd.ForeignKey(
            'avanti.ResidenceReason', blank=True, null=True)
    # else:
    ...
    def full_clean(self, *args, **kw):
        ...
        if not self.client_state:
            self.client_state = ClientStates.coached
