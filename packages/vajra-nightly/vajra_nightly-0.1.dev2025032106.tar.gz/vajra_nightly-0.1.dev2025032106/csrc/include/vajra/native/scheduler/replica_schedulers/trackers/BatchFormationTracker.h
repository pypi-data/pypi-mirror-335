...
class BatchFormationTracker {
 public:
   ...
   */
  void AddIgnoredSequence(const std::shared_ptr<Sequence> seq);
   ...
   */
  void AddPreemptedSequence(const std::shared_ptr<Sequence> seq);
   ...
   */
  [[nodiscard]] SchedulerOutput GetBatch() const;
