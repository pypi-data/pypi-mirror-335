...
class KvpBatchTracker {
 public:
   ...
   */
  void AddSequence(
      const std::shared_ptr<Sequence> seq /*[in]*/,
   ...
   */
  [[nodiscard]] std::vector<std::shared_ptr<Sequence>> GetPerGroupSequences(
 ...
 private:
  ...
  std::vector<std::vector<std::shared_ptr<Sequence>>> per_kvp_group_sequences_;
