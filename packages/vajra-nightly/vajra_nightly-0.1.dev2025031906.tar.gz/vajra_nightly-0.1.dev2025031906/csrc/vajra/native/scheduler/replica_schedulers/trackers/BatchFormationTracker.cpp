...
void BatchFormationTracker::AddSequence(const std::shared_ptr<Sequence> seq,
...
void BatchFormationTracker::AddIgnoredSequence(
    const std::shared_ptr<Sequence> seq) {
  ignored_sequence_ids_.push_back(seq->seq_id);
}

void BatchFormationTracker::AddPreemptedSequence(
    const std::shared_ptr<Sequence> seq) {
...
vajra::SchedulerOutput BatchFormationTracker::GetBatch() const {
  ...
  return SchedulerOutput(schedule_id_, ignored_sequence_ids_,
                         preempted_sequence_ids_, seq_schedule_metadata_list);
}
