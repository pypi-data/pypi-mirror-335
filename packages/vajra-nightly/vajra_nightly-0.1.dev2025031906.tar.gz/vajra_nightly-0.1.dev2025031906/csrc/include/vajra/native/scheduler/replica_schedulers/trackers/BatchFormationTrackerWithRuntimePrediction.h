...
class BatchFormationTrackerWithRuntimePrediction
 ...
 public:
   ...
   */
  void AddSequence(const std::shared_ptr<Sequence> seq,
   ...
   */
  [[nodiscard]] std::size_t GetBatchExecutionTime(
   ...
   */
  [[nodiscard]] std::vector<std::size_t> GetBatchExecutionTimeForKvpGroups(
 ...
 private:
   ...
   */
  std::size_t ComputeBatchExecutionTime(
      std::size_t kvp_group_id,
      const std::vector<std::shared_ptr<Sequence>>& extra_seqs = {},
