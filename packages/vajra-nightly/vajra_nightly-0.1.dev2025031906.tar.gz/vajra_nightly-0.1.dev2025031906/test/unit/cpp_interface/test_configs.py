...
@pytest.mark.parametrize(
    ...
    [(16, 0), (32, 1024), (64, 2048)],
)
@pytest.mark.unit
def test_valid_cache_config_creation(block_size, num_gpu_blocks):
    ...
    assert cache_config.num_gpu_blocks == cache_config_c.num_gpu_blocks
...
@pytest.mark.unit
def test_can_deep_copy_cache_config(block_size, num_gpu_blocks):
    ...
    assert cache_config.num_gpu_blocks == cache_config_deep_copy.num_gpu_blocks
...
@pytest.mark.unit
def test_can_pickle_cache_config(block_size, num_gpu_blocks):
    ...
    assert cache_config.num_gpu_blocks == cache_config_from_pickle.num_gpu_blocks
