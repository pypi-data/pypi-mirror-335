"""
PhenoScope Exceptions

This module contains all exceptions used throughout the PhenoScope library.
Exceptions are organized by module and functionality.
"""


# Base exception class for all PhenoScope exceptions
class PhenoScopeError(Exception):
    """Base exception class for all PhenoScope errors."""
    pass
