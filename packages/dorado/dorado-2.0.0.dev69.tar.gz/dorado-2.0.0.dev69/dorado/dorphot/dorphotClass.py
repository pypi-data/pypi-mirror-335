...
class aicoPhot:
    ...
    def calibrate(self, cr,  filter, use_med_cr_removal = False, rb = 0, use_lac_cr_removal = False, scln = False, scln_xy = [1,-1, 1,-1]):
        ...
        ccdproc.cosmicray_median() method.
        ...
        rb: int
            the rbox value for ccdproc.cosmicray_median(). Default is 0.
        ...
        for im in tqdm(stack.data, colour = 'green'):
            ...
            if use_med_cr_removal:
                im = ccdproc.cosmicray_median(im, rbox = rb)
            if use_lac_cr_removal:
    ...
    def mkBase(self, cr, filter, sigClip = False, minmax = False, mmcmip = 0.1, mmcmap = 0.9):
        ...
        base = ccdproc.combine(series.data,method='median',mem_limit=2e9, sigma_clip=sigClip, minmax_clip=minmax,minmax_clip_min=mmcmi, minmax_clip_max=mmcma)
...
class dracoPhot:
    ...
    def get_field(self, cr, filter, toid, im = None):
        ...
        columnse = [ 'phot_g_mean_mag', 'phot_bp_mean_mag', 'phot_rp_mean_mag', 'teff', 'dist']
