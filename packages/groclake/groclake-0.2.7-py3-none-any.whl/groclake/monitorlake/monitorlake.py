    ...
    "properties": {
        ...
        "monitor_entity": {
            ...
            "properties": {
                ...
                "monitor_entity_ci_id": {"type": "keyword"}
            }
        },
        "ci_relations": {
            "type": "nested",
            "properties": {
                "ci_rel_type": {"type": "keyword"},
                "ci_name": {"type": "text"},
                "ci_id": {"type": "keyword"}
            }
        },
        "frequency": {"type": "keyword"},
        "time_duration": {"type": "keyword"},
        "monitor_apm": {
            "properties": {
                "apm_tool": {"type": "keyword"},
                "apm_account_id": {"type": "keyword"},
                "apm_key": {"type": "keyword"}
            }
        },
        "conditions": {
            "type": "nested",
