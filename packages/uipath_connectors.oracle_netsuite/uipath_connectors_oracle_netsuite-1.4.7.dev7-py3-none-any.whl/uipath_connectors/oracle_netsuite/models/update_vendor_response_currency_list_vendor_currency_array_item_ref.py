...
class UpdateVendorResponseCurrencyListVendorCurrencyArrayItemRef(BaseModel):
    """
    Attributes:
        balance (Optional[int]): The Currency list vendor currency balance Example: 0.0.
        currency (Optional[UpdateVendorResponseCurrencyListVendorCurrencyCurrency]):
        unbilled_orders (Optional[int]): The Currency list vendor currency unbilled orders Example: 0.0.
    """
