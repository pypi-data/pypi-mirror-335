...
from ..models.create_customer_response_address_1_address_1_country import (
...
class CreateCustomerResponseAddress1(BaseModel):
    ...
    Attributes:
        ...
        country (Optional[CreateCustomerResponseAddress1Address1Country]): The Address 1 country Example: _india.
    ...
    country: Optional[CreateCustomerResponseAddress1Address1Country] = Field(
