...
from ..models.create_vendor_response_address_2_address_2_country import (
...
class CreateVendorResponseAddress2(BaseModel):
    ...
    Attributes:
        ...
        country (Optional[CreateVendorResponseAddress2Address2Country]): The Address 2 country Example: _unitedStates.
    ...
    country: Optional[CreateVendorResponseAddress2Address2Country] = Field(
