...
from ..models.create_vendor_request_address_2_address_2_country import (
...
class CreateVendorRequestAddress2(BaseModel):
    ...
    Attributes:
        ...
        country (Optional[CreateVendorRequestAddress2Address2Country]): The Address 2 country Example: _unitedStates.
    ...
    country: Optional[CreateVendorRequestAddress2Address2Country] = Field(
