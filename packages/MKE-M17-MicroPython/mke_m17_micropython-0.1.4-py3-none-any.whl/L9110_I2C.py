...
class L9110:
    ...
    def __init__(self, address=0x40, bus=I2C_BUS):
        """
        Initialize the L9110 motor controller over I2C.

        Args:
            address (int): The I2C address of the L9110 chip (default is 0x40).
            bus (I2C): A pre-initialized I2C bus to use for communication (default is I2C(0)).
        """
    ...
    def control_motor(self, motor_id, percent, direction):
        ...
        data = [self.address, self.MODE_DC, motor_id, 0, 0, 0]
    ...
    def set_address(self, new_address):
        ...
        data = [self.address, self.MODE_SET_ADDR, 0, 0, 0, (new_address + self.MODE_SET_ADDR) & 0xFF]
