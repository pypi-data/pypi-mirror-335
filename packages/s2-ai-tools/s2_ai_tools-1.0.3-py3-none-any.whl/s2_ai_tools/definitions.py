...
SINGLESTORE_DB_USERNAME = config.SINGLESTORE_DB_USERNAME
SINGLESTORE_DB_PASSWORD = config.SINGLESTORE_DB_PASSWORD
...
def __create_file_in_shared_space(path: str, content: str):
    ...
    file_manager = s2.manage_files(
        access_token=SINGLESTORE_API_KEY, base_url=SINGLESTORE_API_BASE_URL
    )
