...
def __create_file_in_shared_space(path: str, content: str):
    ...
    file_manager = s2.manage_files(
        access_token=load_api_key(), base_url=SINGLESTORE_API_BASE_URL
    )
...
tool_registry = [
    ...
    },
    {
        ...
        "func": lambda workspace_group_identifier, workspace_identifier, database, sql_query, username=load_db_username(), password=load_db_password(): (
            __execute_sql(
    ...
    },
    {
        ...
        "func": lambda virtual_workspace_id, sql_query, username=load_db_username(), password=load_db_password(): __execute_sql_on_virtual_workspace(
