...
class FunctionInfoModel(CacheModel):
    ...
    def __init__(self, db_connect_key='db_middler_platform', sub_table=None, db_transaction=None, context=None, is_write=False):
        super(FunctionInfoModel, self).__init__(FunctionInfo, sub_table)
        self.db = MySQLHelper(self.write_or_read_db_config(config.get_value(db_connect_key), is_write))
