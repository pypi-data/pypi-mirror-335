...
impl<'de> serde::Deserialize<'de> for AmpsData {
  ...
  where
    D: serde::Deserializer<'de>,
  {
    const FIELDS: &[&str] = &["error", "seq_num", "seqNum", "amps_value", "ampsValue"];
        ...
        while let Some(k) = map_.next_key()? {
          match k {
            ...
            GeneratedField::AmpsValue => {
              ...
              amps_value__ = Some(
                map_
                  .next_value::<Vec<::pbjson::private::BytesDeserialize<_>>>()?
                  .into_iter()
                  .map(|x| x.0)
                  .collect(),
              );
...
impl serde::Serialize for AppSensor {
    ...
    S: serde::Serializer,
  {
    ...
    if let Some(v) = self.imu_config.as_ref() {
      struct_ser.serialize_field("imuConfig", v)?;
    }
    struct_ser.end()
  }
}
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            E: serde::de::Error,
          {
            match value {
              ...
              "imuConfig" | "imu_config" => Ok(GeneratedField::ImuConfig),
              _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
            }
          }
        }
        ...
        V: serde::de::MapAccess<'de>,
      {
        ...
        while let Some(k) = map_.next_key()? {
          match k {
            ...
            GeneratedField::ImuConfig => {
              if imu_config__.is_some() {
                return Err(serde::de::Error::duplicate_field("imuConfig"));
              }
              imu_config__ = map_.next_value()?;
            }
          }
        }
        Ok(AppSensor {
    ...
    impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
        ...
        E: serde::de::Error,
      {
        match value {
          ...
          "GET_PORT_STAT" => Ok(ConfigReqType::GetPortStat),
...
impl<'de> serde::Deserialize<'de> for DeviceInfo {
    ...
    D: serde::Deserializer<'de>,
  {
    ...
    deserializer.deserialize_struct(
      "tech.brainco.treadmill.DeviceInfo",
      FIELDS,
      GeneratedVisitor,
    )
  }
...
impl<'de> serde::Deserialize<'de> for FlexConfResp {
    ...
    D: serde::Deserializer<'de>,
  {
    ...
    deserializer.deserialize_struct(
      "tech.brainco.treadmill.FlexConfResp",
      FIELDS,
      GeneratedVisitor,
    )
  }
...
impl<'de> serde::Deserialize<'de> for FlexConfig {
  ...
  where
    D: serde::Deserializer<'de>,
  {
    const FIELDS: &[&str] = &["sample_rate", "sampleRate"];
    ...
    deserializer.deserialize_struct(
      "tech.brainco.treadmill.FlexConfig",
      FIELDS,
      GeneratedVisitor,
    )
  }
...
impl serde::Serialize for GaitAnalysisResult {
    ...
    S: serde::Serializer,
  {
    ...
    let mut struct_ser =
      serializer.serialize_struct("tech.brainco.treadmill.GaitAnalysisResult", len)?;
    if self.msg_id != 0 {
      struct_ser.serialize_field("msgId", &self.msg_id)?;
    }
    if self.timestamp != 0 {
    ...
    if self.abnormal_gait != 0 {
      let v = AbnormalGait::try_from(self.abnormal_gait).map_err(|_| {
        serde::ser::Error::custom(format!("Invalid variant {}", self.abnormal_gait))
      })?;
...
impl<'de> serde::Deserialize<'de> for GaitAnalysisResult {
    ...
    D: serde::Deserializer<'de>,
  {
    ...
    deserializer.deserialize_struct(
      "tech.brainco.treadmill.GaitAnalysisResult",
      FIELDS,
      GeneratedVisitor,
    )
  }
...
impl<'de> serde::Deserialize<'de> for gait_analysis_result::FootStrike {
  ...
  where
    D: serde::Deserializer<'de>,
  {
    const FIELDS: &[&str] = &["FOOT_STRIKE_UNSPECIFIED", "LEFT_FOOT", "RIGHT_FOOT"];
...
impl<'de> serde::Deserialize<'de> for gait_analysis_result::GaitPattern {
  ...
  where
    D: serde::Deserializer<'de>,
  {
    const FIELDS: &[&str] = &["GAIT_PATTERN_UNSPECIFIED", "WALK", "RUN"];
...
impl<'de> serde::Deserialize<'de> for ImuConfResp {
    ...
    D: serde::Deserializer<'de>,
  {
    ...
    deserializer.deserialize_struct(
      "tech.brainco.treadmill.ImuConfResp",
      FIELDS,
      GeneratedVisitor,
    )
  }
...
impl serde::Serialize for ImuConfig {
    ...
    S: serde::Serializer,
  {
    ...
    if self.iu_mode != 0 {
      let v = imu_config::ImuMode::try_from(self.iu_mode)
        .map_err(|_| serde::ser::Error::custom(format!("Invalid variant {}", self.iu_mode)))?;
      struct_ser.serialize_field("iuMode", &v)?;
    }
    if self.imu_sr != 0 {
...
impl<'de> serde::Deserialize<'de> for ImuConfig {
  ...
  where
    D: serde::Deserializer<'de>,
  {
    const FIELDS: &[&str] = &["iu_mode", "iuMode", "imu_sr", "imuSr"];
    ...
    impl<'de> serde::Deserialize<'de> for GeneratedField {
        ...
        D: serde::Deserializer<'de>,
      {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
          ...
          {
            match value {
              "iuMode" | "iu_mode" => Ok(GeneratedField::IuMode),
    ...
    impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
      ...
      where
        V: serde::de::MapAccess<'de>,
      {
        let mut iu_mode__ = None;
        let mut imu_sr__ = None;
        while let Some(k) = map_.next_key()? {
          match k {
            GeneratedField::IuMode => {
              if iu_mode__.is_some() {
                return Err(serde::de::Error::duplicate_field("iuMode"));
              }
              iu_mode__ = Some(map_.next_value::<imu_config::ImuMode>()? as i32);
            }
        ...
        Ok(ImuConfig {
          iu_mode: iu_mode__.unwrap_or_default(),
...
impl<'de> serde::Deserialize<'de> for imu_config::ImuMode {
  ...
  where
    D: serde::Deserializer<'de>,
  {
    const FIELDS: &[&str] = &["NOT_SET", "ACC", "GYRO", "ACC_GYRO", "EULER"];
...
impl serde::Serialize for ImuData {
    ...
    S: serde::Serializer,
  {
    ...
    if !self.acc_raw_data.is_empty() {
      ...
      struct_ser.serialize_field(
        "accRawData",
        pbjson::private::base64::encode(&self.acc_raw_data).as_str(),
      )?;
    }
    if !self.gyro_raw_data.is_empty() {
      #[allow(clippy::needless_borrow)]
      ...
      struct_ser.serialize_field(
        "gyroRawData",
        pbjson::private::base64::encode(&self.gyro_raw_data).as_str(),
      )?;
    }
    if !self.eular_raw_data.is_empty() {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            E: serde::de::Error,
          {
            match value {
              ...
              "gyroCorrectionData" | "gyro_correction_data" => {
                Ok(GeneratedField::GyroCorrectionData)
              }
              _ => Err(serde::de::Error::unknown_field(value, FIELDS)),
            }
          }
        ...
        while let Some(k) = map_.next_key()? {
          match k {
            ...
            GeneratedField::EularRawData => {
              ...
              eular_raw_data__ = Some(
                map_
                  .next_value::<Vec<::pbjson::private::NumberDeserialize<_>>>()?
                  .into_iter()
                  .map(|x| x.0)
                  .collect(),
              );
...
impl<'de> serde::Deserialize<'de> for OtaData {
  ...
  where
    D: serde::Deserializer<'de>,
  {
    const FIELDS: &[&str] = &["offset", "data", "finished"];
...
impl<'de> serde::Deserialize<'de> for ota_config::Cmd {
  ...
  where
    D: serde::Deserializer<'de>,
  {
    const FIELDS: &[&str] = &["NONE", "OTA_START", "OTA_REBOOT"];
...
impl serde::Serialize for OtaConfigResp {
    ...
    S: serde::Serializer,
  {
    ...
    let mut struct_ser =
      serializer.serialize_struct("tech.brainco.treadmill.OtaConfigResp", len)?;
    if self.state != 0 {
...
impl<'de> serde::Deserialize<'de> for OtaConfigResp {
    ...
    D: serde::Deserializer<'de>,
  {
    ...
    deserializer.deserialize_struct(
      "tech.brainco.treadmill.OtaConfigResp",
      FIELDS,
      GeneratedVisitor,
    )
  }
...
impl serde::Serialize for SensorApp {
    ...
    S: serde::Serializer,
  {
    ...
    if let Some(v) = self.imu_data2.as_ref() {
      struct_ser.serialize_field("imuData2", v)?;
    }
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            E: serde::de::Error,
          {
            match value {
              ...
              "imuData2" | "imu_data2" => Ok(GeneratedField::ImuData2),
        ...
        V: serde::de::MapAccess<'de>,
      {
        ...
        while let Some(k) = map_.next_key()? {
          match k {
            ...
            GeneratedField::ImuData2 => {
              if imu_data2__.is_some() {
                return Err(serde::de::Error::duplicate_field("imuData2"));
              }
              imu_data2__ = map_.next_value()?;
            }
...
impl serde::Serialize for TreadmillsData {
  #[allow(deprecated)]
  fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
  where
    S: serde::Serializer,
  {
    ...
    let mut struct_ser =
      serializer.serialize_struct("tech.brainco.treadmill.Treadmills_data", len)?;
    if self.msg_id != 0 {
      struct_ser.serialize_field("msgId", &self.msg_id)?;
    }
    if self.st != 0 {
      let v = treadmills_data::Status::try_from(self.st)
...
impl<'de> serde::Deserialize<'de> for TreadmillsData {
  #[allow(deprecated)]
  fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
  where
    D: serde::Deserializer<'de>,
  {
    ...
    struct GeneratedVisitor;
    impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
      type Value = TreadmillsData;

      fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        formatter.write_str("struct tech.brainco.treadmill.Treadmills_data")
      }

      fn visit_map<V>(self, mut map_: V) -> std::result::Result<TreadmillsData, V::Error>
      where
        V: serde::de::MapAccess<'de>,
      {
        let mut msg_id__ = None;
        ...
        while let Some(k) = map_.next_key()? {
          match k {
            ...
            GeneratedField::St => {
              ...
              st__ = Some(map_.next_value::<treadmills_data::Status>()? as i32);
            }
    ...
    deserializer.deserialize_struct(
      "tech.brainco.treadmill.Treadmills_data",
      FIELDS,
      GeneratedVisitor,
    )
  }
}
impl serde::Serialize for treadmills_data::Status {
  #[allow(deprecated)]
  fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
  where
    S: serde::Serializer,
...
impl<'de> serde::Deserialize<'de> for treadmills_data::Status {
  #[allow(deprecated)]
  fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
  where
    D: serde::Deserializer<'de>,
  {
    const FIELDS: &[&str] = &["ST_INVALID", "ST_STOP", "ST_RUN", "ST_DECAY"];

    struct GeneratedVisitor;

    impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
      type Value = treadmills_data::Status;
      ...
      {
        match value {
          "ST_INVALID" => Ok(treadmills_data::Status::StInvalid),
          "ST_STOP" => Ok(treadmills_data::Status::StStop),
          "ST_RUN" => Ok(treadmills_data::Status::StRun),
          "ST_DECAY" => Ok(treadmills_data::Status::StDecay),
          _ => Err(serde::de::Error::unknown_variant(value, FIELDS)),
        }
      }
    }
