...
inspect_class(treadmill_sdk.eeg_cap.EegSignalGain)
inspect_class(treadmill_sdk.eeg_cap.EegSignalSource)
inspect_class(treadmill_sdk.eeg_cap.EegSampleRate)
inspect_class(treadmill_sdk.eeg_cap.ImuSampleRate)
# inspect_class(treadmill_sdk.BandPassFilter)

fs = 250  # 采样频率
low_cut = 2  # 低通滤波截止频率
high_cut = 45  # 高通滤波截止频率
bs = treadmill_sdk.BandPassFilter(fs, low_cut, high_cut)
print(bs)
test_data = [1, 2, 3, 4, 5]
