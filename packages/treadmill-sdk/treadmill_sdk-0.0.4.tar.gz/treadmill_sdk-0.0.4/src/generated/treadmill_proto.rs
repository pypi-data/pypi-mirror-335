...
#[derive(Clone, Copy, PartialEq, ::prost::Message)]
pub struct TreadmillsData {
  #[prost(uint32, tag = "1")]
  pub msg_id: u32,
  #[prost(enumeration = "treadmills_data::Status", tag = "2")]
  pub st: i32,
  #[prost(uint32, tag = "3")]
...
/// Nested message and enum types in `Treadmills_data`.
pub mod treadmills_data {
  #[derive(Clone, Copy, Debug, PartialEq, Eq, Hash, PartialOrd, Ord, ::prost::Enumeration)]
  #[repr(i32)]
  pub enum Status {
    StInvalid = 0,
...
pub struct SensorApp {
  ...
  pub tm_data: ::core::option::Option<TreadmillsData>,
