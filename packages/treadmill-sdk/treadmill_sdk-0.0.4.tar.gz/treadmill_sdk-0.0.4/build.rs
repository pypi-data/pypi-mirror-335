...
fn main() {
  ...
  cfg_if! {
    if #[cfg(feature = "edu")] {
      // 编译并复制 edu proto
      let edu_proto_files = [
          "proto3/edu/app_dongle/app_to_dongle.proto",
          "proto3/edu/app_dongle/dongle_to_app.proto",
          "proto3/edu/app_sensor/device_ctrl_box.proto",
          "proto3/edu/app_sensor/device_exg.proto",
      ];
      let edu_include_dirs = [
          "proto3/edu",
          "proto3/edu/app_dongle",
          "proto3/edu/app_sensor",
      ];
      compile_and_copy_protos(&edu_proto_files, &edu_include_dirs, "edu");
    }
  }

  // 编译并复制 treadmill proto
  let tml_proto_files = [
    "proto3/treadmill/treadmill_common.proto",
    "proto3/treadmill/treadmill_message.proto",
  ];
