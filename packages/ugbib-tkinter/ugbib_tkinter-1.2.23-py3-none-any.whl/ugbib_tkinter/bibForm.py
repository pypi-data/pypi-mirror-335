...
class Picture(tk.Canvas):
    """Picture - Widget zur Anzeige von Bildern
    
        Picture soll in einer GUI für PostgreSQL-Datenbanken Bilder behandeln. Ähnlich
        ...
        Zu diskutieren:
            ...
            2. Ist innerhalb von PostgreSQL bytea der geeigntee Datentyp für
               Bild-Daten?
            3. Ja: Ist tk.Canvas die geeignete Basis-Klasse für Picture?
            4. Ja: Reicht das Python-Modul Pillow (PIL) für die nötigen
...
class yScrolledFrame(ttk.Frame):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.canvas = tk.Canvas(self, height=self.winfo_height(), borderwidth=2, relief=tk.GROOVE)
        ...
        self.innerFrame = ttk.Frame(self.canvas, height=self.winfo_height())
