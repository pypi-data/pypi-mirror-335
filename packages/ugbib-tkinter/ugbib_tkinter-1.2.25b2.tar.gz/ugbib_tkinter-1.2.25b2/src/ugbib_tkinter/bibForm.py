...
class PictureFrame(ttk.Frame):
    ...
    def __init__(self, parent,
        ...
        self.pictureData = None   # Pillow PILImage Objekt
    ...
    def info(self, stand=''):
        print(f'===== {stand} =====')
        print(f'{self.pictureData.info["dpi"]=}')
    ...
    def loadPicture(self, picturePath):
        ...
        """
        # Bild laden
        self.pictureData = PILImage.open(picturePath)
        self.info('nach open')
        #
    ...
    def setValue(self, data):
        """setValue - Setzt den Wert des Widgets auf konvertiertes data
            ...
            Der "Wert" self.pictureData ist dann allerdings ein Pillow PILImage
        ...
        if data is None:
            ...
            self.pictureData = PILImage.open(io.BytesIO(data))
            self.display()
