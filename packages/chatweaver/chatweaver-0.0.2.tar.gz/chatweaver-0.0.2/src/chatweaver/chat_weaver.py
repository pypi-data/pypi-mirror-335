...
class Model(object):
    ...
    def __init__(self, model: str = "gpt-4o", api_key: str | None = None) -> None:
        self.define_attributes(model=model, api_key=api_key)
    ...
    # -------- DEFINE --------
    def define_attributes(self, model: str, api_key: str | None) -> None:
...
class Bot(Model):
    def __init__(self, *args, rules: str | None = None, name: str = "AI Bot", **kwargs) -> None:
    ...
    def response(self, prompt: str, 
        ...
        messages = [
            {"role": "developer", "content": self.__rules}, 
