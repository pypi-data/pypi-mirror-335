...
import typing
from . import F
__all__ = ['Classifier', 'F', 'FaceDetector', 'FaceLandmarks', 'FaceLandmarksObject', 'FaceObject', 'FaceObjects', 'FaceRecognizer', 'HandLandmarks', 'LayerInfo', 'MUD', 'NN', 'NanoTrack', 'OCR_Box', 'OCR_Object', 'OCR_Objects', 'Object', 'ObjectFloat', 'Objects', 'PP_OCR', 'Retinaface', 'SelfLearnClassifier', 'Speech', 'SpeechDecoder', 'SpeechDevice', 'YOLO11', 'YOLOv5', 'YOLOv8']
class Classifier:
    label_path: str
    labels: list[str]
    mean: list[float]
...
class HandLandmarks:
    ...
    def __init__(self, model: str = '') -> None:
        ...
    def detect(self, img: maix._maix.image.Image, conf_th: float = 0.7, iou_th: float = 0.45, conf_th2: float = 0.8, landmarks_rel: bool = False) -> ...:
        """
        Detect objects from image
...
class YOLOv5:
    ...
    def __init__(self, model: str = '', dual_buff: bool = True) -> None:
        ...
    def detect(self, img: maix._maix.image.Image, conf_th: float = 0.5, iou_th: float = 0.45, fit: maix._maix.image.Fit = ..., sort: int = 0) -> list[...]:
        """
        Detect objects from image
