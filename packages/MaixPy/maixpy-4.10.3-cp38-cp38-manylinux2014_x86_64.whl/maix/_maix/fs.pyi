...
import typing
__all__ = ['File', 'SEEK', 'abspath', 'basename', 'dirname', 'exists', 'getcwd', 'getsize', 'isabs', 'isdir', 'isfile', 'islink', 'listdir', 'mkdir', 'open', 'realpath', 'remove', 'rename', 'rmdir', 'splitext', 'symlink', 'sync', 'tempdir']
class File:
...
class SEEK:
    ...
    Members:
      ...
      SEEK_END
    """
    SEEK_CUR: typing.ClassVar[SEEK]  # value = <SEEK.SEEK_CUR: 1>
    SEEK_END: typing.ClassVar[SEEK]  # value = <SEEK.SEEK_END: 2>
    SEEK_SET: typing.ClassVar[SEEK]  # value = <SEEK.SEEK_SET: 0>
    __members__: typing.ClassVar[dict[str, SEEK]]  # value = {'SEEK_SET': <SEEK.SEEK_SET: 0>, 'SEEK_CUR': <SEEK.SEEK_CUR: 1>, 'SEEK_END': <SEEK.SEEK_END: 2>}
