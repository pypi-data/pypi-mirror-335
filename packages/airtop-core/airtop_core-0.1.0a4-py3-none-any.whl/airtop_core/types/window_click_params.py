...
from .shared_params.click_config import ClickConfig

__all__ = ["WindowClickParams"]


class WindowClickParams(TypedDict, total=False):
    session_id: Required[Annotated[str, PropertyInfo(alias="sessionId")]]
    """The session id for the window."""

    element_description: Required[Annotated[str, PropertyInfo(alias="elementDescription")]]
