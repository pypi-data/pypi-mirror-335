...
from airtop_core import Airtop, AsyncAirtop, APIResponseValidationError
from airtop_core._types import Omit
from airtop_core._utils import maybe_transform
from airtop_core._models import BaseModel, FinalRequestOptions
from airtop_core._constants import RAW_RESPONSE_HEADER
from airtop_core._exceptions import AirtopError, APIStatusError, APITimeoutError, APIResponseValidationError
from airtop_core._base_client import (
    DEFAULT_TIMEOUT,
    HTTPX_DEFAULT_TIMEOUT,
    BaseClient,
    make_request_options,
)
from airtop_core.types.session_create_params import SessionCreateParams
...
def _get_open_connections(client: Airtop | AsyncAirtop) -> int:
...
class TestAirtop:
    client = Airtop(base_url=base_url, api_key=api_key, _strict_response_validation=True)
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "airtop_core/_legacy_response.py",
                        "airtop_core/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "airtop_core/_compat.py",
    ...
    def test_client_timeout_option(self) -> None:
        client = Airtop(base_url=base_url, api_key=api_key, _strict_response_validation=True, timeout=httpx.Timeout(0))
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(AirtopError):
            with update_env(**{"AIRTOP_API_KEY": Omit()}):
                client2 = Airtop(base_url=base_url, api_key=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, client: Airtop) -> None:
        request = client._build_request(
    ...
    def test_base_url_setter(self) -> None:
        client = Airtop(base_url="https://example.com/from_init", api_key=api_key, _strict_response_validation=True)
    ...
    def test_base_url_env(self) -> None:
        with update_env(AIRTOP_BASE_URL="http://localhost:5000/from/env"):
            client = Airtop(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"

    @pytest.mark.parametrize(
        "client",
        [
            Airtop(base_url="http://localhost:5000/custom/path/", api_key=api_key, _strict_response_validation=True),
            Airtop(
    ...
    def test_base_url_trailing_slash(self, client: Airtop) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Airtop) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Airtop) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_client_max_retries_validation(self) -> None:
        with pytest.raises(TypeError, match=r"max_retries cannot be None"):
            Airtop(base_url=base_url, api_key=api_key, _strict_response_validation=True, max_retries=cast(Any, None))
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = Airtop(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = Airtop(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    @mock.patch("airtop_core._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    ...
    def test_omit_retry_count_header(
        self, client: Airtop, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
...
class TestAsyncAirtop:
    client = AsyncAirtop(base_url=base_url, api_key=api_key, _strict_response_validation=True)
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(AirtopError):
            with update_env(**{"AIRTOP_API_KEY": Omit()}):
                client2 = AsyncAirtop(base_url=base_url, api_key=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, async_client: AsyncAirtop) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(AIRTOP_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncAirtop(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncAirtop) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncAirtop) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncAirtop) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncAirtop(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncAirtop(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncAirtop, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
    ...
    def test_get_platform(self) -> None:
        ...
        from airtop_core._utils import asyncify
        from airtop_core._base_client import get_platform 
