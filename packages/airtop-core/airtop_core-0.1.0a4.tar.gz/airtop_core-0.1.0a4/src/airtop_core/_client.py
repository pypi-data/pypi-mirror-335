...
from .resources import files, profile, windows, requests, sessions, automations
from ._streaming import Stream as Stream, AsyncStream as AsyncStream
from ._exceptions import AirtopError, APIStatusError
...
__all__ = ["Timeout", "Transport", "ProxiesTypes", "RequestOptions", "Airtop", "AsyncAirtop", "Client", "AsyncClient"]


class Airtop(SyncAPIClient):
    ...
    windows: windows.WindowsResource
    with_raw_response: AirtopWithRawResponse
    with_streaming_response: AirtopWithStreamedResponse
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous Airtop client instance.

        This automatically infers the `api_key` argument from the `AIRTOP_API_KEY` environment variable if it is not provided.
        """
        if api_key is None:
            api_key = os.environ.get("AIRTOP_API_KEY")
        if api_key is None:
            raise AirtopError(
                "The api_key client option must be set either by passing api_key to the client or by setting the AIRTOP_API_KEY environment variable"
            )
        self.api_key = api_key

        if base_url is None:
            base_url = os.environ.get("AIRTOP_BASE_URL")
        if base_url is None:
            base_url = f"https://api.airtop.ai/api/v1"
        ...
        self.windows = windows.WindowsResource(self)
        self.with_raw_response = AirtopWithRawResponse(self)
        self.with_streaming_response = AirtopWithStreamedResponse(self)
...
class AsyncAirtop(AsyncAPIClient):
    ...
    windows: windows.AsyncWindowsResource
    with_raw_response: AsyncAirtopWithRawResponse
    with_streaming_response: AsyncAirtopWithStreamedResponse
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async AsyncAirtop client instance.
        ...
        self.windows = windows.AsyncWindowsResource(self)
        self.with_raw_response = AsyncAirtopWithRawResponse(self)
        self.with_streaming_response = AsyncAirtopWithStreamedResponse(self)
...
class AirtopWithRawResponse:
    def __init__(self, client: Airtop) -> None:
        ...
        self.windows = windows.WindowsResourceWithRawResponse(client.windows)


class AsyncAirtopWithRawResponse:
    def __init__(self, client: AsyncAirtop) -> None:
        ...
        self.windows = windows.AsyncWindowsResourceWithRawResponse(client.windows)


class AirtopWithStreamedResponse:
    def __init__(self, client: Airtop) -> None:
        ...
        self.windows = windows.WindowsResourceWithStreamingResponse(client.windows)


class AsyncAirtopWithStreamedResponse:
    def __init__(self, client: AsyncAirtop) -> None:
        ...
        self.windows = windows.AsyncWindowsResourceWithStreamingResponse(client.windows)


Client = Airtop

AsyncClient = AsyncAirtop
