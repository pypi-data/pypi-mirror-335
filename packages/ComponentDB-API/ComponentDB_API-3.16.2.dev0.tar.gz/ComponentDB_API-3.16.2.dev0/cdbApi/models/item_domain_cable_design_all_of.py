...
class ItemDomainCableDesignAllOf(object):
    ...
    def __init__(self, connection_list=None, assigned_item=None, inventory_item=None, technical_system_list=None, alternate_name=None, is_housed=None, catalog_item=None, local_vars_configuration=None):  # noqa: E501
