...
class ItemDomainCableDesign(object):
    ...
    def __init__(self, id=None, name=None, item_identifier1=None, item_identifier2=None, qr_id=None, domain=None, derived_from_item=None, description=None, domain_id=None, item_category_list_import=None, primary_image_for_item=None, item_control=None, max_sort_order=None, entity_type_list=None, item_category_list=None, item_type_list=None, item_project_list=None, item_source_list=None, connection_list=None, assigned_item=None, inventory_item=None, technical_system_list=None, alternate_name=None, is_housed=None, catalog_item=None, local_vars_configuration=None):  # noqa: E501
