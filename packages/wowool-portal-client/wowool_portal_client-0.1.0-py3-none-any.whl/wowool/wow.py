...
class WowTools:
    ...
    def stagger(self, cli, id: str, doc: Document):
        ...
        for sentence in doc.analysis:
            ...
            for concept in Concept.iter(sentence, lambda concept: concept.uri != "Sentence"):
...
class CLI:
    def __init__(self, kwargs, console_=None):
        ...
        if "pipeline" not in self.kwargs and "domains" in self.kwargs:
            ...
            if pipeline_filename.exists():
                if pipeline_filename.suffix not in [".language", ".dom", ".app"]:
